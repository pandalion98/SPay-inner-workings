...
public class GridView extends AbsListView {
            ...
            switch (this.mLayoutMode) {
                ...
                case 5:
                    ...
                    if (sel != null) {
                        ...
                        inTouchMode = this.mTouchMode <= 0 && this.mTouchMode < 3;
                        if (!inTouchMode) {
                    ...
                    if (viewRootImpl != null) {
                        newAccessibilityFocusedView = viewRootImpl.getAccessibilityFocusedHost();
                        if (newAccessibilityFocusedView == null) {
                            ...
                            position = MathUtils.constrain(accessibilityFocusPosition - this.mFirstPosition, 0, getChildCount() - 1);
                            if (mInsideViewAccFocused) {
                                restoreView = getChildAt(position).findViewById(newAccessibilityFocusedView.getId());
                            } else {
                                restoreView = getChildAt(position);
                            }
                            if (newAccessibilityFocusedView.isAccessibilityFocused() && newAccessibilityFocusedView != restoreView) {
                                newAccessibilityFocusedView.clearAccessibilityFocus();
                                if (restoreView != null) {
                                    restoreView.requestAccessibilityFocus();
                                }
                            }
    ...
    protected int computeVerticalScrollExtent() {
        ...
        height = view.getHeight() + this.mVerticalSpacing;
        if (height > 0) {
