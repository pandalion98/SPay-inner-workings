...
class YearPickerView extends ListView {
    ...
    private static class YearAdapter extends BaseAdapter {
        private static final int ITEM_LAYOUT = 17367401;
        private static final int ITEM_TEXT_ACTIVATED_APPEARANCE = 16974877;
        private static final int ITEM_TEXT_APPEARANCE = 16974876;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (hasNewView) {
                v = (TextView) this.mInflater.inflate(17367401, parent, false);
            } else {
            ...
            if (hasNewView || v.isActivated() != activated) {
                ...
                if (activated) {
                    textAppearanceResId = 16974877;
                } else {
                    textAppearanceResId = 16974876;
                }
