...
public class ExpandableListView extends ListView {
    ...
    private boolean isRtlCompatibilityMode() {
        ...
        if ((targetSdkVersion >= 17 || isSystemApp) && hasRtlSupport()) {
            return false;
        }
        return true;
    }
                    ...
                    if (b >= 0 && t <= myB) {
                        ...
                        if (pos.position.type != lastItemType) {
                            ...
                            if (pos.position.type != 1) {
                                indicatorRect.left = isLayoutRtl ? width - this.mIndicatorRight : this.mIndicatorLeft;
                                indicatorRect.right = isLayoutRtl ? width - this.mIndicatorLeft : this.mIndicatorRight;
                            } else if (isLayoutRtl) {
                                indicatorRect.left = this.mChildIndicatorLeft == -1 ? this.mRight - this.mIndicatorRight : this.mRight - this.mChildIndicatorRight;
                                if (this.mChildIndicatorRight == -1) {
                                    i2 = this.mRight - this.mIndicatorLeft;
                                } else {
                                    i2 = this.mRight - this.mChildIndicatorLeft;
                                }
                            ...
                            indicatorRect.left = (isLayoutRtl ? -this.mPaddingRight : this.mPaddingLeft) + indicatorRect.left;
                            int i3 = indicatorRect.right;
                            if (isLayoutRtl) {
                                i2 = -this.mPaddingRight;
                            } else {
                                i2 = this.mPaddingLeft;
                            }
                            indicatorRect.right = i2 + i3;
