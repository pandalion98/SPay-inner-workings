...
public class VideoView extends SurfaceView implements MediaPlayerControl, Anchor {
    ...
    private boolean mWFDTcpDisable;
    ...
    public VideoView(Context context) {
        ...
        this.mErrorListener = new OnErrorListener() {
            public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
                Log.d(VideoView.this.TAG, "Error: " + framework_err + FingerprintManager.FINGER_PERMISSION_DELIMITER + impl_err);
    ...
    private void openVideo() {
        if (this.mUri != null && this.mSurfaceHolder != null) {
            ...
            if (this.mStopMusic) {
                ...
                String currentAudioFocus = am.getCurrentAudioFocusPackageName();
                if (currentAudioFocus == null || !currentAudioFocus.equals(this.mContext.getOpPackageName())) {
                    am.requestAudioFocus(null, 3, 1);
                } else {
                    Log.w(this.TAG, "Skip requesting AudioFocus, This package already requested the audio focus");
                }
                Intent i = new Intent("com.android.music.musicservicecommand");
                i.putExtra(MagazineIntents.COMMAND, "pause");
            ...
            try {
                ...
                if (this.mWFDTcpDisable) {
                    this.mMediaPlayer.setParameter(2500, 1);
                    Log.w(this.TAG, "Disable TCP mode for wfd, mWFDTcpDisable :  " + this.mWFDTcpDisable);
                }
    ...
    public void setStopMusic(boolean stopMusic) {
        this.mStopMusic = stopMusic;
    }

    public void setWFDTcpDisable(boolean wfdTcpDisable) {
        this.mWFDTcpDisable = wfdTcpDisable;
    }
}
