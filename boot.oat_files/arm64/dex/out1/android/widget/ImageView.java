...
public class ImageView extends View {
    ...
    private ImageViewBitmapDrawable mRecycleableBitmapDrawable;
    ...
    public ImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (d != null) {
            if (Build.IS_SYSTEM_SECURE) {
                TypedValue image = a.peekValue(0);
                if (image != null) {
                    d.setImagePath(image);
                }
            }
            setImageDrawable(d);
        }
    ...
    public void setImageBitmap(Bitmap bm) {
        ...
        if (this.mRecycleableBitmapDrawable == null) {
            this.mRecycleableBitmapDrawable = new ImageViewBitmapDrawable(this.mContext.getResources(), bm);
        } else {
            ...
            if (rsrc != null) {
                ...
                if (this.mResource != 0) {
                    try {
                        ...
                        if (Build.IS_SYSTEM_SECURE && d != null) {
                            TypedValue image = new TypedValue();
                            rsrc.getValue(this.mResource, image, true);
                            d.setImagePath(image);
                        }
                    } catch (Exception e) {
                    ...
                    } else if (AbsCocktailLoadablePanel.LOADABLE_CONTENT_CLASS.equals(scheme) || "file".equals(scheme)) {
                    ...
                    if (d == null) {
                        ...
                        this.mUri = null;
                    } else if (Build.IS_SYSTEM_SECURE) {
                        d.setImagePath(this.mUri.toString());
                    }
                } else {
                    return;
                }
    ...
    private void updateDrawable(Drawable d) {
        ...
        this.mDrawable = d;
        if (Build.IS_SYSTEM_SECURE && this.mDrawable != null && this.mDrawable.isImagePath()) {
            this.mImagePath = this.mDrawable.getImagePath();
        }
        if (d != null) {
            d.setCallback(this);
