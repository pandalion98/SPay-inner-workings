...
import android.widget.HorizontalListView.FixedViewInfo;
import java.util.ArrayList;
import java.util.Iterator;

public class HeaderViewHorizontalListAdapter implements WrapperListAdapter, Filterable {
    ...
    public HeaderViewHorizontalListAdapter(ArrayList<FixedViewInfo> headerViewInfos, ArrayList<FixedViewInfo> footerViewInfos, ListAdapter adapter) {
