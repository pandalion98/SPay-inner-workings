...
public class RelativeLayout extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            boolean z = (c.getApplicationInfo().targetSdkVersion < 17 && !((c.getApplicationInfo().flags & 1) != 0)) || !c.getApplicationInfo().hasRtlSupport();
    ...
    private int compareLayoutPosition(LayoutParams p1, LayoutParams p2) {
        ...
        return topDiff != 0 ? topDiff : p1.mLeft - p2.mLeft;
    }
