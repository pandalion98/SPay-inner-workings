        ...
        if (key == null) {
            ...
            if (key instanceof AndroidKeyStorePrivateKey) {
                ...
                if (keyAliasInKeystore.startsWith(Credentials.USER_PRIVATE_KEY)) {
                    return AndroidKeyStoreSecretKeyFactorySpi.getKeyInfo(this.mKeyStore, keyAliasInKeystore.substring(Credentials.USER_PRIVATE_KEY.length()), keyAliasInKeystore);
                }
