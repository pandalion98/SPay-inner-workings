...
class KeyStoreCryptoOperationChunkedStreamer implements KeyStoreCryptoOperationStreamer {
    ...
    public byte[] flush() throws KeyStoreException {
        ...
        if (this.mBufferedLength > 0) {
            String str;
            StringBuilder append = new StringBuilder().append("Keystore failed to consume last ");
            if (this.mBufferedLength != 1) {
                str = this.mBufferedLength + " bytes";
            } else {
                str = "byte";
            }
            throw new KeyStoreException(-21, append.append(str).append(" of input").toString());
        }
