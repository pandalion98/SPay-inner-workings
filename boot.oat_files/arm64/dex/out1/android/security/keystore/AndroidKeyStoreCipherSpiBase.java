...
abstract class AndroidKeyStoreCipherSpiBase extends CipherSpi implements KeyStoreCryptoOperation {
    ...
    private void ensureKeystoreOperationInitialized() throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        OperationResult opResult = this.mKeyStore.begin(this.mKey.getAlias(), purpose, true, keymasterInputArgs, additionalEntropy);
        if (opResult == null) {
    ...
    protected final byte[] engineWrap(Key key) throws IllegalBlockSizeException, InvalidKeyException {
        ...
        if (this.mKey == null) {
            ...
            try {
                ...
                throw ((IllegalBlockSizeException) new IllegalBlockSizeException().initCause(e8));
            }
        }
    }
                ...
                switch (wrappedKeyType) {
                    ...
                    case 2:
                        try {
                            ...
                            throw new InvalidKeyException("Failed to create private key from its PKCS#8 encoded form", e22);
                        }
                    case 3:
