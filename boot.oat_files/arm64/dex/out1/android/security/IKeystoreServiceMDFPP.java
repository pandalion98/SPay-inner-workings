...
public interface IKeystoreServiceMDFPP extends IKeystoreService {
    ...
    public static abstract class Stub extends Binder implements IKeystoreService {
        ...
        static final int TRANSACTION_getState_MDFPP = 37;
        static final int TRANSACTION_get_by_uid = 40;
        ...
        static final int TRANSACTION_migrate_MDFPP_keystore = 36;
        static final int TRANSACTION_onUserAdded = 34;
        static final int TRANSACTION_onUserAdded_MDFPP = 39;
        ...
        static final int TRANSACTION_reset_MDFPP = 38;
        ...
        private static class Proxy implements IKeystoreService {
            ...
            public byte[] get(String name) throws RemoteException {
                ...
                try {
                    ...
                    _data2.writeString("delete reply___");
                    _data2.writeInt(_reply.readInt());
                    this.mRemote.transact(2, _data2, null, 524288);
                    return _result;
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public int insert(String name, byte[] item, int uid, int flags) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeByteArray(new byte[item.length]);
                    _data.recycle();
                    MemoryWipeUtils.clear(this.mRemote, Stub.DESCRIPTOR, 1, item.length);
                    return _result;
                } catch (Throwable th) {
                    _reply.recycle();
                    _data.setDataPosition(_pos);
            ...
            public int onUserPasswordChanged(int userId, String newPassword) throws RemoteException {
                ...
                try {
                    ...
                    _data.recycle();
                    MemoryWipeUtils.clear(this.mRemote, Stub.DESCRIPTOR, 1, length);
                    return _result;
                } catch (Throwable th) {
                    _reply.recycle();
                    _data.setDataPosition(_pos);
            ...
            public int getKeyCharacteristics(String alias, KeymasterBlob clientId, KeymasterBlob appId, KeyCharacteristics characteristics) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public ExportResult exportKey(String alias, int format, KeymasterBlob clientId, KeymasterBlob appId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public OperationResult begin(IBinder appToken, String alias, int purpose, boolean pruneable, KeymasterArguments params, byte[] entropy) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public int migrate_MDFPP_keystore(String password, int uid, int isFingerprint) throws RemoteException {
                int length = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _pos = 0;
            ...
            public int getState_MDFPP(int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int reset_MDFPP(int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int onUserAdded_MDFPP(int userId, int parentId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public byte[] get_by_uid(String key, int uid) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    long _result5 = getmtime(data.readString());
                    reply.writeNoException();
                ...
                case 25:
                    ...
                    KeyCharacteristics _arg32 = new KeyCharacteristics();
                    _result = getKeyCharacteristics(_arg0, _arg13, _arg22, _arg32);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    if (_arg32 != null) {
                        reply.writeInt(1);
                ...
                case 26:
                    ...
                    _result = importKey(_arg0, _arg12, _arg2, _arg33, _arg4, _arg53, _arg6);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    if (_arg6 != null) {
                        reply.writeInt(1);
                ...
                case 27:
                    ...
                    if (data.readInt() != 0) {
                        _arg34 = (KeymasterBlob) KeymasterBlob.CREATOR.createFromParcel(data);
                    } else {
                        _arg34 = null;
                    }
                    ExportResult _result6 = exportKey(_arg0, _arg1, _arg22, _arg34);
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 28:
                    ...
                    if (data.readInt() != 0) {
                        _arg42 = (KeymasterArguments) KeymasterArguments.CREATOR.createFromParcel(data);
                    } else {
                        _arg42 = null;
                    }
                    _result3 = begin(_arg02, _arg14, _arg2, _arg35, _arg42, data.createByteArray());
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                    _result = migrate_MDFPP_keystore(data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 37:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getState_MDFPP(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 38:
                    data.enforceInterface(DESCRIPTOR);
                    _result = reset_MDFPP(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 39:
                    data.enforceInterface(DESCRIPTOR);
                    _result = onUserAdded_MDFPP(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 40:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = get_by_uid(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeByteArray(_result2);
                    return true;
                case 1598968902:
