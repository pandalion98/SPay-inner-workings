...
public class Credentials {
    ...
    public static final String EXTRA_WAPI_AS_CERTIFICATE_DATA = "wapi_as_certificates_data";
    public static final String EXTRA_WAPI_AS_CERTIFICATE_NAME = "wapi_as_certificates_name";
    public static final String EXTRA_WAPI_USER_CERTIFICATE_DATA = "wapi_user_certificates_data";
    public static final String EXTRA_WAPI_USER_CERTIFICATE_NAME = "wapi_user_certificates_name";
    ...
    public void install(Context context) {
        try {
            ...
            if (this.mSender != null) {
                intent.putExtra(KeyChain.EXTRA_SENDER_PACKAGE_NAME, this.mSender.getIntentSender().getCreatorPackage());
            }
    ...
    public static boolean deleteAllTypesForAlias(KeyStore keystore, String alias) {
        return (keystore.delete(USER_PRIVATE_KEY + alias) | keystore.delete(USER_SECRET_KEY + alias)) | deleteCertificateTypesForAlias(keystore, alias);
    }
    ...
    static boolean deletePrivateKeyTypeForAlias(KeyStore keystore, String alias) {
        return keystore.delete(USER_PRIVATE_KEY + alias);
    }

    public static boolean deleteSecretKeyTypeForAlias(KeyStore keystore, String alias) {
        return keystore.delete(USER_SECRET_KEY + alias);
    }
}
