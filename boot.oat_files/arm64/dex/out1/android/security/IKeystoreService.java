...
public interface IKeystoreService extends IInterface {
    ...
    int getState_MDFPP(int i) throws RemoteException;

    byte[] get_by_uid(String str, int i) throws RemoteException;
    ...
    int migrate_MDFPP_keystore(String str, int i, int i2) throws RemoteException;

    int onUserAdded(int i, int i2) throws RemoteException;

    int onUserAdded_MDFPP(int i, int i2) throws RemoteException;
    ...
    int reset_MDFPP(int i) throws RemoteException;
