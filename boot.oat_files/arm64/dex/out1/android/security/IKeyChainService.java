...
public interface IKeyChainService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IKeyChainService {
        ...
        static final int TRANSACTION_allSystemAliases = 16;
        ...
        static final int TRANSACTION_findIssuer = 19;
        static final int TRANSACTION_getCaCertificateChainAliases = 11;
        static final int TRANSACTION_getCertificate = 2;
        static final int TRANSACTION_getCertificateAlias = 15;
        static final int TRANSACTION_getCertificateFromTrustCredential = 14;
        ...
        static final int TRANSACTION_userAliases = 17;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = installKeyPair(data.createByteArray(), data.createByteArray(), data.readString());
                    reply.writeNoException();
                    if (_result3) {
                        i = 1;
                    }
                ...
                case 10:
                    ...
                    _result2 = getEncodedCaCertificate(_arg0, _arg1);
                    reply.writeNoException();
                    reply.writeByteArray(_result2);
                    return true;
                case 11:
                    ...
                    _result5 = getCaCertificateChainAliases(_arg0, _arg1);
                    reply.writeNoException();
                ...
                case 14:
                    ...
                    _result2 = getCertificateFromTrustCredential(_arg0, _arg1);
                    reply.writeNoException();
                    reply.writeByteArray(_result2);
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getCertificateAlias(data.createByteArray());
                    reply.writeNoException();
                    reply.writeString(_result);
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = allSystemAliases();
                    reply.writeNoException();
                    reply.writeStringList(_result5);
                    return true;
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = userAliases();
                    reply.writeNoException();
                    reply.writeStringList(_result5);
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = containsAlias(data.readString());
                    reply.writeNoException();
                    if (_result3) {
                        i = 1;
                    }
                ...
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = findIssuer(data.createByteArray());
                    reply.writeNoException();
                    reply.writeByteArray(_result2);
                    return true;
                case 1598968902:
