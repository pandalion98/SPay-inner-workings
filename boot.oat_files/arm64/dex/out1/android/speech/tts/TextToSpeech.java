...
public class TextToSpeech {
    ...
    private Bundle mRestartParams;
    private int mRestartQueueMode;
    private CharSequence mRestartText;
                    ...
                    if (isCancelled()) {
                        ...
                        try {
                            ...
                            if (TextToSpeech.this.mParams.getString(Engine.KEY_PARAM_LANGUAGE) == null) {
                                ...
                                TextToSpeech.this.mParams.putString(Engine.KEY_PARAM_LANGUAGE, defaultLanguage[0]);
        ...
        public <R> R runAction(Action<R> action, R errorResult, String method, boolean reconnect, boolean onlyEstablishedConnection) {
            synchronized (TextToSpeech.this.mStartLock) {
                try {
                    ...
                    Log.e(TextToSpeech.TAG, method + AuditEvents.FAILED, ex);
                    if (reconnect) {
                        disconnect();
    ...
    private boolean connectToEngine(String engine) {
        ...
        this.mEngineName = intent.getPackage();
    ...
    public int speak(CharSequence text, int queueMode, Bundle params, String utteranceId) {
        ...
        return ((Integer) runAction(new Action<Integer>() {
            public Integer run(ITextToSpeechService service) throws RemoteException {
                TextToSpeech.this.mRestartText = charSequence;
                TextToSpeech.this.mRestartQueueMode = i;
                if (bundle != null) {
                    TextToSpeech.this.mRestartParams = new Bundle(bundle);
                } else {
                    TextToSpeech.this.mRestartParams = null;
                }
    ...
    public int resume() {
        return ((Integer) runAction(new Action<Integer>() {
            public Integer run(ITextToSpeechService service) throws RemoteException {
                Log.d(TextToSpeech.TAG, "textToSpeech : resume() - method");
                return Integer.valueOf(service.resume(TextToSpeech.this.getCallerIdentity()));
            }
        }, Integer.valueOf(-1), "resume")).intValue();
    }

    public int pause() {
        return ((Integer) runAction(new Action<Integer>() {
            public Integer run(ITextToSpeechService service) throws RemoteException {
                Log.d(TextToSpeech.TAG, "textToSpeech : pause() - method");
                return Integer.valueOf(service.pause(TextToSpeech.this.getCallerIdentity()));
            }
        }, Integer.valueOf(-1), "pause")).intValue();
    }

    public int restart() {
        Log.d(TAG, "textToSpeech : restart() - method");
        if (getCallerIdentity() == null) {
            return -1;
        }
        stop();
        return speak(this.mRestartText, this.mRestartQueueMode, this.mRestartParams, null);
    }

    public boolean isPaused() {
        return ((Boolean) runAction(new Action<Boolean>() {
            public Boolean run(ITextToSpeechService service) throws RemoteException {
                return Boolean.valueOf(service.isPaused());
            }
        }, Boolean.valueOf(false), "isPaused")).booleanValue();
    }
            ...
            public Integer run(ITextToSpeechService service) throws RemoteException {
                ...
                try {
                    ...
                    try {
                        ...
                        if (!"com.google.android.tts".equalsIgnoreCase(TextToSpeech.this.mEngineName) && "spa".equals(language) && "USA".equals(country)) {
                            country = "MEX";
                        }
    ...
    public Locale getLanguage() {
        return (Locale) runAction(new Action<Locale>() {
            public Locale run(ITextToSpeechService service) {
                return new Locale(TextToSpeech.this.mParams.getString(Engine.KEY_PARAM_LANGUAGE, ""), TextToSpeech.this.mParams.getString(Engine.KEY_PARAM_COUNTRY, ""), TextToSpeech.this.mParams.getString(Engine.KEY_PARAM_VARIANT, ""));
            }
        }, null, "getLanguage");
    }
        ...
        return ((Integer) runAction(new Action<Integer>() {
            public Integer run(ITextToSpeechService service) throws RemoteException {
                try {
                    ...
                    Log.e(TextToSpeech.TAG, "Opening file " + file2 + AuditEvents.FAILED, e);
                    return Integer.valueOf(-1);
                } catch (IOException e2) {
                    Log.e(TextToSpeech.TAG, "Closing file " + file2 + AuditEvents.FAILED, e2);
                    return Integer.valueOf(-1);
                }
            }
