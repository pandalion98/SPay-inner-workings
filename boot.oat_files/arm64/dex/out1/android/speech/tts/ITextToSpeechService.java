...
public interface ITextToSpeechService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITextToSpeechService {
        ...
        static final int TRANSACTION_getClientDefaultLanguage = 11;
        static final int TRANSACTION_getDefaultVoiceNameFor = 18;
        static final int TRANSACTION_getFeaturesForLanguage = 13;
        static final int TRANSACTION_getLanguage = 10;
        static final int TRANSACTION_getVoices = 16;
        static final int TRANSACTION_isLanguageAvailable = 12;
        static final int TRANSACTION_isPaused = 3;
        static final int TRANSACTION_isSpeaking = 8;
        static final int TRANSACTION_loadLanguage = 14;
        static final int TRANSACTION_loadVoice = 17;
        static final int TRANSACTION_pause = 2;
        static final int TRANSACTION_playAudio = 6;
        static final int TRANSACTION_playSilence = 7;
        static final int TRANSACTION_resume = 1;
        static final int TRANSACTION_setCallback = 15;
        static final int TRANSACTION_speak = 4;
        static final int TRANSACTION_stop = 9;
        static final int TRANSACTION_synthesizeToFileDescriptor = 5;
        ...
        private static class Proxy implements ITextToSpeechService {
            ...
            public int resume(IBinder callingInstance) throws RemoteException {
            ...
            public int pause(IBinder callingInstance) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    _result = resume(data.readStrongBinder());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    _result = pause(data.readStrongBinder());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 3:
                ...
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getLanguage();
                    reply.writeNoException();
                    reply.writeStringArray(_result3);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getClientDefaultLanguage();
                    reply.writeNoException();
                    reply.writeStringArray(_result3);
                    return true;
                case 12:
                ...
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getFeaturesForLanguage(data.readString(), data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeStringArray(_result3);
                    return true;
                case 14:
    ...
    int pause(IBinder iBinder) throws RemoteException;
    ...
    int resume(IBinder iBinder) throws RemoteException;
