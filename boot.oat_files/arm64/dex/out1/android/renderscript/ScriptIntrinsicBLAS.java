...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    public void DTRMV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 57, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void ZTRMV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 73, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void DTRSV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        validateTRMV(Element.F64(this.mRS), Uplo, TransA, Diag, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 60, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void ZTRSV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        validateTRMV(Element.F64_2(this.mRS), Uplo, TransA, Diag, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 76, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void DSYR(int Uplo, double alpha, Allocation X, int incX, Allocation A) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 91, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, X.getID(this.mRS), A.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void DSPR(int Uplo, double alpha, Allocation X, int incX, Allocation Ap) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 92, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, X.getID(this.mRS), Ap.getID(this.mRS), 0.0d, 0, incX, 0, 0, 0);
    }
    ...
    public void CHEMV(int Uplo, Float2 alpha, Allocation A, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 95, 0, 0, 0, Uplo, 0, 0, N, 0, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CHBMV(int Uplo, int K, Float2 alpha, Allocation A, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 96, 0, 0, 0, Uplo, 0, 0, N, K, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CHPMV(int Uplo, Float2 alpha, Allocation Ap, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 97, 0, 0, 0, Uplo, 0, 0, N, 0, alpha.x, alpha.y, Ap.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CHER(int Uplo, float alpha, Allocation X, int incX, Allocation A) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 100, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, 0.0f, X.getID(this.mRS), 0, 0.0f, 0.0f, A.getID(this.mRS), incX, 0, 0, 0);
    }
    ...
    public void CHPR(int Uplo, float alpha, Allocation X, int incX, Allocation Ap) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 101, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, 0.0f, X.getID(this.mRS), 0, 0.0f, 0.0f, Ap.getID(this.mRS), incX, 0, 0, 0);
    }

    public void CHER2(int Uplo, Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        int N = validateSYR2(Element.F32_2(this.mRS), Uplo, X, incX, Y, incY, A);
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 102, 0, 0, 0, Uplo, 0, 0, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, 0.0f, A.getID(this.mRS), incX, incY, 0, 0);
    }

    public void CHPR2(int Uplo, Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
        int N = validateSPR2(Element.F32_2(this.mRS), Uplo, X, incX, Y, incY, Ap);
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 103, 0, 0, 0, Uplo, 0, 0, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, 0.0f, Ap.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZHEMV(int Uplo, Double2 alpha, Allocation A, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 104, 0, 0, 0, Uplo, 0, 0, N, 0, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZHBMV(int Uplo, int K, Double2 alpha, Allocation A, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 105, 0, 0, 0, Uplo, 0, 0, N, K, alpha.x, alpha.y, A.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZHPMV(int Uplo, Double2 alpha, Allocation Ap, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 106, 0, 0, 0, Uplo, 0, 0, N, 0, alpha.x, alpha.y, Ap.getID(this.mRS), X.getID(this.mRS), beta.x, beta.y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZHER(int Uplo, double alpha, Allocation X, int incX, Allocation A) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 109, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, 0.0d, X.getID(this.mRS), 0, 0.0d, 0.0d, A.getID(this.mRS), incX, 0, 0, 0);
    }
    ...
    public void ZHPR(int Uplo, double alpha, Allocation X, int incX, Allocation Ap) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 110, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, 0.0d, X.getID(this.mRS), 0, 0.0d, 0.0d, Ap.getID(this.mRS), incX, 0, 0, 0);
    }

    public void ZHER2(int Uplo, Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        int N = validateSYR2(Element.F64_2(this.mRS), Uplo, X, incX, Y, incY, A);
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 111, 0, 0, 0, Uplo, 0, 0, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, 0.0d, A.getID(this.mRS), incX, incY, 0, 0);
    }

    public void ZHPR2(int Uplo, Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
        int N = validateSPR2(Element.F64_2(this.mRS), Uplo, X, incX, Y, incY, Ap);
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 112, 0, 0, 0, Uplo, 0, 0, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, 0.0d, Ap.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void DSYMM(int Side, int Uplo, double alpha, Allocation A, Allocation B, double beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 120, 0, 0, Side, Uplo, 0, C.getType().getY(), C.getType().getX(), 0, alpha, A.getID(this.mRS), B.getID(this.mRS), beta, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CSYMM(int Side, int Uplo, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 126, 0, 0, Side, Uplo, 0, C.getType().getY(), C.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZSYMM(int Side, int Uplo, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 132, 0, 0, Side, Uplo, 0, C.getType().getY(), C.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CSYRK(int Uplo, int Trans, Float2 alpha, Allocation A, Float2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 127, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), K, alpha.x, alpha.y, A.getID(this.mRS), 0, beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZSYRK(int Uplo, int Trans, Double2 alpha, Allocation A, Double2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 133, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), K, alpha.x, alpha.y, A.getID(this.mRS), 0, beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void DSYR2K(int Uplo, int Trans, double alpha, Allocation A, Allocation B, double beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 122, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), K, alpha, A.getID(this.mRS), B.getID(this.mRS), beta, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CSYR2K(int Uplo, int Trans, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 128, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), K, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZSYR2K(int Uplo, int Trans, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 134, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), K, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void DTRMM(int Side, int Uplo, int TransA, int Diag, double alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 123, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0, 0, 0, 0, 0);
    }
    ...
    public void CTRMM(int Side, int Uplo, int TransA, int Diag, Float2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 129, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0.0f, 0, 0, 0, 0, 0);
    }
    ...
    public void ZTRMM(int Side, int Uplo, int TransA, int Diag, Double2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 135, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0.0d, 0, 0, 0, 0, 0);
    }
    ...
    public void DTRSM(int Side, int Uplo, int TransA, int Diag, double alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 124, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0, 0, 0, 0, 0);
    }
    ...
    public void CTRSM(int Side, int Uplo, int TransA, int Diag, Float2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 130, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0.0f, 0, 0, 0, 0, 0);
    }
    ...
    public void ZTRSM(int Side, int Uplo, int TransA, int Diag, Double2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 136, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0.0d, 0, 0, 0, 0, 0);
    }
    ...
    public void CHEMM(int Side, int Uplo, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 137, 0, 0, Side, Uplo, 0, C.getType().getY(), C.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZHEMM(int Side, int Uplo, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 140, 0, 0, Side, Uplo, 0, C.getType().getY(), C.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CHERK(int Uplo, int Trans, float alpha, Allocation A, float beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 138, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), k, alpha, 0.0f, A.getID(this.mRS), 0, beta, 0.0f, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZHERK(int Uplo, int Trans, double alpha, Allocation A, double beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 141, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), k, alpha, 0.0d, A.getID(this.mRS), 0, beta, 0.0d, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CHER2K(int Uplo, int Trans, Float2 alpha, Allocation A, Allocation B, float beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 139, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), k, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta, 0.0f, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZHER2K(int Uplo, int Trans, Double2 alpha, Allocation A, Allocation B, double beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 142, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), k, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta, 0.0d, C.getID(this.mRS), 0, 0, 0, 0);
    }
