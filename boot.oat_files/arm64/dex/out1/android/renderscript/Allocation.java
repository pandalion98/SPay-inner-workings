...
public class Allocation extends BaseObj {
    ...
    L_0x000f:
        r0 = new android.renderscript.RSIllegalArgumentException;	 Catch:{ all -> 0x0017 }
        r1 = "Source must be exactly one usage type.";
    ...
    L_0x0017:
        ...
        throw r0;
    L_0x001c:
        r0 = r6.mUsage;	 Catch:{ all -> 0x0017 }
        r0 = r0 & 128;
        if (r0 == 0) goto L_0x0027;
    L_0x0022:
        r0 = r6.mBitmap;	 Catch:{ all -> 0x0017 }
        r6.copyFrom(r0);	 Catch:{ all -> 0x0017 }
    L_0x0027:
        r0 = r6.mRS;	 Catch:{ all -> 0x0017 }
        r0.validate();	 Catch:{ all -> 0x0017 }
        r0 = r6.mRS;	 Catch:{ all -> 0x0017 }
        r2 = r6.getIDSafe();	 Catch:{ all -> 0x0017 }
        r0.nAllocationSyncAll(r2, r7);	 Catch:{ all -> 0x0017 }
        android.os.Trace.traceEnd(r4);
        return;
    L_0x0039:
        r0 = r6.mUsage;	 Catch:{ all -> 0x0017 }
    ...
    L_0x003f:
        r0 = r6.mBitmap;	 Catch:{ all -> 0x0017 }
        r6.copyTo(r0);	 Catch:{ all -> 0x0017 }
        goto L_0x0027;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.renderscript.Allocation.syncAll(int):void");
    }
    ...
    public static Allocation createTyped(RenderScript rs, Type type, MipmapControl mips, int usage) {
        try {
            ...
            Allocation allocation = new Allocation(id, rs, type, usage);
            return allocation;
        } finally {
            Trace.traceEnd(32768);
        }
    ...
    public static Allocation createSized(RenderScript rs, Element e, int count, int usage) {
        try {
            ...
            Allocation allocation = new Allocation(id, rs, t, usage);
            return allocation;
        } finally {
            Trace.traceEnd(32768);
        }
        ...
        try {
            ...
            if (b.getConfig() != null) {
                ...
                if (mips == MipmapControl.MIPMAP_NONE && t.getElement().isCompatible(Element.RGBA_8888(rs)) && usage == 131) {
                    ...
                    alloc = new Allocation(id, rs, t, usage);
                    alloc.setBitmap(b);
                    Trace.traceEnd(32768);
                    return alloc;
                }
                ...
                Bitmap newBitmap = Bitmap.createBitmap(b.getWidth(), b.getHeight(), Config.ARGB_8888);
                new Canvas(newBitmap).drawBitmap(b, 0.0f, 0.0f, null);
                alloc = createFromBitmap(rs, newBitmap, mips, usage);
                return alloc;
            }
        } finally {
            Trace.traceEnd(32768);
