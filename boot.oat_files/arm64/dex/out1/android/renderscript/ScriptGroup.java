...
public final class ScriptGroup extends BaseObj {
    ...
    ScriptGroup(RenderScript rs, String name, List<Closure> closures, List<Input> inputs, Future[] outputs) {
        ...
        setID(rs.nScriptGroup2Create(name, ScriptC.mCachePath, closureIDs));
    }
    ...
    public Object[] execute(Object... inputs) {
        ...
        if (inputs.length < this.mInputs2.size()) {
            ...
            objArr = new Object[this.mOutputs2.length];
            Future[] arr$ = this.mOutputs2;
            int len$ = arr$.length;
            int i$ = 0;
            int i2 = 0;
            while (i$ < len$) {
                Object output = arr$[i$].getValue();
