...
public class Matrix4f {
    ...
    public void loadOrthoWindow(int w, int h) {
        loadOrtho(0.0f, (float) w, (float) h, 0.0f, LayoutParams.BRIGHTNESS_OVERRIDE_NONE, 1.0f);
    }
    ...
    public void loadProjectionNormalized(int w, int h) {
        ...
        if (w > h) {
            ...
            m1.loadFrustum(-aspect, aspect, LayoutParams.BRIGHTNESS_OVERRIDE_NONE, 1.0f, 1.0f, 100.0f);
        } else {
            aspect = ((float) h) / ((float) w);
            m1.loadFrustum(LayoutParams.BRIGHTNESS_OVERRIDE_NONE, 1.0f, -aspect, aspect, 1.0f, 100.0f);
        }
