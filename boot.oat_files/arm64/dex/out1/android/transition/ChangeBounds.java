                ...
                if (this.mResizeClip) {
                    ...
                    if (numChanges == 2) {
                        if (startWidth == endWidth && startHeight == endHeight) {
                            mergeAnimators = ObjectAnimator.ofObject(view, POSITION_PROPERTY, null, getPathMotion().getPath((float) startLeft, (float) startTop, (float) endLeft, (float) endTop));
                        } else {
                        ...
                        mergeAnimators = ObjectAnimator.ofObject(view, BOTTOM_RIGHT_ONLY_PROPERTY, null, getPathMotion().getPath((float) startRight, (float) startBottom, (float) endRight, (float) endBottom));
                    } else {
                        mergeAnimators = ObjectAnimator.ofObject(view, TOP_LEFT_ONLY_PROPERTY, null, getPathMotion().getPath((float) startLeft, (float) startTop, (float) endLeft, (float) endTop));
                    }
                }
