...
public class ChangeText extends Transition {
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (this.mChangeBehavior == 0) {
            ...
            startColor = ((Integer) startVals.get(PROPNAME_TEXT_COLOR)).intValue();
            ...
            if (this.mChangeBehavior == 3 || this.mChangeBehavior == 1) {
                outAnim = ValueAnimator.ofInt(new int[]{255, 0});
                final int i = startColor;
                outAnim.addUpdateListener(new AnimatorUpdateListener() {
                    public void onAnimationUpdate(ValueAnimator animation) {
                        view.setTextColor((((((Integer) animation.getAnimatedValue()).intValue() << 24) | (i & Spanned.SPAN_PRIORITY)) | (i & 65280)) | (i & 255));
                    }
                });
            ...
            if (this.mChangeBehavior == 3 || this.mChangeBehavior == 2) {
                inAnim = ValueAnimator.ofInt(new int[]{0, 255});
