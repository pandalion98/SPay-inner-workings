...
public interface ITAController extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITAController {
        private static final String DESCRIPTOR = "android.spay.ITAController";
        static final int TRANSACTION_clearDeviceCertificates = 8;
        static final int TRANSACTION_copyMctoRst = 7;
        static final int TRANSACTION_getCertInfo = 4;
        static final int TRANSACTION_loadTA = 1;
        static final int TRANSACTION_makeSystemCall = 6;
        static final int TRANSACTION_processTACommand = 3;
        static final int TRANSACTION_setCertInfo = 5;
        ...
        private static class Proxy implements ITAController {
            ...
            public TACommandResponse processTACommand(TACommandRequest request) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (TACommandResponse) TACommandResponse.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
            ...
            public CertInfo getCertInfo() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    CertInfo _result;
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (CertInfo) CertInfo.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
            ...
            public boolean setCertInfo(CertInfo certInfo) throws RemoteException {
                boolean _result = true;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    if (certInfo != null) {
                        _data.writeInt(1);
                        certInfo.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
            ...
            public boolean copyMctoRst() throws RemoteException {
                boolean _result = false;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public boolean clearDeviceCertificates() throws RemoteException {
                boolean _result = false;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    _result = loadTA(_arg0, data.readLong(), data.readLong());
                ...
                case 3:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg02 = (TACommandRequest) TACommandRequest.CREATOR.createFromParcel(data);
                    } else {
                        _arg02 = null;
                    }
                ...
                case 5:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg03 = (CertInfo) CertInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg03 = null;
                    }
                    _result = setCertInfo(_arg03);
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    _result = makeSystemCall(data.readInt());
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    _result = clearDeviceCertificates();
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
    ...
    boolean clearDeviceCertificates() throws RemoteException;

    boolean copyMctoRst() throws RemoteException;

    CertInfo getCertInfo() throws RemoteException;
    ...
    boolean setCertInfo(CertInfo certInfo) throws RemoteException;
