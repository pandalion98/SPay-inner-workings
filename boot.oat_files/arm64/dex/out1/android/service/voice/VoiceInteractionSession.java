...
public class VoiceInteractionSession implements Callback, ComponentCallbacks2 {
    ...
    public VoiceInteractionSession(Context context, Handler handler) {
        ...
        this.mSession = new IVoiceInteractionSession.Stub() {
            ...
            public void handleAssist(Bundle data, AssistStructure structure, AssistContent content) {
                ...
                new Thread("AssistStructure retriever") {
                    public void run() {
                        ...
                        VoiceInteractionSession.this.mHandlerCaller.sendMessage(VoiceInteractionSession.this.mHandlerCaller.obtainMessageOOOO(104, bundle, failure == null ? assistStructure : null, failure, assistContent));
                    }
                }.start();
            }
