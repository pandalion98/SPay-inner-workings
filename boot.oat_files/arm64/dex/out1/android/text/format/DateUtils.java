...
public class DateUtils {
    ...
    public static CharSequence formatDuration(long millis) {
        ...
        if (millis >= HOUR_IN_MILLIS) {
            return res.getQuantityString(R.plurals.duration_hours, (int) ((1800000 + millis) / HOUR_IN_MILLIS), new Object[]{Integer.valueOf((int) ((1800000 + millis) / HOUR_IN_MILLIS))});
        } else if (millis >= MINUTE_IN_MILLIS) {
            return res.getQuantityString(R.plurals.duration_minutes, (int) ((30000 + millis) / MINUTE_IN_MILLIS), new Object[]{Integer.valueOf((int) ((30000 + millis) / MINUTE_IN_MILLIS))});
        } else {
            return res.getQuantityString(R.plurals.duration_seconds, (int) ((500 + millis) / 1000), new Object[]{Integer.valueOf((int) ((500 + millis) / 1000))});
        }
    }
