...
public class ModemActivityInfo implements Parcelable {
    ...
    public String toString() {
        return "ModemActivityInfo{ mTimestamp=" + this.mTimestamp + " mSleepTimeMs=" + this.mSleepTimeMs + " mTxTimeMs[]=" + Arrays.toString(this.mTxTimeMs) + " mRxTimeMs=" + this.mRxTimeMs + " mEnergyUsed=" + this.mEnergyUsed + "}";
    }
    ...
    public boolean isValid() {
        ...
        return (getIdleTimeMillis() == 0 && totalTxTimeMs == 0 && getSleepTimeMillis() == 0 && getIdleTimeMillis() == 0) ? false : true;
    }
}
