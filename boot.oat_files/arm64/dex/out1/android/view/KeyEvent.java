...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_ACTIVE = 1065;
    public static final int KEYCODE_ALT_GR = 1010;
    public static final int KEYCODE_ALT_LEFT = 57;
    public static final int KEYCODE_ALT_RIGHT = 58;
    public static final int KEYCODE_APOSTROPHE = 75;
    public static final int KEYCODE_APPLICATION = 1002;
    public static final int KEYCODE_APPSELECT = 1073;
    ...
    public static final int KEYCODE_CAMERA_FLASH = 1028;
    public static final int KEYCODE_CAMERA_FOCUS_RING_LEFT = 1030;
    public static final int KEYCODE_CAMERA_FOCUS_RING_RIGHT = 1031;
    public static final int KEYCODE_CAMERA_FUNCTION = 1029;
    public static final int KEYCODE_CAMERA_RECORD = 1022;
    public static final int KEYCODE_CAMERA_ZOOM_RING_IN = 1032;
    public static final int KEYCODE_CAMERA_ZOOM_RING_MOVE = 1034;
    public static final int KEYCODE_CAMERA_ZOOM_RING_OUT = 1033;
    public static final int KEYCODE_CAMERA_ZOOM_RING_SPEED1 = 1038;
    public static final int KEYCODE_CAMERA_ZOOM_RING_SPEED2 = 1039;
    public static final int KEYCODE_CAMERA_ZOOM_RING_SPEED3 = 1040;
    public static final int KEYCODE_CAMERA_ZOOM_RING_SPEED4 = 1041;
    public static final int KEYCODE_CAM_QUICK = 1066;
    public static final int KEYCODE_CAM_QUICK_FRONT = 1068;
    public static final int KEYCODE_CAM_QUICK_REAR = 1067;
    ...
    public static final int KEYCODE_DMB_ANT_CLOSE = 1018;
    public static final int KEYCODE_DMB_ANT_OPEN = 1017;
    public static final int KEYCODE_DPAD_CENTER = 23;
    public static final int KEYCODE_DPAD_DOWN = 20;
    public static final int KEYCODE_DPAD_LEFT = 21;
    public static final int KEYCODE_DPAD_RIGHT = 22;
    public static final int KEYCODE_DPAD_UP = 19;
    public static final int KEYCODE_DUMMY_BACK = 1025;
    public static final int KEYCODE_DUMMY_HOME = 1024;
    public static final int KEYCODE_DUMMY_HOME1 = 1026;
    public static final int KEYCODE_DUMMY_HOME2 = 1027;
    public static final int KEYCODE_DUMMY_MENU = 1023;
    public static final int KEYCODE_DVR = 173;
    public static final int KEYCODE_E = 33;
    public static final int KEYCODE_EISU = 212;
    public static final int KEYCODE_EMAIL = 1008;
    ...
    public static final int KEYCODE_F24 = 1074;
    ...
    public static final int KEYCODE_FINGER_DETECTED = 1045;
    public static final int KEYCODE_FINGER_REMOVED = 1046;
    ...
    public static final int KEYCODE_JOG_LEFT = 1019;
    public static final int KEYCODE_JOG_RIGHT = 1020;
    public static final int KEYCODE_JOG_SELECT = 1021;
    public static final int KEYCODE_K = 39;
    public static final int KEYCODE_KANA = 218;
    public static final int KEYCODE_KATAKANA_HIRAGANA = 215;
    public static final int KEYCODE_L = 40;
    public static final int KEYCODE_LANG = 1005;
    public static final int KEYCODE_LANGUAGE_SWITCH = 204;
    public static final int KEYCODE_LAST_CHANNEL = 229;
    public static final int KEYCODE_LEFT_BRACKET = 71;
    public static final int KEYCODE_LOCK = 1011;
    ...
    public static final int KEYCODE_MESSAGE = 1072;
    public static final int KEYCODE_META_LEFT = 117;
    public static final int KEYCODE_META_RIGHT = 118;
    public static final int KEYCODE_MINIMODE_ON_OFF = 1000;
    ...
    public static final int KEYCODE_PDCT = 1016;
    ...
    public static final int KEYCODE_QPANEL_ON_OFF = 1003;
    public static final int KEYCODE_QUESTION = 1014;
    public static final int KEYCODE_R = 46;
    public static final int KEYCODE_RECENTAPPS = 1001;
    public static final int KEYCODE_RIGHT_BRACKET = 72;
    public static final int KEYCODE_RO = 217;
    public static final int KEYCODE_S = 47;
    public static final int KEYCODE_SCREEN_CAPTURE = 1004;
    ...
    public static final int KEYCODE_SIDE_CAMERA_DETECTED = 1059;
    ...
    public static final int KEYCODE_VOICESEARCH = 1007;
    ...
    private static final int LAST_KEYCODE = 275;
    @Deprecated
    public static final int MAX_KEYCODE = 84;
    private static final int MAX_RECYCLED = 10;
    private static final int META_ALL_MASK = 7827711;
    public static final int META_ALT_GR_ON = 32768;
    ...
    private static final int SAMSUNG_LAST_KEYCODE = 1076;
    ...
    public static class DispatcherState {
        ...
        public void handleUpEvent(KeyEvent event) {
            ...
            if (index >= 0) {
                KeyEvent.access$076(event, R.styleable.Theme_alertDialogCenterButtons);
    ...
    public static KeyEvent obtain(long downTime, long eventTime, int action, int code, int repeat, int metaState, int deviceId, int scancode, int flags, int displayId, int source, String characters) {
        KeyEvent ev = obtain();
        ev.mDownTime = downTime;
        ev.mEventTime = eventTime;
        ev.mAction = action;
    ...
    public static final boolean isWakeKey(int keyCode) {
        switch (keyCode) {
            ...
            case 1017:
            case 1018:
            case KEYCODE_WATCH /*1049*/:
            case KEYCODE_VOICE_WAKEUP /*1062*/:
            case KEYCODE_VOICE_WAKEUP_LPSD /*1063*/:
                return true;
            default:
                return false;
        }
    ...
    public final boolean isAltRightPressed() {
        return (this.mMetaState & 32) != 0;
    }

    public final void setClearRightShiftPressed() {
        this.mMetaState &= -129;
        if ((this.mMetaState & 64) == 0) {
            this.mMetaState &= -2;
        }
    }
    ...
    public final boolean isAltGrPressed() {
        return (this.mMetaState & 32768) != 0;
    }
