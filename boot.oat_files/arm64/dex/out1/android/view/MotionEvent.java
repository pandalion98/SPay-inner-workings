...
public final class MotionEvent extends InputEvent implements Parcelable {
    ...
    public static final int AXIS_GRIP = 49;
    public static final int AXIS_HAT_X = 15;
    public static final int AXIS_HAT_Y = 16;
    public static final int AXIS_HSCROLL = 10;
    public static final int AXIS_LTRIGGER = 17;
    public static final int AXIS_ORIENTATION = 8;
    public static final int AXIS_PALM = 48;
    public static final int AXIS_PREDICTED_X = 51;
    public static final int AXIS_PREDICTED_Y = 52;
    ...
    public static final int BUTTON_3FINGER_DOWN = 2097152;
    public static final int BUTTON_3FINGER_LEFT = 4194304;
    public static final int BUTTON_3FINGER_RIGHT = 8388608;
    public static final int BUTTON_3FINGER_UP = 1048576;
    ...
    public static final int FLAG_BOTH_DISPLAY_TOUCH_HOLD = 268435456;
    ...
    boolean mNeedWindowOffset = false;
    private MotionEvent mNext;
    float mScaleFactorX = 1.0f;
    float mScaleFactorY = 1.0f;
    int mScaledWindowOffsetX = 0;
    int mScaledWindowOffsetY = 0;
    int mWindowOffsetX = 0;
    int mWindowOffsetY = 0;
    ...
    private static native long nativeInitialize(long j, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, float f, float f2, float f3, float f4, long j2, long j3, int i9, PointerProperties[] pointerPropertiesArr, PointerCoords[] pointerCoordsArr);
    ...
    public static MotionEvent obtain(long downTime, long eventTime, int action, int pointerCount, PointerProperties[] pointerProperties, PointerCoords[] pointerCoords, int metaState, int buttonState, float xPrecision, float yPrecision, int deviceId, int edgeFlags, int source, int flags) {
        ...
        ev.mNativePtr = nativeInitialize(ev.mNativePtr, deviceId, source, action, flags, edgeFlags, metaState, buttonState, 0, 0.0f, 0.0f, xPrecision, yPrecision, downTime * 1000000, eventTime * 1000000, pointerCount, pointerProperties, pointerCoords);
        return ev;
    }

    public static MotionEvent obtain(long downTime, long eventTime, int action, int pointerCount, PointerProperties[] pointerProperties, PointerCoords[] pointerCoords, int metaState, int buttonState, int displayId, float xPrecision, float yPrecision, int deviceId, int edgeFlags, int source, int flags) {
        MotionEvent ev = obtain();
        ev.mNativePtr = nativeInitialize(ev.mNativePtr, deviceId, source, action, flags, edgeFlags, metaState, buttonState, displayId, 0.0f, 0.0f, xPrecision, yPrecision, downTime * 1000000, eventTime * 1000000, pointerCount, pointerProperties, pointerCoords);
        return ev;
    }
    ...
    public static MotionEvent obtain(long downTime, long eventTime, int action, float x, float y, float pressure, float size, int metaState, float xPrecision, float yPrecision, int deviceId, int edgeFlags) {
        ...
        synchronized (gSharedTempLock) {
            ...
            pc[0].size = size;
            ev.mNativePtr = nativeInitialize(ev.mNativePtr, deviceId, 0, action, 0, edgeFlags, metaState, 0, 0, 0.0f, 0.0f, xPrecision, yPrecision, downTime * 1000000, eventTime * 1000000, 1, pp, pc);
        }
        return ev;
    }

    public static MotionEvent obtain(long downTime, long eventTime, int action, float x, float y, float pressure, float size, int metaState, int displayId, float xPrecision, float yPrecision, int deviceId, int edgeFlags) {
        MotionEvent ev = obtain();
        synchronized (gSharedTempLock) {
            ensureSharedTempPointerCapacity(1);
            PointerProperties[] pp = gSharedTempPointerProperties;
            ...
            pc[0].pressure = pressure;
            pc[0].size = size;
            ev.mNativePtr = nativeInitialize(ev.mNativePtr, deviceId, 0, action, 0, edgeFlags, metaState, 0, displayId, 0.0f, 0.0f, xPrecision, yPrecision, downTime * 1000000, eventTime * 1000000, 1, pp, pc);
        }
        return ev;
    }
    ...
    public static MotionEvent obtain(MotionEvent other) {
        ...
        if (other.mNeedWindowOffset) {
            ev.mNeedWindowOffset = other.mNeedWindowOffset;
            ev.mWindowOffsetX = other.mWindowOffsetX;
            ev.mWindowOffsetY = other.mWindowOffsetY;
            ev.mScaleFactorX = other.mScaleFactorX;
            ev.mScaleFactorY = other.mScaleFactorY;
            ev.mScaledWindowOffsetX = other.mScaledWindowOffsetX;
            ev.mScaledWindowOffsetY = other.mScaledWindowOffsetY;
        } else {
    ...
    public final void setTargetAccessibilityFocus(boolean targetsFocus) {
        int flags = getFlags();
        nativeSetFlags(this.mNativePtr, targetsFocus ? 1073741824 | flags : -1073741825 & flags);
    }
    ...
    public final float getPalm() {
        return nativeGetAxisValue(this.mNativePtr, 48, 0, Integer.MIN_VALUE);
    }

    @Deprecated
    public final Float getSumSize() {
        return Float.valueOf(LayoutParams.BRIGHTNESS_OVERRIDE_NONE);
    }

    @Deprecated
    public final float getSurfaceSize(int pointerIndex) {
    ...
    public final float getPredictedX(int pointerIndex) {
        float x = nativeGetAxisValue(this.mNativePtr, 51, pointerIndex, Integer.MIN_VALUE);
        return x != 0.0f ? x : nativeGetAxisValue(this.mNativePtr, 0, pointerIndex, Integer.MIN_VALUE);
    }

    public final float getPredictedY(int pointerIndex) {
        float y = nativeGetAxisValue(this.mNativePtr, 52, pointerIndex, Integer.MIN_VALUE);
        return y != 0.0f ? y : nativeGetAxisValue(this.mNativePtr, 1, pointerIndex, Integer.MIN_VALUE);
    }
    ...
    public final float getPalm(int pointerIndex) {
        return nativeGetAxisValue(this.mNativePtr, 48, pointerIndex, Integer.MIN_VALUE);
    }
    ...
    public final float getRawX() {
        if (this.mNeedWindowOffset) {
            return getAdjustedRawXByWindowOffset();
        }
        return nativeGetRawAxisValue(this.mNativePtr, 0, 0, Integer.MIN_VALUE);
    }

    public final float getRawXForScaledWindow() {
        return nativeGetRawAxisValue(this.mNativePtr, 0, 0, Integer.MIN_VALUE) / this.mDssScale;
    }

    public final float getRawY() {
        if (this.mNeedWindowOffset) {
            return getAdjustedRawYByWindowOffset();
        }
    ...
    public final float getRawYForScaledWindow() {
        return nativeGetRawAxisValue(this.mNativePtr, 1, 0, Integer.MIN_VALUE) / this.mDssScale;
    }

    public void setScale(float scaleX, float scaleY) {
        if (scaleX == 1.0f && scaleY == 1.0f) {
            this.mNeedWindowOffset = false;
        } else {
            this.mNeedWindowOffset = true;
        }
        this.mScaleFactorX = scaleX;
        this.mScaleFactorY = scaleY;
    }

    public void setScaledWindowOffset(int offsetX, int offsetY) {
        this.mScaledWindowOffsetX = offsetX;
        this.mScaledWindowOffsetY = offsetY;
    }

    public void setWindowOffsetByCocktailBar(int offsetX, int offsetY) {
    }

    public final float getAdjustedRawXByWindowOffset() {
        float rawX = nativeGetRawAxisValue(this.mNativePtr, 0, 0, Integer.MIN_VALUE);
        if (this.mScaleFactorX != 1.0f) {
            return ((rawX - ((float) this.mScaledWindowOffsetX)) - ((float) this.mWindowOffsetX)) * this.mScaleFactorX;
        }
        return rawX - ((float) this.mWindowOffsetX);
    }

    public final float getAdjustedRawYByWindowOffset() {
        float rawY = nativeGetRawAxisValue(this.mNativePtr, 1, 0, Integer.MIN_VALUE);
        if (this.mScaleFactorY != 1.0f) {
            return ((rawY - ((float) this.mScaledWindowOffsetY)) - ((float) this.mWindowOffsetY)) * this.mScaleFactorY;
        }
        return rawY - ((float) this.mWindowOffsetY);
    }
    ...
    public final MotionEvent split(int idBits) {
        ...
        synchronized (gSharedTempLock) {
            ...
            for (int h = 0; h <= historySize; h++) {
                ...
                if (h == 0) {
                    ev.mNativePtr = nativeInitialize(ev.mNativePtr, nativeGetDeviceId(this.mNativePtr), nativeGetSource(this.mNativePtr), newAction, nativeGetFlags(this.mNativePtr), nativeGetEdgeFlags(this.mNativePtr), nativeGetMetaState(this.mNativePtr), nativeGetButtonState(this.mNativePtr), nativeGetDisplayId(this.mNativePtr), nativeGetXOffset(this.mNativePtr), nativeGetYOffset(this.mNativePtr), nativeGetXPrecision(this.mNativePtr), nativeGetYPrecision(this.mNativePtr), nativeGetDownTimeNanos(this.mNativePtr), eventTimeNanos, newPointerCount, pp, pc);
                } else {
                    nativeAddBatch(ev.mNativePtr, eventTimeNanos, pc, 0);
                }
            }
            if (this.mNeedWindowOffset) {
                ev.mNeedWindowOffset = this.mNeedWindowOffset;
                ev.mWindowOffsetX = this.mWindowOffsetX;
                ev.mWindowOffsetY = this.mWindowOffsetY;
                ev.mScaleFactorX = this.mScaleFactorX;
                ev.mScaleFactorY = this.mScaleFactorY;
                ev.mScaledWindowOffsetX = this.mScaledWindowOffsetX;
                ev.mScaledWindowOffsetY = this.mScaledWindowOffsetY;
            }
        }
        return ev;
    }
