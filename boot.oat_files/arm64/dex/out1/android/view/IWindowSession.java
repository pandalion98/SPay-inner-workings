...
public interface IWindowSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWindowSession {
        ...
        static final int TRANSACTION_getContentFrame = 29;
        static final int TRANSACTION_getCoverStateSwitch = 30;
        ...
        private static class Proxy implements IWindowSession {
            ...
            public int relayout(IWindow window, int seq, LayoutParams attrs, int requestedWidth, int requestedHeight, int viewVisibility, int flags, Rect outFrame, Rect outOverscanInsets, Rect outContentInsets, Rect outVisibleInsets, Rect outStableInsets, Rect outOutsets, Configuration outConfig, Surface outSurface, PointF outScale, Rect outCocktailBar) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    if (_reply.readInt() != 0) {
                        outScale.readFromParcel(_reply);
                    }
                    if (_reply.readInt() != 0) {
                        outCocktailBar.readFromParcel(_reply);
                    }
                    _reply.recycle();
                    _data.recycle();
                    return _result;
            ...
            public void getContentFrame(IWindow window, Rect outContentFrame) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        outContentFrame.readFromParcel(_reply);
                    }
                    _reply.recycle();
                    _data.recycle();
                } catch (Throwable th) {
            ...
            public boolean getCoverStateSwitch() throws RemoteException {
                boolean _result = false;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 6:
                    ...
                    Configuration _arg13 = new Configuration();
                    Surface _arg14 = new Surface();
                    PointF _arg15 = new PointF();
                    Rect _arg16 = new Rect();
                    _result = relayout(_arg0, _arg1, _arg2, _arg3, _arg42, _arg52, _arg63, _arg7, _arg82, _arg9, _arg10, _arg11, _arg122, _arg13, _arg14, _arg15, _arg16);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    if (_arg7 != null) {
                        reply.writeInt(1);
                ...
                case 9:
                    ...
                    _arg0 = android.view.IWindow.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                        _arg17 = (Region) Region.CREATOR.createFromParcel(data);
                    } else {
                        _arg17 = null;
                    }
                    setTransparentRegion(_arg0, _arg17);
                    reply.writeNoException();
                    return true;
                case 10:
                    Rect _arg23;
                ...
                case 17:
                    ...
                    _result2 = performDrag(_arg0, _arg18, _arg24, _arg33, _arg45, _arg53, _arg64);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 18:
                ...
                case 24:
                    ...
                    Bundle _result4 = sendWallpaperCommand(_arg02, _arg19, _arg22, _arg3, _arg42, _arg54, data.readInt() != 0);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 25:
                    ...
                    wallpaperCommandComplete(_arg02, _arg110);
                    reply.writeNoException();
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void getContentFrame(IWindow iWindow, Rect rect) throws RemoteException;

    boolean getCoverStateSwitch() throws RemoteException;
    ...
    int relayout(IWindow iWindow, int i, LayoutParams layoutParams, int i2, int i3, int i4, int i5, Rect rect, Rect rect2, Rect rect3, Rect rect4, Rect rect5, Rect rect6, Configuration configuration, Surface surface, PointF pointF, Rect rect7) throws RemoteException;
