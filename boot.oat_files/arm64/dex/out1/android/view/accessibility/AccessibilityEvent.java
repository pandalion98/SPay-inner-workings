...
public final class AccessibilityEvent extends AccessibilityRecord implements Parcelable {
    ...
    public static final int TYPE_THREE_TAP_GESTURE_END = 67108864;
    public static final int TYPE_THREE_TAP_GESTURE_START = 33554432;
        ...
        while (eventType != 0) {
            ...
            switch (eventTypeFlag) {
                ...
                case 33554432:
                    ...
                    builder.append("TYPE_THREE_TAP_GESTURE_START");
                    eventTypeCount++;
                    break;
                case 67108864:
                    if (eventTypeCount > 0) {
                    ...
                    builder.append("TYPE_THREE_TAP_GESTURE_END");
                    eventTypeCount++;
                    break;
                default:
                    break;
