...
public final class ViewTreeObserver {
    ...
    private ArrayList<OnStylusButtonEventListener> mOnStylusButtonEventListeners;
    ...
    public interface OnStylusButtonEventListener {
        void onStylusButtonEvent(MotionEvent motionEvent, int i);
    }
    ...
    public void addOnStylusButtonEventListener(Context context, OnStylusButtonEventListener listener) {
        checkIsAlive();
        if (this.mOnStylusButtonEventListeners == null) {
    ...
    public void removeOnStylusButtonEventListener(OnStylusButtonEventListener victim) {
        checkIsAlive();
        if (this.mOnStylusButtonEventListeners != null) {
    ...
    public final void dispatchOnPenButtonEventListener(MotionEvent event, int clipboardId) {
        if (this.mOnStylusButtonEventListeners != null && this.mOnStylusButtonEventListeners.size() > 0) {
            ArrayList<OnStylusButtonEventListener> listeners = (ArrayList) this.mOnStylusButtonEventListeners.clone();
            int numListeners = listeners.size();
            for (int i = 0; i < numListeners; i++) {
                ((OnStylusButtonEventListener) listeners.get(i)).onStylusButtonEvent(event, clipboardId);
            }
        }
    }
}
