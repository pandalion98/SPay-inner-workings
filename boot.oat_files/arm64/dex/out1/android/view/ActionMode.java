...
public abstract class ActionMode {
    ...
    public static final int TYPE_FLOATING_TW = 99;
    public static final int TYPE_PRIMARY = 0;
    private int mDelayMili = -1;
    private Object mTag;
    ...
    public void setMovingOffDelay(int miliSec) {
        this.mDelayMili = miliSec;
    }

    public int getMovingOffDelay() {
        return this.mDelayMili;
    }
