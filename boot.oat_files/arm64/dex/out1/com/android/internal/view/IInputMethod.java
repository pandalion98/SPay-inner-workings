...
public interface IInputMethod extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInputMethod {
        ...
        static final int TRANSACTION_changeInputMethodSubtype = 13;
        static final int TRANSACTION_createSession = 6;
        static final int TRANSACTION_hideSoftInput = 10;
        static final int TRANSACTION_minimizeSoftInput = 11;
        ...
        static final int TRANSACTION_undoMinimizeSoftInput = 12;
        static final int TRANSACTION_updateFloatingState = 15;
        static final int TRANSACTION_updateWacomState = 14;
        ...
        private static class Proxy implements IInputMethod {
            ...
            public void minimizeSoftInput(int minimize) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void updateWacomState(int value) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void updateFloatingState(int value) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(value);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    if (data.readInt() != 0) {
                        _arg1 = (EditorInfo) EditorInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg1 = null;
                    }
                    startInput(_arg0, _arg1);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = com.android.internal.view.IInputContext.Stub.asInterface(data.readStrongBinder());
                ...
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    minimizeSoftInput(data.readInt());
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    updateWacomState(data.readInt());
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    updateFloatingState(data.readInt());
                    return true;
                case 1598968902:
    ...
    void updateFloatingState(int i) throws RemoteException;

    void updateWacomState(int i) throws RemoteException;
}
