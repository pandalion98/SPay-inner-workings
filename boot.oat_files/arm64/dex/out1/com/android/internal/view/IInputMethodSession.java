...
public interface IInputMethodSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInputMethodSession {
        ...
        static final int TRANSACTION_showSideSyncSoftInput = 9;
        static final int TRANSACTION_toggleSoftInput = 8;
        static final int TRANSACTION_updateCursor = 5;
        static final int TRANSACTION_updateCursorAnchorInfo = 11;
        ...
        private static class Proxy implements IInputMethodSession {
            ...
            public void showSideSyncSoftInput(int showFlags) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(showFlags);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    showSideSyncSoftInput(data.readInt());
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    finishSession();
    ...
    void showSideSyncSoftInput(int i) throws RemoteException;
