...
public class MenuDialogHelper implements OnKeyListener, OnClickListener, OnDismissListener, Callback {
    ...
    public void show(IBinder windowToken) {
        ...
        if (!builder.getContext().getTheme().resolveAttribute(R.attr.parentIsDeviceDefault, outValue, true) || outValue.data == 0) {
            this.mPresenter = new ListMenuPresenter(builder.getContext(), (int) R.layout.list_menu_item_layout);
        } else {
            this.mPresenter = new ListMenuPresenter(builder.getContext(), (int) R.layout.tw_list_menu_item_layout);
        }
