...
public class KernelWakelockReader {
    ...
    private static final int[] WAKEUP_SOURCES_FORMAT = new int[]{4105, 8457, R.styleable.Theme_isLightTheme, R.styleable.Theme_isLightTheme, R.styleable.Theme_isLightTheme, R.styleable.Theme_isLightTheme, 8457};
    ...
    private KernelWakelockStats parseProcWakelocks(byte[] wlBuffer, int len, boolean wakeup_sources, KernelWakelockStats staleStats) {
