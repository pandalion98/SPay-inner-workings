...
public interface IStatusBar extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IStatusBar {
        ...
        static final int TRANSACTION_applyEDMPolicy = 26;
        ...
        static final int TRANSACTION_enableSignals = 31;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    ...
                    setImeWindowStatus(_arg03, _arg12, _arg2, _arg3);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 30:
                    ...
                    notifyRecentPanelVisiblity(_arg0);
                    return true;
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
