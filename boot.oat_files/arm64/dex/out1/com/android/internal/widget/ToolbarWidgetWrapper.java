...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription) {
        ...
        this.mToolbar.getContext().getTheme().resolveAttribute(R.attr.parentIsDeviceDefault, outValue, true);
        ...
        this.mToolbar.setNavigationOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (ToolbarWidgetWrapper.this.mWindowCallback != null && ToolbarWidgetWrapper.this.mMenuPrepared) {
                    if (ToolbarWidgetWrapper.this.mIsThemeDeviceDefaultFamily) {
                        InputMethodManager imm = InputMethodManager.peekInstance();
                        if (imm == null || !imm.hideSoftInputFromWindow(ToolbarWidgetWrapper.this.mToolbar.getWindowToken(), 0, new ResultReceiver(ToolbarWidgetWrapper.this.mToolbar.getHandler()) {
                            protected void onReceiveResult(int resultCode, Bundle resultData) {
                                ToolbarWidgetWrapper.this.mWindowCallback.onMenuItemSelected(0, AnonymousClass1.this.mNavItem);
                            }
                        })) {
