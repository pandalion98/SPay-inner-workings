...
public class SlidingTab extends ViewGroup {
    ...
    private static class Slider {
        ...
        void layout(int l, int t, int r, int b, int alignment) {
            ...
            int leftTarget = (((int) (SlidingTab.THRESHOLD * ((float) parentWidth))) - targetWidth) + (handleWidth / 2);
            ...
            top = (((int) (SlidingTab.THRESHOLD * ((float) parentHeight))) + (handleHeight / 2)) - targetHeight;
            bottom = ((int) (0.3333333f * ((float) parentHeight))) - (handleHeight / 2);
            if (alignment == 2) {
