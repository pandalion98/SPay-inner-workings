...
public class ActionBarView extends AbsActionBarView implements DecorToolbar {
    ...
    private static final int OFFSET_OF_TITLE = 72;
    private static final String TAG = "ActionBarView";
    private static int mContentInsetStart;
    ...
    private View mMultiWindowMenuButton;
    ...
    private boolean mReserveMultiWindow;
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (AbsActionBarView.mIsThemeDeviceDefaultFamily) {
                ActionBarView.this.mExpandedHomeLayout.setShowIcon(false);
            }
    ...
    private static class HomeView extends FrameLayout {
        ...
        private boolean mHaveExtraPadding;
        ...
        boolean getShowUp() {
            return this.mUpView.getVisibility() != 8;
        }
        ...
        boolean getShowIcon() {
            return this.mIconView.getVisibility() != 8;
        }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            boolean showUp = this.mUpView.getVisibility() != 8;
            boolean showIcon = this.mIconView.getVisibility() != 8;
            if (this.mHaveExtraPadding) {
                int padding = ((int) (72.0f * ActionBarView.mDensity)) - this.mUpView.getMeasuredWidth();
                LayoutParams temp = (LayoutParams) this.mUpView.getLayoutParams();
                if (isLayoutRtl()) {
                    temp.leftMargin = padding;
                } else {
                    temp.rightMargin = padding;
                }
                this.mUpView.setLayoutParams(temp);
            }
            LayoutParams upLp = (LayoutParams) this.mUpView.getLayoutParams();
            int upMargins = upLp.leftMargin + upLp.rightMargin;
            int measuredWidth = (!AbsActionBarView.mIsThemeDeviceDefaultFamily || showUp) ? this.mUpView.getMeasuredWidth() : ActionBarView.mContentInsetStart;
            this.mUpWidth = measuredWidth;
            this.mStartOffset = this.mUpWidth + upMargins;
            int width = !showUp ? 0 : this.mStartOffset;
        ...
        void setExtraUpPadding(boolean havePadding) {
            this.mHaveExtraPadding = havePadding;
        }
    }
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        mContentInsetStart = a.getDimensionPixelOffset(22, -1);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mContext instanceof Activity) {
            MultiWindowStyle multindowStyle = ((Activity) this.mContext).getMultiWindowStyle();
        } else if (this.mContext instanceof ContextWrapper) {
            this.mContext.getAppMultiWindowStyle();
        }
