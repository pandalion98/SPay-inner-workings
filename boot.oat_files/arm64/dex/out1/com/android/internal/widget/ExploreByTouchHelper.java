...
public abstract class ExploreByTouchHelper extends AccessibilityDelegate {
    ...
    private AccessibilityEvent createEventForHost(int eventType) {
        ...
        onInitializeAccessibilityEvent(this.mView, event);
        return event;
    }
    ...
    private AccessibilityNodeInfo createNodeForHost() {
        ...
        onInitializeAccessibilityNodeInfo(this.mView, node);
    ...
    private boolean performActionForHost(int action, Bundle arguments) {
        return performAccessibilityAction(this.mView, action, arguments);
    }
    ...
    private boolean requestAccessibilityFocus(int virtualViewId) {
        ...
        if ((!universalSwitchEnabled && !this.mManager.isTouchExplorationEnabled()) || isAccessibilityFocused(virtualViewId)) {
            return false;
        }
        if (this.mFocusedVirtualViewId != Integer.MIN_VALUE) {
