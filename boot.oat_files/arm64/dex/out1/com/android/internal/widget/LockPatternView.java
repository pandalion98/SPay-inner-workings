...
public class LockPatternView extends View {
    ...
    private static final int MESSAGE_HANDLE_ACTION_UP = 10;
    ...
    protected ArrayList<Cell> mPattern;
    protected DisplayMode mPatternDisplayMode;
    protected boolean[][] mPatternDrawLookup;
    ...
    private final class PatternExploreByTouchHelper extends ExploreByTouchHelper {
        ...
        private boolean isClickable(int virtualViewId) {
            ...
            if (LockPatternView.this.mPatternDrawLookup[(virtualViewId - 1) / 3][(virtualViewId - 1) % 3]) {
                return false;
            }
            return true;
        }
        ...
        private boolean shouldSpeakPassword() {
            ...
            if (Secure.getIntForUser(LockPatternView.this.mContext.getContentResolver(), "speak_password", 0, -3) != 0) {
                speakPassword = true;
            } else {
                speakPassword = false;
            }
            boolean hasHeadphones = LockPatternView.this.mAudioManager != null ? LockPatternView.this.mAudioManager.isWiredHeadsetOn() || LockPatternView.this.mAudioManager.isBluetoothA2dpOn() : false;
            if (speakPassword || hasHeadphones) {
                return true;
            }
            return false;
        }
        ...
        private CharSequence getTextForVirtualView(int virtualViewId) {
            ...
            return res.getString(R.string.lockscreen_access_pattern_cell_added_verbose, new Object[]{Integer.valueOf(virtualViewId)});
        }
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        this.mHandler = new Handler(Looper.myLooper(), null, true) {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case 10:
                        LockPatternView.this.handleActionUpEvent((MotionEvent) msg.obj);
                        return;
                    default:
                        return;
                }
        ...
        this.mRegularColor = context.getColor(R.color.lock_pattern_view_regular_color);
        this.mErrorColor = context.getColor(R.color.lock_pattern_view_error_color);
        this.mSuccessColor = context.getColor(R.color.lock_pattern_view_success_color);
    ...
    private void notifyPatternDetected() {
        ...
        if (this.mOnPatternListener != null) {
            Log.e(TAG, "notifyPatternDetected");
        ...
        if (AccessibilityManager.getInstance(this.mContext).isTouchExplorationEnabled()) {
            ...
            switch (action) {
                ...
                case 10:
                    ...
                    this.mHandler.sendMessageDelayed(this.mHandler.obtainMessage(10, event), 50);
    ...
    protected float calculateLastSegmentAlpha(float x, float y, float lastX, float lastY) {
        float diffX = x - lastX;
        float diffY = y - lastY;
