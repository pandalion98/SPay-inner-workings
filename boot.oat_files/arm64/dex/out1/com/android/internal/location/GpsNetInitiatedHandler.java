...
public class GpsNetInitiatedHandler {
    ...
    public GpsNetInitiatedHandler(Context context, INetInitiatedListener netInitiatedListener, boolean isSuplEsEnabled) {
        ...
        this.mLocationManager = (LocationManager) context.getSystemService(SmartClipMetaTagType.LOCATION);
        updateLocationMode();
    ...
    private synchronized void setNiNotification(GpsNiNotification notif) {
        ...
        if (notificationManager != null) {
            ...
            if (this.mNiNotificationBuilder == null) {
                this.mNiNotificationBuilder = new Builder(this.mContext).setSmallIcon(R.drawable.stat_sys_gps_on).setWhen(0).setOngoing(true).setAutoCancel(true).setColor(this.mContext.getResources().getColor(R.color.system_notification_accent_color));
            }
            if (this.mPlaySounds) {
