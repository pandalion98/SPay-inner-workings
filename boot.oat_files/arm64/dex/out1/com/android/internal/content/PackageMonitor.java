...
public abstract class PackageMonitor extends BroadcastReceiver {
    ...
    int mChangeType;
    int mChangeUserId = DeviceRootKeyServiceManager.ERR_SERVICE_ERROR;
    ...
    static {
        ...
        sPackageFilt.addDataScheme(AbsCocktailLoadablePanel.PACKAGE_NAME);
    ...
    public void onReceive(Context context, Intent intent) {
        int i = 2;
        this.mChangeUserId = intent.getIntExtra("android.intent.extra.user_handle", DeviceRootKeyServiceManager.ERR_SERVICE_ERROR);
        if (this.mChangeUserId == DeviceRootKeyServiceManager.ERR_SERVICE_ERROR) {
        ...
        this.mChangeUserId = DeviceRootKeyServiceManager.ERR_SERVICE_ERROR;
    }
}
