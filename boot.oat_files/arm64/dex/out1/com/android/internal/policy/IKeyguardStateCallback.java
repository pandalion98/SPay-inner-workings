...
public interface IKeyguardStateCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IKeyguardStateCallback {
        ...
        static final int TRANSACTION_onSwipeLockShowingstateChanged = 4;
        ...
        private static class Proxy implements IKeyguardStateCallback {
            ...
            public void onSwipeLockShowingstateChanged(boolean swipelockshowing) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    onSwipeLockShowingstateChanged(_arg0);
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void onSwipeLockShowingstateChanged(boolean z) throws RemoteException;
}
