...
public interface ITextServicesManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITextServicesManager {
        ...
        static final int TRANSACTION_switchUserForKnox = 10;
        ...
        private static class Proxy implements ITextServicesManager {
            ...
            public void switchUserForKnox(int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    switchUserForKnox(data.readInt());
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void switchUserForKnox(int i) throws RemoteException;
}
