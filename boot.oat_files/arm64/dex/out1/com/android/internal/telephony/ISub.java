...
public interface ISub extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISub {
        ...
        static final int TRANSACTION_activateSubId = 37;
        ...
        static final int TRANSACTION_deactivateSubId = 38;
        ...
        static final int TRANSACTION_getSubState = 40;
        static final int TRANSACTION_getSubscriptionProperty = 30;
        static final int TRANSACTION_isActiveSubId = 32;
        static final int TRANSACTION_isSMSPromptEnabled = 33;
        static final int TRANSACTION_isVoicePromptEnabled = 35;
        static final int TRANSACTION_setDataRoaming = 14;
        static final int TRANSACTION_setDefaultDataSubId = 21;
        static final int TRANSACTION_setDefaultDataSubIdForMMS = 22;
        ...
        static final int TRANSACTION_setSMSPromptEnabled = 34;
        static final int TRANSACTION_setSubState = 39;
        static final int TRANSACTION_setSubscriptionProperty = 29;
        static final int TRANSACTION_setVoicePromptEnabled = 36;
        ...
        private static class Proxy implements ISub {
            ...
            public void setDefaultDataSubIdForMMS(int subId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    setDefaultDataSubIdForMMS(data.readInt());
                    reply.writeNoException();
                    return true;
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                    String _result6 = getSubscriptionProperty(data.readInt(), data.readString(), data.readString());
                    reply.writeNoException();
                ...
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = isActiveSubId(data.readInt());
                    reply.writeNoException();
                    if (_result5) {
                        i = 1;
                    }
                ...
                case 34:
                    ...
                    setSMSPromptEnabled(_arg0);
                    reply.writeNoException();
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = isVoicePromptEnabled();
                    reply.writeNoException();
                    if (_result5) {
                        i = 1;
                    }
    ...
    void setDefaultDataSubIdForMMS(int i) throws RemoteException;
