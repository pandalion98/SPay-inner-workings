...
public class DctConstants {
    public static final int APN_BIP_ID = 14;
    public static final int APN_CAS_ID = 13;
    public static final int APN_CBS_ID = 7;
    public static final int APN_CMDM_ID = 10;
    public static final int APN_CMMAIL_ID = 11;
    public static final int APN_DEFAULT_ID = 0;
    public static final int APN_DUN_ID = 3;
    public static final int APN_EMERGENCY_ID = 9;
    public static final int APN_ENT1_ID = 17;
    public static final int APN_ENT2_ID = 18;
    ...
    public static final int APN_MMS_ID2 = 15;
    public static final int APN_NUM_TYPES = 19;
    public static final int APN_SS_BASE_ID = 10;
    public static final int APN_SUPL_ID = 2;
    public static final String APN_TYPE_KEY = "apnType";
    public static final int APN_WAP_ID = 12;
    public static final int APN_XCAP_ID = 16;
    ...
    public static final int EVENT_CREATE_ALL_APN_RETRY_TIMEOUT = 270446;
    ...
    public static final int EVENT_DUN_STATE_CHANGED = 270440;
    ...
    public static final int EVENT_RETRY_INITIAL_ATTACH = 270445;
    ...
    public static final int EVENT_SET_VOICE_DOMAIN = 270437;
    public static final int EVENT_SET_VOICE_DOMAIN_DONE = 270438;
