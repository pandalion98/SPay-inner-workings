...
public interface IPhoneStateListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPhoneStateListener {
        ...
        static final int TRANSACTION_onDunDataActivity = 19;
        static final int TRANSACTION_onDunDataConnectionStateChanged = 20;
        static final int TRANSACTION_onFdnUpdated = 18;
        ...
        static final int TRANSACTION_onVoiceRadioBearerHoStateChanged = 21;
        ...
        private static class Proxy implements IPhoneStateListener {
            ...
            public void onFdnUpdated() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void onDunDataActivity(int direction) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(direction);
            ...
            public void onDunDataConnectionStateChanged(int state, int networkType) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(state);
            ...
            public void onVoiceRadioBearerHoStateChanged(int state) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(state);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    onDunDataActivity(data.readInt());
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    onDunDataConnectionStateChanged(data.readInt(), data.readInt());
                    return true;
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    onVoiceRadioBearerHoStateChanged(data.readInt());
                    return true;
                case 1598968902:
    ...
    void onDunDataActivity(int i) throws RemoteException;

    void onDunDataConnectionStateChanged(int i, int i2) throws RemoteException;

    void onFdnUpdated() throws RemoteException;
    ...
    void onVoiceRadioBearerHoStateChanged(int i) throws RemoteException;
}
