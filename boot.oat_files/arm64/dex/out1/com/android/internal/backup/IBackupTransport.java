...
public interface IBackupTransport extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBackupTransport {
        ...
        static final int TRANSACTION_abortFullRestore = 24;
        ...
        static final int TRANSACTION_getNextFullRestoreDataChunk = 23;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    ...
                    _result4 = performBackup(_arg0, _arg1);
                    reply.writeNoException();
                    reply.writeInt(_result4);
                    return true;
                case 10:
                ...
                case 19:
                    ...
                    _result4 = performFullBackup(_arg0, _arg1);
                    reply.writeNoException();
                    reply.writeInt(_result4);
                    return true;
                case 20:
