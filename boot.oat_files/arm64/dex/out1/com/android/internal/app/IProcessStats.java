...
public interface IProcessStats extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IProcessStats {
        ...
        static final int TRANSACTION_DataCollection = 4;
        ...
        private static class Proxy implements IProcessStats {
            ...
            public List<ProcStatsCollection> DataCollection(long aggregateHours) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeLong(aggregateHours);
                    this.mRemote.transact(4, _data, _reply, 0);
                    _reply.readException();
                    List<ProcStatsCollection> _result = _reply.createTypedArrayList(ProcStatsCollection.CREATOR);
                    return _result;
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    List<ProcStatsCollection> _result4 = DataCollection(data.readLong());
                    reply.writeNoException();
    ...
    List<ProcStatsCollection> DataCollection(long j) throws RemoteException;
