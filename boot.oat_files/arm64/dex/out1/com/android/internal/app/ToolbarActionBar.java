...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0048 in list [B:15:0x0045]
...
*/
    ...
    L_0x0021:
        r2 = r1;
        r2 = (com.android.internal.view.menu.MenuBuilder) r2;
        r0 = r2;
    L_0x0025:
    ...
    L_0x002a:
        ...
        r2 = r5.mWindowCallback;	 Catch:{ all -> 0x0049 }
        r3 = 0;	 Catch:{ all -> 0x0049 }
        r2 = r2.onCreatePanelMenu(r3, r1);	 Catch:{ all -> 0x0049 }
        if (r2 == 0) goto L_0x0040;	 Catch:{ all -> 0x0049 }
    L_0x0036:
        r2 = r5.mWindowCallback;	 Catch:{ all -> 0x0049 }
        r3 = 0;	 Catch:{ all -> 0x0049 }
        r4 = 0;	 Catch:{ all -> 0x0049 }
        r2 = r2.onPreparePanel(r3, r4, r1);	 Catch:{ all -> 0x0049 }
        if (r2 != 0) goto L_0x0043;	 Catch:{ all -> 0x0049 }
    L_0x0040:
        r1.clear();	 Catch:{ all -> 0x0049 }
    L_0x0043:
