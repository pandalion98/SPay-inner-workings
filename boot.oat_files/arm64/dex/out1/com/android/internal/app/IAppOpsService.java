...
public interface IAppOpsService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAppOpsService {
        ...
        static final int TRANSACTION_isControlAllowed = 20;
        ...
        static final int TRANSACTION_removeUser = 19;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result4 = isControlAllowed(data.readInt(), data.readString());
                    reply.writeNoException();
