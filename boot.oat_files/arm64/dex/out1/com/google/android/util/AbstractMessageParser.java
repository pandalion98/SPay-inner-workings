...
public abstract class AbstractMessageParser {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$google$android$util$AbstractMessageParser$Token$Type = new int[Type.values().length];
    ...
    public static abstract class Token {
        ...
        public enum Type {
            HTML(SmartClipMetaTagType.HTML),
            FORMAT("format"),
            LINK("l"),
            SMILEY("e"),
            ACRONYM("a"),
    ...
    public static class FlickrPhoto extends Token {
        ...
        public FlickrPhoto(String user, String photo, String grouping, String groupingId, String text) {
            ...
            this.user = user;
            if (HardwareRenderer.OVERDRAW_PROPERTY_SHOW.equals(photo)) {
                photo = null;
            }
            this.photo = photo;
        ...
        public static FlickrPhoto matchURL(String url, String text) {
            ...
            return m.matches() ? new FlickrPhoto(m.group(1), m.group(2), null, null, text) : null;
        }
    ...
    public String toHtml() {
        ...
        while (it.hasNext()) {
            ...
            boolean caps = false;
            html.append("<p>");
            Iterator i$ = part.getTokens().iterator();
            while (i$.hasNext()) {
