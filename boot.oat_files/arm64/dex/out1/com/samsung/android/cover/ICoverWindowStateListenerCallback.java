...
public interface ICoverWindowStateListenerCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICoverWindowStateListenerCallback {
        ...
        public static ICoverWindowStateListenerCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof ICoverWindowStateListenerCallback)) {
                return new Proxy(obj);
            }
            return (ICoverWindowStateListenerCallback) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    onCoverAppCovered(data.readInt() != 0);
