...
import com.samsung.android.contextaware.dataprovider.sensorhubprovider.ActivityTrackerProviderForExtLib;
...
public class ActivityTrackerCurrentInfoRunner extends ActivityTrackerProviderForExtLib {
    public ActivityTrackerCurrentInfoRunner(int version, Context context, ISensorHubResetObservable observable) {
        super(version, context, observable);
    }

    public final String getContextType() {
        return ContextType.REQUEST_SENSORHUB_ACTIVITY_TRACKER_CURRENT_INFO.getCode();
    }
