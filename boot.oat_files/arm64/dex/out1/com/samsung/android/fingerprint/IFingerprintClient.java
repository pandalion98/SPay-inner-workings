...
public interface IFingerprintClient extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFingerprintClient {
        ...
        public static IFingerprintClient asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IFingerprintClient)) {
                return new Proxy(obj);
            }
            return (IFingerprintClient) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    FingerprintEvent _arg0;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (FingerprintEvent) FingerprintEvent.CREATOR.createFromParcel(data);
                    } else {
                        _arg0 = null;
                    }
                    onFingerprintEvent(_arg0);
                    return true;
                case 1598968902:
