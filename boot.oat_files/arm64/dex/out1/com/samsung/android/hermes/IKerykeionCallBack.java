...
public interface IKerykeionCallBack extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IKerykeionCallBack {
        private static final String DESCRIPTOR = "com.samsung.android.hermes.IKerykeionCallBack";
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    onCompleted(data.createTypedArrayList(KerykeionResult.CREATOR));
    ...
    void onCompleted(List<KerykeionResult> list) throws RemoteException;
}
