...
public interface ISmartCardPinService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISmartCardPinService {
        ...
        private static class Proxy implements ISmartCardPinService {
            ...
            public void getPin(ISmartCardGetPinCallback callback) throws RemoteException {
            ...
            public void registerCard(char[] pin, ISmartCardRegisterCallback callback) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void unRegisterCard(char[] pin, ISmartCardRegisterCallback callback) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void verifyCard(char[] pin, ISmartCardVerifyCallback callback) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void getCardLoginAttemptRemain(ISmartCardInfoCallback callback) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public static ISmartCardPinService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof ISmartCardPinService)) {
                return new Proxy(obj);
            }
            return (ISmartCardPinService) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    getPin(com.sec.smartcard.pinservice.ISmartCardGetPinCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    registerCard(data.createCharArray(), com.sec.smartcard.pinservice.ISmartCardRegisterCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    unRegisterCard(data.createCharArray(), com.sec.smartcard.pinservice.ISmartCardRegisterCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    verifyCard(data.createCharArray(), com.sec.smartcard.pinservice.ISmartCardVerifyCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    getCardLoginAttemptRemain(com.sec.smartcard.pinservice.ISmartCardInfoCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isCardRegistered();
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isDeviceConnectedWithCard();
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isSmartCardAuthenticationAvailable();
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
