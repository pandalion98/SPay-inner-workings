...
public interface IBluetoothHeadsetVoIP extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothHeadsetVoIP {
        ...
        public static IBluetoothHeadsetVoIP asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IBluetoothHeadsetVoIP)) {
                return new Proxy(obj);
            }
            return (IBluetoothHeadsetVoIP) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getSubscriberId();
                    reply.writeNoException();
                    reply.writeString(_result2);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getDeviceId();
                    reply.writeNoException();
                    reply.writeString(_result2);
                    return true;
                case 11:
