...
public class SearchRecentSuggestions {
    ...
    public static final String[] QUERIES_PROJECTION_1LINE = new String[]{"_id", "date", "query", SuggestionColumns.DISPLAY1};
    public static final String[] QUERIES_PROJECTION_2LINE = new String[]{"_id", "date", "query", SuggestionColumns.DISPLAY1, SuggestionColumns.DISPLAY2};
