...
public final class ContactsContract {
    ...
    public static final class CommonDataKinds {
        ...
        public static final class Email implements DataColumnsWithJoins, CommonColumns, ContactCounts {
            ...
            public static final CharSequence getTypeLabel(Resources res, int type, CharSequence label) {
                return (type != 0 || TextUtils.isEmpty(label)) ? res.getText(getTypeLabelResource(type)) : label;
            }
        }
        ...
        public static final class Event implements DataColumnsWithJoins, CommonColumns, ContactCounts {
            ...
            public static final CharSequence getTypeLabel(Resources res, int type, CharSequence label) {
                return (type != 0 || TextUtils.isEmpty(label)) ? res.getText(getTypeResource(Integer.valueOf(type))) : label;
            }
        }
        ...
        public static final class Im implements DataColumnsWithJoins, CommonColumns, ContactCounts {
            ...
            public static final CharSequence getProtocolLabel(Resources res, int type, CharSequence label) {
                return (type != -1 || TextUtils.isEmpty(label)) ? res.getText(getProtocolLabelResource(type)) : label;
            }
        }
        ...
        public static final class Phone implements DataColumnsWithJoins, CommonColumns, ContactCounts {
            ...
            public static final int TYPE_CONFERENCE = 1021;
            ...
            public static final CharSequence getTypeLabel(Resources res, int type, CharSequence label) {
                return ((type == 0 || type == 19) && !TextUtils.isEmpty(label)) ? label : res.getText(getTypeLabelResource(type));
            }
        }
    ...
    public static class Contacts implements BaseColumns, ContactsColumns, ContactOptionsColumns, ContactNameColumns, ContactStatusColumns, ContactCounts {
        ...
        public static InputStream openContactPhotoInputStream(ContentResolver cr, Uri contactUri, boolean preferHighres) {
            ...
            if (preferHighres) {
                try {
                    inputStream = cr.openAssetFileDescriptor(Uri.withAppendedPath(contactUri, "display_photo"), FullBackup.ROOT_TREE_TOKEN).createInputStream();
                } catch (IOException e) {
                }
                return inputStream;
            }
            ...
            if (photoUri != null) {
                Cursor cursor = cr.query(photoUri, new String[]{"data15"}, inputStream, inputStream, inputStream);
                if (cursor != null) {
                    try {
    ...
    public static final class QuickContact {
        ...
        public static Intent composeQuickContactsIntent(Context context, Rect target, Uri lookupUri, int mode, String[] excludeMimes) {
            ...
            if (CscFeature.getInstance().getEnableStatus("CscFeature_Contact_EnableDocomoAccountAsDefault") && actualContext.checkCallingOrSelfPermission(permission.GET_TASKS) == 0) {
                String PackageName = ((RunningTaskInfo) ((ActivityManager) actualContext.getSystemService(Context.ACTIVITY_SERVICE)).getRunningTasks(1).get(0)).topActivity.getPackageName();
                String ReplacedPackageName = CscFeature.getInstance().getString("CscFeature_Contact_ReplacePackageAs");
                if (!(ContactsContract.AUTHORITY.equals(PackageName) || TextUtils.isEmpty(ReplacedPackageName))) {
                    intent.setPackage(ReplacedPackageName);
                }
            }
        ...
        public static Intent rebuildManagedQuickContactsIntent(String lookupKey, long contactId, Intent originalIntent) {
