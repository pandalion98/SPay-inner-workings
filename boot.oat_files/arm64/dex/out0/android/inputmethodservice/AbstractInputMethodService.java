...
public abstract class AbstractInputMethodService extends Service implements Callback {
    final DispatcherState mDispatcherState = new DispatcherState();
    private InputMethod mInputMethod;
    private boolean mIsPressBtnSIPOnOff;
    ...
    public void setPressBtnSIPOnOff(boolean isOn) {
        this.mIsPressBtnSIPOnOff = isOn;
    }

    public boolean getPressBtnSIPOnOff() {
        return this.mIsPressBtnSIPOnOff;
    }
}
