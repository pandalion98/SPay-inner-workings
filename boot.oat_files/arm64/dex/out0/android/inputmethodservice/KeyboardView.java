...
public class KeyboardView extends View implements OnClickListener {
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        a = this.mContext.obtainStyledAttributes(com.android.internal.R.styleable.Theme);
    ...
    private void sendAccessibilityEventForUnicodeCharacter(int eventType, int code) {
        ...
        if (this.mAccessibilityManager.isEnabled()) {
            ...
            if (speakPassword || this.mAudioManager.isBluetoothA2dpOn() || this.mAudioManager.isWiredHeadsetOn()) {
                switch (code) {
                    case -6:
                        text = this.mContext.getString(17040516);
                        break;
                    case -5:
                        text = this.mContext.getString(17040518);
                        break;
                    case -4:
                        text = this.mContext.getString(17040519);
                        break;
                    case -3:
                        text = this.mContext.getString(17040517);
                        break;
                    case -2:
                        text = this.mContext.getString(17040520);
                        break;
                    case -1:
                        text = this.mContext.getString(17040521);
                        break;
                    case 10:
                        text = this.mContext.getString(17040522);
                        break;
                    default:
                ...
                text = this.mContext.getString(17040530);
            } else {
                if (eventType == 256) {
                    this.mHeadsetRequiredToHearPasswordsAnnounced = true;
                }
                text = this.mContext.getString(17040529);
            }
        ...
        if (this.mGestureDetector.onTouchEvent(me)) {
            ...
            switch (action) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if (me.getToolType(0) != 2 && this.mAccessibilityManager.isTouchExplorationEnabled()) {
                        detectAndSendKey(this.mCurrentKey, touchX, touchY, eventTime);
                    }
                    removeMessages();
                    dismissPopupKeyboard();
