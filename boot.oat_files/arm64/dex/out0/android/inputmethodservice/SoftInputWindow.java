...
public class SoftInputWindow extends Dialog {
    ...
    private boolean mMinimizeFlag = false;
    final String mName;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (this.mMinimizeFlag) {
            ...
            return true;
        } else if (ev.isWithinBoundsNoHistory((float) this.mBounds.left, (float) this.mBounds.top, (float) (this.mBounds.right - 1), (float) (this.mBounds.bottom - 1))) {
