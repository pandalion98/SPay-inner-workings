...
class IInputMethodWrapper extends Stub implements Callback {
    ...
    private static final int DO_MINIMIZE_SOFT_INPUT = 110;
    ...
    private static final int MSG_UPDATE_FLOATING_STATE = 100;
    private static final int MSG_UPDATE_WACOM_STATE = 90;
    private static final String TAG = "InputMethodWrapper";
    private static final int UNDO_MINIMIZE_SOFT_INPUT = 111;
        ...
        if (inputMethod != null || msg.what == 1) {
            ...
            switch (msg.what) {
                ...
                case 70:
                    ...
                    return;
                case 80:
                    inputMethod.changeInputMethodSubtype(msg.obj);
                    return;
                case 90:
                    inputMethod.updateWacomState(msg.arg1);
                    return;
                case 100:
                    inputMethod.updateFloatingState(msg.arg1);
                    return;
                case 110:
    ...
    public void minimizeSoftInput(int minimize) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageI(110, minimize));
    }

    public void undoMinimizeSoftInput() {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageI(111, 0));
    }
    ...
    public void updateWacomState(int value) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageI(90, value));
    }

    public void updateFloatingState(int value) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageI(100, value));
    }
}
