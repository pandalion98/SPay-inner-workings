...
class IInputMethodSessionWrapper extends Stub implements Callback {
    ...
    private static final int DO_SHOW_SIDESYNC_SOFT_INPUT = 120;
    ...
    public void executeMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case 115:
                ...
                return;
            case 120:
                this.mInputMethodSession.showSideSyncSoftInput(msg.arg1);
                return;
            default:
    ...
    public void showSideSyncSoftInput(int showFlags) {
        this.mCaller.executeOrSendMessage(this.mCaller.obtainMessageI(120, showFlags));
    }
