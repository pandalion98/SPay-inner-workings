...
public final class LocationRequest implements Parcelable {
    ...
    public static final Creator<LocationRequest> CREATOR = new Creator<LocationRequest>() {
        public LocationRequest createFromParcel(Parcel in) {
            ...
            request.setAltitudeRequired(z);
            if (in.readInt() == 0) {
                z2 = false;
            }
            request.setIsBlacklist(z2);
    ...
    public static LocationRequest createFromDeprecatedCriteria(Criteria criteria, long minTime, float minDistance, boolean singleShot) {
        ...
        LocationRequest request = new LocationRequest().setQuality(quality).setInterval(minTime).setFastestInterval(minTime).setSmallestDisplacement(minDistance).setAltitudeRequired(criteria.isAltitudeRequired()).setIsBlacklist(false);
        if (singleShot) {
            request.setNumUpdates(1);
        }
        return request;
    ...
    public LocationRequest(LocationRequest src) {
        ...
        this.mAltitudeRequired = src.mAltitudeRequired;
        this.mIsBlacklist = src.mIsBlacklist;
    }
    ...
    public LocationRequest setAltitudeRequired(boolean altitude) {
        this.mAltitudeRequired = altitude;
        return this;
    }

    public boolean getAltitudeRequired() {
        return this.mAltitudeRequired;
    }

    public LocationRequest setIsBlacklist(boolean isBlacklist) {
        this.mIsBlacklist = isBlacklist;
        return this;
    }
