    ...
    public final class Page implements AutoCloseable {
        ...
        public void render(Bitmap destination, Rect destClip, Matrix transform, int renderMode) {
            if (destination.getConfig() != Config.ARGB_8888) {
                ...
                PdfRenderer.nativeRenderPage(PdfRenderer.this.mNativeDocument, this.mNativePage, destination, destClip != null ? destClip.left : 0, destClip != null ? destClip.top : 0, destClip != null ? destClip.right : destination.getWidth(), destClip != null ? destClip.bottom : destination.getHeight(), transform != null ? transform.native_instance : 0, renderMode);
            }
        }
