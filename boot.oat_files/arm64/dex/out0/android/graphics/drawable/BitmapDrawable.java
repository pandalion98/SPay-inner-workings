...
public class BitmapDrawable extends Drawable {
    ...
    private BitmapState mConstantState;
    ...
    public BitmapDrawable(Bitmap bitmap) {
        ...
        if (bitmap != null) {
            setImagePath(bitmap.getImagePath());
        }
    }
    ...
    public void setTintList(ColorStateList tint) {
        if (this.mConstantState == null) {
            this.mConstantState = new BitmapState(this.mBitmapState);
        }
    ...
    public final ConstantState getConstantState() {
        ...
        this.mConstantState.mChangingConfigurations = getChangingConfigurations();
