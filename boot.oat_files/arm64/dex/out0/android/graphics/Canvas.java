...
public class Canvas {
    ...
    private static native boolean native_getHighContrastText(long j);
    ...
    public int getDCSFormat() {
        return this.mDCSFormat;
    }

    public void setDCSFormat(int format) {
        this.mDCSFormat = format;
    }
    ...
    public boolean getHighContrastText() {
        return native_getHighContrastText(this.mNativeCanvasWrapper);
    }
