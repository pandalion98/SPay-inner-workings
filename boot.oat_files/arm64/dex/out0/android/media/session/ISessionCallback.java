...
public interface ISessionCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISessionCallback {
        ...
        static final int TRANSACTION_onAdjustVolume = 17;
        static final int TRANSACTION_onCommand = 1;
        static final int TRANSACTION_onCustomAction = 16;
        static final int TRANSACTION_onFastForward = 12;
        static final int TRANSACTION_onMediaButton = 2;
        static final int TRANSACTION_onNext = 10;
        static final int TRANSACTION_onPause = 8;
        ...
        static final int TRANSACTION_onPlayFromUri = 6;
        static final int TRANSACTION_onPrevious = 11;
        static final int TRANSACTION_onRate = 15;
        static final int TRANSACTION_onRewind = 13;
        static final int TRANSACTION_onSeekTo = 14;
        static final int TRANSACTION_onSetVolumeTo = 18;
        static final int TRANSACTION_onSkipToTrack = 7;
