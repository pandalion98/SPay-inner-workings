...
public interface ISessionController extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISessionController {
        ...
        static final int TRANSACTION_adjustVolume = 13;
        static final int TRANSACTION_fastForward = 24;
        static final int TRANSACTION_getExtras = 33;
        static final int TRANSACTION_getFlags = 11;
        static final int TRANSACTION_getLaunchPendingIntent = 10;
        static final int TRANSACTION_getMetadata = 29;
        static final int TRANSACTION_getPackageName = 8;
        ...
        static final int TRANSACTION_getTag = 9;
        static final int TRANSACTION_getVolumeAttributes = 12;
        static final int TRANSACTION_isTransportControlEnabled = 7;
        static final int TRANSACTION_next = 22;
        static final int TRANSACTION_pause = 20;
        static final int TRANSACTION_play = 15;
        static final int TRANSACTION_playFromMediaId = 16;
        static final int TRANSACTION_playFromSearch = 17;
        static final int TRANSACTION_playFromUri = 18;
        static final int TRANSACTION_previous = 23;
        static final int TRANSACTION_rate = 27;
        static final int TRANSACTION_registerCallbackListener = 3;
        static final int TRANSACTION_releaseLock = 6;
        static final int TRANSACTION_requestLock = 5;
        static final int TRANSACTION_rewind = 25;
        static final int TRANSACTION_seekTo = 26;
        static final int TRANSACTION_sendCommand = 1;
        static final int TRANSACTION_sendCustomAction = 28;
        static final int TRANSACTION_sendMediaButton = 2;
        static final int TRANSACTION_setVolumeTo = 14;
        static final int TRANSACTION_skipToQueueItem = 19;
        static final int TRANSACTION_stop = 21;
        ...
        private static class Proxy implements ISessionController {
            ...
            public void requestLock() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
    ...
    void requestLock() throws RemoteException;
