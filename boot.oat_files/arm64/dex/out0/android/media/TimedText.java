...
public final class TimedText {
    ...
    public static final int KEY_TEXT_INDEX = 3017;
    ...
    private String mHeadChars = null;
    ...
    private synchronized boolean parseParcel(Parcel parcel) {
        ...
        if (parcel.dataAvail() == 0) {
            ...
            if (textType == KEY_TEXT_INDEX) {
                this.mKeyObjectMap.put(Integer.valueOf(textType), Integer.valueOf(parcel.readInt()));
                type = parcel.readInt();
            } else {
                type = textType;
            }
            ...
            } else if (type == KEY_SMPTE_TT_HEAD) {
                if (parcel.readInt() != KEY_HEAD_INFO) {
                    z = false;
                } else {
                    textLen = parcel.readInt();
                    text = parcel.createByteArray();
                    if (text == null || text.length == 0) {
                        this.mHeadChars = null;
                    } else {
                        this.mHeadChars = new String(text);
                    }
                }
            } else if (type != 101) {
