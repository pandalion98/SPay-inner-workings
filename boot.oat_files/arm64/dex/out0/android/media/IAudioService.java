...
public interface IAudioService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAudioService {
        ...
        static final int TRANSACTION_abandonAudioFocus = 37;
        ...
        static final int TRANSACTION_dismissVolumePanel = 73;
        static final int TRANSACTION_forceRemoteSubmixFullVolume = 6;
        static final int TRANSACTION_forceVolumeControlStream = 48;
        static final int TRANSACTION_getActiveStreamType = 70;
        static final int TRANSACTION_getAudioServiceConfig = 77;
        static final int TRANSACTION_getCurrentAudioFocus = 39;
        static final int TRANSACTION_getCurrentAudioFocusPackageName = 75;
        ...
        static final int TRANSACTION_getRingtonePlayer = 50;
        ...
        static final int TRANSACTION_getUiSoundsStreamType = 51;
        static final int TRANSACTION_getVibrateSetting = 20;
        static final int TRANSACTION_isBluetoothA2dpOn = 35;
        static final int TRANSACTION_isBluetoothScoOn = 33;
        static final int TRANSACTION_isCameraSoundForced = 55;
        static final int TRANSACTION_isForceSpeakerOn = 79;
        static final int TRANSACTION_isHdmiSystemAudioSupported = 62;
        static final int TRANSACTION_isMasterMute = 7;
        static final int TRANSACTION_isMediaSilentMode = 72;
        static final int TRANSACTION_isRadioSpeakerOn = 69;
        ...
        static final int TRANSACTION_registerRemoteControlDisplay = 40;
        static final int TRANSACTION_registerRemoteController = 41;
        static final int TRANSACTION_reloadAudioSettings = 28;
        static final int TRANSACTION_remoteControlDisplayUsesBitmapSize = 43;
        static final int TRANSACTION_remoteControlDisplayWantsPlaybackPositionSync = 44;
        static final int TRANSACTION_requestAudioFocus = 36;
        static final int TRANSACTION_setAudioServiceConfig = 76;
        static final int TRANSACTION_setBluetoothA2dpDeviceConnectionState = 53;
        static final int TRANSACTION_setBluetoothA2dpOn = 34;
        static final int TRANSACTION_setBluetoothScoOn = 32;
        static final int TRANSACTION_setDeviceToForceByUser = 80;
        static final int TRANSACTION_setFocusPropertiesForPolicy = 65;
        static final int TRANSACTION_setForceSpeakerOn = 78;
        static final int TRANSACTION_setForceUseForMedia = 67;
        static final int TRANSACTION_setHdmiSystemAudioSupported = 61;
        static final int TRANSACTION_setMasterMute = 8;
        static final int TRANSACTION_setMediaSilentMode = 71;
        static final int TRANSACTION_setMicrophoneMute = 13;
        static final int TRANSACTION_setMode = 22;
        static final int TRANSACTION_setRadioSpeakerOn = 68;
        static final int TRANSACTION_setRemoteStreamVolume = 4;
        static final int TRANSACTION_setRingerModeExternal = 14;
        static final int TRANSACTION_setRingerModeInternal = 15;
        static final int TRANSACTION_setRingtonePlayer = 49;
        static final int TRANSACTION_setSpeakerphoneOn = 30;
        static final int TRANSACTION_setStreamVolume = 3;
        static final int TRANSACTION_setTogether = 74;
        static final int TRANSACTION_setVibrateSetting = 19;
        static final int TRANSACTION_setVolumeController = 56;
        static final int TRANSACTION_setVolumePolicy = 66;
        static final int TRANSACTION_setWiredDeviceConnectionState = 52;
        static final int TRANSACTION_shouldVibrate = 21;
        static final int TRANSACTION_startBluetoothSco = 45;
        static final int TRANSACTION_startBluetoothScoVirtualCall = 46;
        static final int TRANSACTION_startWatchingRoutes = 54;
        static final int TRANSACTION_stopBluetoothSco = 47;
        static final int TRANSACTION_unloadSoundEffects = 27;
        static final int TRANSACTION_unregisterAudioFocusClient = 38;
        static final int TRANSACTION_unregisterAudioPolicyAsync = 64;
        static final int TRANSACTION_unregisterRemoteControlDisplay = 42;
        ...
        private static class Proxy implements IAudioService {
            ...
            public void setForceUseForMedia(int forced_config) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(forced_config);
            ...
            public void setRadioSpeakerOn(boolean on) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public boolean isRadioSpeakerOn() throws RemoteException {
                boolean _result = false;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public int getActiveStreamType(int suggestedStreamType) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setMediaSilentMode(boolean state) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public boolean isMediaSilentMode() throws RemoteException {
                boolean _result = false;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void setTogether(boolean value) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 50:
                    data.enforceInterface(DESCRIPTOR);
                    IRingtonePlayer _result4 = getRingtonePlayer();
                    reply.writeNoException();
                ...
                case 54:
                    data.enforceInterface(DESCRIPTOR);
                    AudioRoutesInfo _result5 = startWatchingRoutes(android.media.IAudioRoutesObserver.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                ...
                case 63:
                    ...
                    _result3 = registerAudioPolicy(_arg05, android.media.audiopolicy.IAudioPolicyCallback.Stub.asInterface(data.readStrongBinder()), data.readInt() != 0);
                    reply.writeNoException();
                ...
                case 67:
                    data.enforceInterface(DESCRIPTOR);
                    setForceUseForMedia(data.readInt());
                    reply.writeNoException();
                    return true;
                case 68:
                    data.enforceInterface(DESCRIPTOR);
                    setRadioSpeakerOn(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 69:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isRadioSpeakerOn();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 70:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getActiveStreamType(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 71:
                    data.enforceInterface(DESCRIPTOR);
                    setMediaSilentMode(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 72:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isMediaSilentMode();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 73:
                ...
                case 74:
                    data.enforceInterface(DESCRIPTOR);
                    setTogether(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 75:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getCurrentAudioFocusPackageName();
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 76:
                    data.enforceInterface(DESCRIPTOR);
                    setAudioServiceConfig(data.readString());
                    reply.writeNoException();
                    return true;
                case 77:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getAudioServiceConfig(data.readString());
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 78:
                    data.enforceInterface(DESCRIPTOR);
                    setForceSpeakerOn(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 79:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isForceSpeakerOn();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 80:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = setDeviceToForceByUser(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
    ...
    boolean isMediaSilentMode() throws RemoteException;

    boolean isRadioSpeakerOn() throws RemoteException;
    ...
    int setDeviceToForceByUser(int i, String str) throws RemoteException;
    ...
    void setForceUseForMedia(int i) throws RemoteException;
    ...
    void setMediaSilentMode(boolean z) throws RemoteException;
    ...
    void setRadioSpeakerOn(boolean z) throws RemoteException;
    ...
    void setTogether(boolean z) throws RemoteException;
