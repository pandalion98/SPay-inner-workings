...
public class RemoteControlClient {
    ...
    private void setPlaybackStateInt(int state, long timeInMs, float playbackSpeed, boolean hasPosition) {
        ...
        synchronized (this.mCacheLock) {
            if (!(this.mPlaybackState == state && this.mPlaybackPositionMs == timeInMs && this.mPlaybackSpeed == playbackSpeed && (this.mPlaybackPositionMs != 0 || timeInMs != 0))) {
    ...
    private void onPositionDriftCheck() {
        ...
        r5 = r14.mCacheLock;
        monitor-enter(r5);
        r4 = r14.mEventHandler;	 Catch:{ all -> 0x0022 }
        if (r4 == 0) goto L_0x0011;
    L_0x0009:
        r4 = r14.mPositionProvider;	 Catch:{ all -> 0x0022 }
        if (r4 == 0) goto L_0x0011;
    L_0x000d:
        r4 = r14.mNeedsPositionSync;	 Catch:{ all -> 0x0022 }
    ...
    L_0x0012:
        return;
    L_0x0013:
        r6 = r14.mPlaybackPositionMs;	 Catch:{ all -> 0x0022 }
        r4 = (r6 > r12 ? 1 : (r6 == r12 ? 0 : -1));
        if (r4 < 0) goto L_0x0020;
    L_0x0019:
        r4 = r14.mPlaybackSpeed;	 Catch:{ all -> 0x0022 }
        r6 = 0;
    ...
    L_0x0025:
        r6 = r14.mPlaybackPositionMs;	 Catch:{ all -> 0x0022 }
        r8 = android.os.SystemClock.elapsedRealtime();	 Catch:{ all -> 0x0022 }
        r10 = r14.mPlaybackStateChangeTimeMs;	 Catch:{ all -> 0x0022 }
        r8 = r8 - r10;
        r4 = (float) r8;	 Catch:{ all -> 0x0022 }
        r8 = r14.mPlaybackSpeed;	 Catch:{ all -> 0x0022 }
        r4 = r4 / r8;
        r8 = (long) r4;	 Catch:{ all -> 0x0022 }
        r2 = r6 + r8;
        r4 = r14.mPositionProvider;	 Catch:{ all -> 0x0022 }
        r0 = r4.onGetPlaybackPosition();	 Catch:{ all -> 0x0022 }
        r4 = (r0 > r12 ? 1 : (r0 == r12 ? 0 : -1));
        if (r4 < 0) goto L_0x0068;
    L_0x003f:
        r6 = r2 - r0;
        r6 = java.lang.Math.abs(r6);	 Catch:{ all -> 0x0022 }
        r8 = 500; // 0x1f4 float:7.0E-43 double:2.47E-321;
        r4 = (r6 > r8 ? 1 : (r6 == r8 ? 0 : -1));
        if (r4 <= 0) goto L_0x0054;
    L_0x004b:
        r4 = r14.mPlaybackState;	 Catch:{ all -> 0x0022 }
        r6 = r14.mPlaybackSpeed;	 Catch:{ all -> 0x0022 }
        r14.setPlaybackState(r4, r0, r6);	 Catch:{ all -> 0x0022 }
    L_0x0052:
        monitor-exit(r5);	 Catch:{ all -> 0x0022 }
        goto L_0x0012;
    L_0x0054:
        r4 = r14.mEventHandler;	 Catch:{ all -> 0x0022 }
        r6 = r14.mEventHandler;	 Catch:{ all -> 0x0022 }
        r7 = 11;
        r6 = r6.obtainMessage(r7);	 Catch:{ all -> 0x0022 }
        r7 = r14.mPlaybackSpeed;	 Catch:{ all -> 0x0022 }
        r8 = getCheckPeriodFromSpeed(r7);	 Catch:{ all -> 0x0022 }
        r4.sendMessageDelayed(r6, r8);	 Catch:{ all -> 0x0022 }
        goto L_0x0052;
    L_0x0068:
        r4 = r14.mEventHandler;	 Catch:{ all -> 0x0022 }
        r6 = 11;
        r4.removeMessages(r6);	 Catch:{ all -> 0x0022 }
        goto L_0x0052;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.media.RemoteControlClient.onPositionDriftCheck():void");
    }
    ...
    public void setOnGetPlaybackPositionListener(OnGetPlaybackPositionListener l) {
        synchronized (this.mCacheLock) {
            ...
            if (!(this.mPositionProvider == null || this.mEventHandler == null || !playbackPositionShouldMove(this.mPlaybackState))) {
                this.mEventHandler.sendMessageDelayed(this.mEventHandler.obtainMessage(11), 0);
            }
        }
    }
