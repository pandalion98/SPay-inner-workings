...
public abstract class MediaMetadataEditor {
    ...
    public synchronized int[] getEditableKeys() {
        return this.mEditableKeys == 268435457 ? new int[]{RATING_KEY_BY_USER} : null;
    }
        ...
        switch (METADATA_KEYS_TYPE.get(key, -1)) {
            case 0:
                if (this.mEditorMetadata.containsKey(String.valueOf(key))) {
                    defaultValue = Long.valueOf(this.mEditorMetadata.getLong(String.valueOf(key)));
                    break;
                }
                break;
            case 1:
                if (this.mEditorMetadata.containsKey(String.valueOf(key))) {
                    defaultValue = this.mEditorMetadata.getString(String.valueOf(key));
                    break;
                }
                break;
            case 2:
            ...
            case 3:
                if (this.mEditorMetadata.containsKey(String.valueOf(key))) {
                    defaultValue = this.mEditorMetadata.getParcelable(String.valueOf(key));
                    break;
                }
                break;
        }
