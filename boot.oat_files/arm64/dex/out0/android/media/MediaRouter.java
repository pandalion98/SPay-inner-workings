...
public class MediaRouter {
    static final /* synthetic */ boolean $assertionsDisabled = (!MediaRouter.class.desiredAssertionStatus());
    ...
    static class Static implements DisplayListener {
        ...
        final IAudioRoutesObserver.Stub mAudioRoutesObserver = new IAudioRoutesObserver.Stub() {
            public void dispatchAudioRoutesChanged(final AudioRoutesInfo newRoutes) {
                final long AudioRoutesChangedTime = SystemClock.uptimeMillis();
                MediaRouter.sStatic.mLastDispatchAudioRoutesChangedTime = AudioRoutesChangedTime;
                Static.this.mHandler.post(new Runnable() {
                    public void run() {
                        if (AudioRoutesChangedTime >= MediaRouter.sStatic.mLastDispatchAudioRoutesChangedTime || newRoutes.bluetoothName != null || Static.this.mCurAudioRoutesInfo.bluetoothName == null) {
                            Static.this.updateAudioRoutes(newRoutes);
                        } else {
                            Log.w(MediaRouter.TAG, "The invalid updateAudioRoutes is skipped. Current Bluetooth: " + Static.this.mCurAudioRoutesInfo.bluetoothName);
                        }
                    }
                });
            }
        ...
        long mLastDispatchAudioRoutesChangedTime = 0;
        ...
        Static(Context appContext) {
            ...
            this.mSystemCategory = new RouteCategory(17040584, 3, false);
        ...
        void startMonitoringRoutes(Context appContext) {
            ...
            this.mDefaultAudioVideo.mNameResId = 17040580;
            ...
            this.mDisplayService.registerDisplayListener((DisplayListener) this, this.mHandler);
            ...
            if (!TextUtils.equals(newRoutes.bluetoothName, this.mCurAudioRoutesInfo.bluetoothName)) {
                ...
                if (this.mCurAudioRoutesInfo.bluetoothName != null) {
                    if (MediaRouter.sStatic.mBluetoothA2dpRoute == null) {
                        ...
                        info.mDescription = MediaRouter.sStatic.mResources.getText(17040585);
    ...
    static void selectRouteStatic(int types, RouteInfo route, boolean explicit) {
        if ($assertionsDisabled || route != null) {
            ...
            if (route.matchesTypes(types)) {
                ...
                boolean bluetoothA2dpRoute = false;
                ...
                if (activeDisplay != null || oldRouteHasAddress || newRouteHasAddress) {
                    if (!newRouteHasAddress || matchesDeviceAddress(activeDisplay, route)) {
                        if (!(activeDisplay == null || newRouteHasAddress || bluetoothA2dpRoute)) {
    ...
    static boolean isAudioPathA2DPStatic() {
        ...
        if (sStatic.mSelectedRoute != null) {
            stream = sStatic.mSelectedRoute.getPlaybackStream();
        }
    ...
    static boolean matchesDeviceAddress(WifiDisplay display, RouteInfo info) {
        ...
        if (display != null || routeHasAddress) {
            return (display == null || !routeHasAddress) ? false : display.getDeviceAddress().equals(info.mDeviceAddress);
        } else {
            return true;
        }
    }
    ...
    static RouteInfo makeWifiDisplayRoute(WifiDisplay display, WifiDisplayStatus wfdStatus) {
        ...
        newRoute.mDescription = sStatic.mResources.getText(17040586);
