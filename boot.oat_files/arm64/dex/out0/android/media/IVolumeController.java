...
public interface IVolumeController extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IVolumeController {
        ...
        static final int TRANSACTION_isSafeVolumeDialogShowing = 6;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result = isSafeVolumeDialogShowing();
    ...
    boolean isSafeVolumeDialogShowing() throws RemoteException;
