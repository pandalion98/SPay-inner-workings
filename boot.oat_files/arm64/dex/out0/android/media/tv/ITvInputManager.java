...
public interface ITvInputManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITvInputManager {
        ...
        static final int TRANSACTION_acquireTvInputHardware = 33;
        static final int TRANSACTION_addBlockedRating = 11;
        static final int TRANSACTION_captureFrame = 36;
        ...
        static final int TRANSACTION_getAvailableTvStreamConfigList = 35;
        static final int TRANSACTION_getBlockedRatings = 10;
        static final int TRANSACTION_getDvbDeviceList = 38;
        static final int TRANSACTION_getHardwareList = 32;
        ...
        static final int TRANSACTION_isSingleSessionActive = 37;
        static final int TRANSACTION_openDvbDevice = 39;
        ...
        static final int TRANSACTION_releaseTvInputHardware = 34;
        ...
        static final int TRANSACTION_timeShiftEnablePositionTracking = 31;
        static final int TRANSACTION_timeShiftPause = 27;
        static final int TRANSACTION_timeShiftResume = 28;
        static final int TRANSACTION_timeShiftSeekTo = 29;
        static final int TRANSACTION_timeShiftSetPlaybackParams = 30;
        static final int TRANSACTION_tune = 19;
        static final int TRANSACTION_unblockContent = 26;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 33:
                    ...
                    ITvInputHardware _result8 = acquireTvInputHardware(_arg02, _arg17, _arg23, data.readInt());
                    reply.writeNoException();
                ...
                case 38:
                    ...
                    return true;
                case 39:
                    DvbDeviceInfo _arg04;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg04 = (DvbDeviceInfo) DvbDeviceInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg04 = null;
                    }
                    ParcelFileDescriptor _result11 = openDvbDevice(_arg04, data.readInt());
                    reply.writeNoException();
                    if (_result11 != null) {
                        reply.writeInt(1);
