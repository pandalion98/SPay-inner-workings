        ...
        private void broadcastAddHardwareTvInput(int deviceId, TvInputInfo inputInfo) {
            ...
            for (int i = 0; i < n; i++) {
                try {
                    ...
                    Log.e(TvInputService.TAG, "error in broadcastAddHardwareTvInput", e);
                }
            }
        ...
        private void broadcastAddHdmiTvInput(int id, TvInputInfo inputInfo) {
            ...
            for (int i = 0; i < n; i++) {
                try {
                    ...
                    Log.e(TvInputService.TAG, "error in broadcastAddHdmiTvInput", e);
                }
            }
            TvInputService.this.mCallbacks.finishBroadcast();
        }
        ...
        private void broadcastRemoveTvInput(String inputId) {
            ...
            for (int i = 0; i < n; i++) {
                try {
                    ...
                    Log.e(TvInputService.TAG, "error in broadcastRemoveTvInput", e);
                }
            }
            TvInputService.this.mCallbacks.finishBroadcast();
        }
