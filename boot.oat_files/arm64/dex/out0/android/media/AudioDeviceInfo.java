...
public final class AudioDeviceInfo {
    ...
    public static final int TYPE_R_SUBMIX = 21;
    ...
    public int[] getChannelCounts() {
        ...
        for (int mask : getChannelMasks()) {
            countSet.add(Integer.valueOf(isSink() ? AudioFormat.channelCountFromOutChannelMask(mask) : AudioFormat.channelCountFromInChannelMask(mask)));
        }
        ...
        while (i$.hasNext()) {
            int index2 = index + 1;
            counts[index] = ((Integer) i$.next()).intValue();
            index = index2;
        }
        return counts;
    }
    ...
    static {
        ...
        INT_TO_EXT_DEVICE_MAPPING.put(536870912, 8);
        ...
        INT_TO_EXT_DEVICE_MAPPING.put(32768, 21);
        ...
        EXT_TO_INT_DEVICE_MAPPING.put(21, 32768);
    }
}
