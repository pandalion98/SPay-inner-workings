...
public class AudioSystem {
    ...
    public static final int AUDIO_STATUS_STOP_RECORDING = 200;
    ...
    public static int[] DEFAULT_STREAM_VOLUME = new int[]{4, 6, 11, 7, 11, 11, 7, 14, 11, 11, 7, 4, 4, 7};
    ...
    public static final int DEVICE_IN_ALL = -1006632961;
    ...
    public static final int DEVICE_IN_EXTERNAL_MIC = -2143289344;
    public static final int DEVICE_IN_EXTERNAL_TMS = -2145386496;
    public static final int DEVICE_IN_FM = -2147475456;
    public static final int DEVICE_IN_FM_RX = -2130706432;
    public static final int DEVICE_IN_FM_RX_A2DP = -2113929216;
    ...
    public static final int DEVICE_IN_PROXY = -2139095040;
    ...
    public static final int DEVICE_IN_THIRD_MIC = -2146435072;
    ...
    public static final int DEVICE_OUT_ACPU = 134217728;
    public static final int DEVICE_OUT_ALL = Integer.MAX_VALUE;
    public static final int DEVICE_OUT_ALL_A2DP = 536871808;
    ...
    public static final int DEVICE_OUT_BLUETOOTH_A2DP_AOBLE = 536870912;
    public static final String DEVICE_OUT_BLUETOOTH_A2DP_AOBLE_NAME = "bt_a2dp_aoble";
    ...
    public static final int DEVICE_OUT_EXTERNAL_TMS = 33554432;
    public static final String DEVICE_OUT_EXTERNAL_TMS_NAME = "external_tms";
    public static final int DEVICE_OUT_EXTERNAL_WIFI = 16777216;
    public static final String DEVICE_OUT_EXTERNAL_WIFI_NAME = "external_wifi";
    public static final int DEVICE_OUT_FM = 1048576;
    public static final String DEVICE_OUT_FM_NAME = "fm_transmitter";
    public static final int DEVICE_OUT_FM_TX = 268435456;
    ...
    public static final int DEVICE_OUT_PROXY = 67108864;
    ...
    public static final int FORCE_2MIC = 13;
    ...
    public static final int FOR_FMRADIO = 6;
    ...
    public static final int PLAY_SOUND_DELAY = 0;
    @Deprecated
    ...
    public static final String[] STREAM_NAMES = new String[]{"STREAM_VOICE_CALL", "STREAM_SYSTEM", "STREAM_RING", "STREAM_MUSIC", "STREAM_ALARM", "STREAM_NOTIFICATION", "STREAM_BLUETOOTH_SCO", "STREAM_SYSTEM_ENFORCED", "STREAM_DTMF", "STREAM_TTS", "STREAM_FM_RADIO", "STREAM_VIDEO_CALL", "STREAM_SEC_COMMUNICATION", "STREAM_VOICENOTE"};
    ...
    public static native boolean isMediaServerStarted();
    ...
    public static String getOutputDeviceName(int device) {
        switch (device) {
            ...
            case 8388608:
                return "ip";
            case 16777216:
                return DEVICE_OUT_EXTERNAL_WIFI_NAME;
            case 33554432:
                return DEVICE_OUT_EXTERNAL_TMS_NAME;
            case 67108864:
                return DEVICE_OUT_PROXY_NAME;
            case 268435456:
                return DEVICE_OUT_FM_TX_NAME;
            case 536870912:
                return DEVICE_OUT_BLUETOOTH_A2DP_AOBLE_NAME;
            default:
    ...
    public static int getPlatformType(Context context) {
        if (context.getResources().getBoolean(17956955)) {
            return 1;
        }
