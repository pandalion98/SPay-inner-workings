...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:android.print.PrintManager.PrintDocumentAdapterDelegate.MyLayoutResultCallback.onLayoutFinished(android.print.PrintDocumentInfo, boolean):void. bs: [B:12:0x0019, B:18:0x0026]
...
*/
                ...
                r3 = r2.mLock;
                monitor-enter(r3);
                r0 = r4.mCallback;	 Catch:{ all -> 0x0014 }
            ...
            L_0x0019:
                r2 = new java.lang.NullPointerException;	 Catch:{ all -> 0x0021 }
                r3 = "document info cannot be null";	 Catch:{ all -> 0x0021 }
            ...
            L_0x0021:
                ...
                throw r2;
            L_0x0026:
                r2 = r4.mSequence;	 Catch:{ RemoteException -> 0x002f }
                r0.onLayoutFinished(r5, r6, r2);	 Catch:{ RemoteException -> 0x002f }
            L_0x002b:
                r4.destroy();
                goto L_0x0013;
            L_0x002f:
                r1 = move-exception;
                r2 = "PrintManager";	 Catch:{ all -> 0x0021 }
                r3 = "Error calling onLayoutFinished";	 Catch:{ all -> 0x0021 }
                android.util.Log.e(r2, r3, r1);	 Catch:{ all -> 0x0021 }
                goto L_0x002b;
                */
        ...
        private final class MyWriteResultCallback extends WriteResultCallback implements DestroyableCallback {
            ...
            public void onWriteFinished(android.print.PageRange[] r5) {
                /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:android.print.PrintManager.PrintDocumentAdapterDelegate.MyWriteResultCallback.onWriteFinished(android.print.PageRange[]):void. bs: [B:12:0x0019, B:23:0x0033]
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:86)
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.process(ProcessTryCatchRegions.java:45)
	at jadx.core.dex.visitors.regions.RegionMakerVisitor.postProcessRegions(RegionMakerVisitor.java:63)
	at jadx.core.dex.visitors.regions.RegionMakerVisitor.visit(RegionMakerVisitor.java:58)
...
*/
            ...
            L_0x0019:
                r2 = new java.lang.IllegalArgumentException;	 Catch:{ all -> 0x0022 }
                r3 = "pages cannot be null";	 Catch:{ all -> 0x0022 }
            ...
            L_0x0022:
                ...
                throw r2;
            L_0x0027:
                r2 = r5.length;	 Catch:{ all -> 0x0022 }
                if (r2 != 0) goto L_0x0033;	 Catch:{ all -> 0x0022 }
            L_0x002a:
                r2 = new java.lang.IllegalArgumentException;	 Catch:{ all -> 0x0022 }
                r3 = "pages cannot be empty";	 Catch:{ all -> 0x0022 }
                r2.<init>(r3);	 Catch:{ all -> 0x0022 }
                throw r2;	 Catch:{ all -> 0x0022 }
            L_0x0033:
                r2 = r4.mSequence;	 Catch:{ RemoteException -> 0x003c }
                r0.onWriteFinished(r5, r2);	 Catch:{ RemoteException -> 0x003c }
            L_0x0038:
                r4.destroy();
                goto L_0x0013;
            L_0x003c:
                r1 = move-exception;
                r2 = "PrintManager";	 Catch:{ all -> 0x0022 }
                r3 = "Error calling onWriteFinished";	 Catch:{ all -> 0x0022 }
                android.util.Log.e(r2, r3, r1);	 Catch:{ all -> 0x0022 }
                goto L_0x0038;
                */
