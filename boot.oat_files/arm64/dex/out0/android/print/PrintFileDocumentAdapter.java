...
public class PrintFileDocumentAdapter extends PrintDocumentAdapter {
    ...
    private final class WriteFileAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                try {
                    ...
                    this.mResultCallback.onWriteFailed(PrintFileDocumentAdapter.this.mContext.getString(17040732));
        ...
        protected void onCancelled(Void result) {
            this.mResultCallback.onWriteFailed(PrintFileDocumentAdapter.this.mContext.getString(17040731));
        }
    }
