...
public abstract class Uri implements Parcelable, Comparable<Uri> {
    ...
    private static abstract class AbstractHierarchicalUri extends Uri {
        ...
        private String parseHost() {
            ...
            return Uri.decode(portSeparator == -1 ? authority.substring(userInfoSeparator + 1) : authority.substring(userInfoSeparator + 1, portSeparator));
        }
    ...
    public boolean getBooleanQueryParameter(String key, boolean defaultValue) {
        ...
        boolean z = (AudioParameter.AUDIO_PARAMETER_VALUE_false.equals(flag) || "0".equals(flag)) ? false : true;
        return z;
    }
