...
public class StructNdMsg {
    ...
    public static byte NTF_ROUTER = BluetoothHidDevice.SUBCLASS1_MOUSE;
    ...
    public String toString() {
        String stateStr = ProxyInfo.LOCAL_EXCL_LIST + this.ndm_state + " (" + stringForNudState(this.ndm_state) + ")";
        return "StructNdMsg{ family{" + NetlinkConstants.stringForAddressFamily(this.ndm_family) + "}, " + "ifindex{" + this.ndm_ifindex + "}, " + "state{" + stateStr + "}, " + "flags{" + (ProxyInfo.LOCAL_EXCL_LIST + this.ndm_flags + " (" + stringForNudFlags(this.ndm_flags) + ")") + "}, " + "type{" + this.ndm_type + "} " + "}";
    }
}
