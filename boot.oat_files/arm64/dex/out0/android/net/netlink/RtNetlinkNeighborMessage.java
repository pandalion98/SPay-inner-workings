...
public class RtNetlinkNeighborMessage extends NetlinkMessage {
    ...
    public String toString() {
        return "RtNetlinkNeighborMessage{ nlmsghdr{" + (this.mHeader == null ? ProxyInfo.LOCAL_EXCL_LIST : this.mHeader.toString()) + "}, " + "ndmsg{" + (this.mNdmsg == null ? ProxyInfo.LOCAL_EXCL_LIST : this.mNdmsg.toString()) + "}, " + "destination{" + (this.mDestination == null ? ProxyInfo.LOCAL_EXCL_LIST : this.mDestination.getHostAddress()) + "} " + "linklayeraddr{" + NetlinkConstants.hexify(this.mLinkLayerAddr) + "} " + "probes{" + this.mNumProbes + "} " + "cacheinfo{" + (this.mCacheInfo == null ? ProxyInfo.LOCAL_EXCL_LIST : this.mCacheInfo.toString()) + "} " + "}";
    }
}
