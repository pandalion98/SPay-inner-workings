...
public class StructNlMsgHdr {
    ...
    public String toString() {
        String typeStr = ProxyInfo.LOCAL_EXCL_LIST + this.nlmsg_type + "(" + NetlinkConstants.stringForNlMsgType(this.nlmsg_type) + ")";
        return "StructNlMsgHdr{ nlmsg_len{" + this.nlmsg_len + "}, " + "nlmsg_type{" + typeStr + "}, " + "nlmsg_flags{" + (ProxyInfo.LOCAL_EXCL_LIST + this.nlmsg_flags + "(" + stringForNlMsgFlags(this.nlmsg_flags) + ")") + ")}, " + "nlmsg_seq{" + this.nlmsg_seq + "}, " + "nlmsg_pid{" + this.nlmsg_pid + "} " + "}";
    }
}
