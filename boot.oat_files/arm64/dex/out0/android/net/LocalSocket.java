...
public class LocalSocket implements Closeable {
    ...
    public void setReceiveBufferSize(int size) throws IOException {
        this.impl.setOption(NetworkPolicyManager.POLICY_ALLOW_WHITELIST_IN_ROAMING, Integer.valueOf(size));
    }

    public int getReceiveBufferSize() throws IOException {
        return ((Integer) this.impl.getOption(NetworkPolicyManager.POLICY_ALLOW_WHITELIST_IN_ROAMING)).intValue();
    }
