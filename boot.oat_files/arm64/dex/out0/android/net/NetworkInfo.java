...
public class NetworkInfo implements Parcelable {
    ...
    public NetworkInfo(int type, int subtype, String typeName, String subtypeName) {
        if (ConnectivityManager.isNetworkTypeValid(type) || type == 8192) {
    ...
    public String toString() {
        ...
        synchronized (this) {
            ...
            StringBuilder append = builder.append("type: ").append(getTypeName()).append("[").append(getSubtypeName()).append("] - ").append(ConnectivityManager.getNetworkTypeName(this.mNetworkType)).append(", state: ").append(this.mState).append("/").append(this.mDetailedState).append(", reason: ");
            if (this.mReason == null) {
                str = "(unspecified)";
            } else {
                str = this.mReason;
            }
            append = append.append(str).append(", extra: ");
            if (this.mExtraInfo == null) {
                str = "(none)";
            } else {
                str = this.mExtraInfo;
            }
            append.append(str).append(", roaming: ").append(this.mIsRoaming).append(", failover: ").append(this.mIsFailover).append(", isAvailable: ").append(this.mIsAvailable).append("]");
