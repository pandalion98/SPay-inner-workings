...
public class SslCertificate {
    ...
    public View inflateCertificateView(Context context) {
        View certificateView = LayoutInflater.from(context).inflate(17367296, null);
        DName issuedTo = getIssuedTo();
        if (issuedTo != null) {
            ((TextView) certificateView.findViewById(16909457)).setText(issuedTo.getCName());
            ((TextView) certificateView.findViewById(16909459)).setText(issuedTo.getOName());
            ((TextView) certificateView.findViewById(16909461)).setText(issuedTo.getUName());
        }
        ((TextView) certificateView.findViewById(16909463)).setText(getSerialNumber(this.mX509Certificate));
        DName issuedBy = getIssuedBy();
        if (issuedBy != null) {
            ((TextView) certificateView.findViewById(16909465)).setText(issuedBy.getCName());
            ((TextView) certificateView.findViewById(16909467)).setText(issuedBy.getOName());
            ((TextView) certificateView.findViewById(16909469)).setText(issuedBy.getUName());
        }
        ((TextView) certificateView.findViewById(16909472)).setText(formatCertificateDate(context, getValidNotBeforeDate()));
        ((TextView) certificateView.findViewById(16909474)).setText(formatCertificateDate(context, getValidNotAfterDate()));
        ((TextView) certificateView.findViewById(16909477)).setText(getDigest(this.mX509Certificate, "SHA256"));
        ((TextView) certificateView.findViewById(16909479)).setText(getDigest(this.mX509Certificate, "SHA1"));
