...
public abstract class NetworkAgent extends Handler {
    ...
    public static final int EVENT_REPLACE_NETWORK_INFO = 528400;
    ...
    public static final int INVALID_NETWORK_DISABLE = 3;
    public static final int VALID_NETWORK = 1;
    public static final int VALID_NETWORK_AUTHENTICATED = 4;
    ...
    public void handleMessage(Message msg) {
        switch (msg.what) {
            ...
            case CMD_REPORT_NETWORK_STATUS /*528391*/:
                log("CMD_REPORT_NETWORK_STATUS(" + (msg.arg1 == 1 ? "VALID)" : "INVALID)"));
                log("CMD_REPORT_NETWORK_STATUS(" + msg.arg1 + ")");
    ...
    public void sendNetworkInfoWithoutSwitch(NetworkInfo networkInfo) {
        queueOrSendMessage(EVENT_REPLACE_NETWORK_INFO, new NetworkInfo(networkInfo));
    }
