...
public final class WifiActivityEnergyInfo implements Parcelable {
    public static final Creator<WifiActivityEnergyInfo> CREATOR = new Creator<WifiActivityEnergyInfo>() {
        public WifiActivityEnergyInfo createFromParcel(Parcel in) {
            return new WifiActivityEnergyInfo(in.readLong(), in.readInt(), in.readLong(), in.readLong(), in.readLong(), in.readLong());
        }
    ...
    public WifiActivityEnergyInfo(long timestamp, int stackState, long txTime, long rxTime, long idleTime, long energyUsed) {
