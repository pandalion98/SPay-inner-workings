...
public class WifiP2pDeviceList implements Parcelable {
    ...
    public void updateSupplicantDetails(WifiP2pDevice device) {
        if (device != null && device.deviceAddress != null) {
            ...
            if (d != null) {
                ...
                d.groupownerAddress = device.groupownerAddress;
                d.GOdeviceName = device.GOdeviceName;
                d.SConnectInfo = device.SConnectInfo;
                d.contactInfoHash = device.contactInfoHash;
                d.contactImage = device.contactImage;
                return;
            }
    ...
    public boolean remove(WifiP2pDevice device) {
        if (device == null || device.deviceAddress == null || this.mDevices.remove(device.deviceAddress) == null) {
            return false;
        }
        return true;
    }
