...
public class NetworkStats implements Parcelable {
    ...
    public static class Entry {
        ...
        public void remove(long bytes, long packets) {
            this.txBytes -= bytes;
    ...
    public void modifyValues(int i, Entry entry) {
        if (i != -1 && entry != null) {
    ...
    public void combineValues(int i, long bytes, long packets, boolean add) {
        if (i != -1) {
            long[] jArr;
            if (add) {
                jArr = this.txBytes;
    ...
    private void deductTrafficFromVpnApp(int tunUid, String underlyingIface, Entry moved) {
        ...
        combineValues(moved);
        int idxVpnBackground = findIndex(underlyingIface, tunUid, 0, 0);
        if (idxVpnBackground != -1) {
            tunSubtract(idxVpnBackground, this, moved);
        }
        int idxVpnForeground = findIndex(underlyingIface, tunUid, 1, 0);
