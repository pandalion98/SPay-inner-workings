...
public class NetworkUtils {
    ...
    public static native boolean getDhcpResults(String str, DhcpResults dhcpResults);
    ...
    public static native boolean startDhcp(String str);

    public static native boolean startDhcpRenew(String str);

    public static native int startPppoe(PPPOEConfig pPPOEConfig);

    public static native boolean stopDhcp(String str);

    public static native int stopPppoe();
    ...
    public static boolean configureInterface(String interfaceName, DhcpInfo ipInfo) {
        return configureNative(interfaceName, ipInfo.ipAddress, ipInfo.netmask, ipInfo.gateway, ipInfo.dns1, ipInfo.dns2);
    }
