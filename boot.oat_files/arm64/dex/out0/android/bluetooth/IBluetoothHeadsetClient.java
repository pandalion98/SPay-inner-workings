...
public interface IBluetoothHeadsetClient extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothHeadsetClient {
        ...
        static final int TRANSACTION_acceptCall = 15;
        static final int TRANSACTION_acceptIncomingConnect = 3;
        static final int TRANSACTION_connect = 1;
        static final int TRANSACTION_connectAudio = 27;
        static final int TRANSACTION_dial = 22;
        static final int TRANSACTION_dialMemory = 23;
        static final int TRANSACTION_disconnect = 2;
        static final int TRANSACTION_disconnectAudio = 28;
        static final int TRANSACTION_enterPrivateMode = 19;
        static final int TRANSACTION_explicitCallTransfer = 20;
        static final int TRANSACTION_getAudioState = 26;
        static final int TRANSACTION_getCLCC = 12;
        static final int TRANSACTION_getConnectedDevices = 5;
        static final int TRANSACTION_getConnectionState = 7;
        static final int TRANSACTION_getCurrentAgEvents = 14;
        static final int TRANSACTION_getCurrentAgFeatures = 29;
        static final int TRANSACTION_getCurrentCalls = 13;
        static final int TRANSACTION_getDevicesMatchingConnectionStates = 6;
        static final int TRANSACTION_getLastVoiceTagNumber = 25;
        static final int TRANSACTION_getPriority = 9;
        static final int TRANSACTION_holdCall = 16;
        static final int TRANSACTION_redial = 21;
        static final int TRANSACTION_rejectCall = 17;
        ...
        static final int TRANSACTION_terminateCall = 18;
    ...
    boolean getCLCC() throws RemoteException;
