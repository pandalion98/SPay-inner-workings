...
public interface IBluetoothA2dpSink extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothA2dpSink {
        ...
        static final int TRANSACTION_getPendingDevice = 7;
        ...
        private static class Proxy implements IBluetoothA2dpSink {
            ...
            public BluetoothDevice getPendingDevice() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    BluetoothDevice _result5 = getPendingDevice();
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
    ...
    BluetoothDevice getPendingDevice() throws RemoteException;
}
