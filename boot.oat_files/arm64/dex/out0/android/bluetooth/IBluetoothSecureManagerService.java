...
public interface IBluetoothSecureManagerService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothSecureManagerService {
        ...
        private static class Proxy implements IBluetoothSecureManagerService {
            ...
            public int getSecureModeSetting(String name) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean setSecureModeSetting(String name, int value) throws RemoteException {
                boolean _result = false;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
        ...
        public static IBluetoothSecureManagerService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IBluetoothSecureManagerService)) {
                return new Proxy(obj);
            }
            return (IBluetoothSecureManagerService) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    _result = enableSecureMode(_arg0);
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getSecureModeSetting(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setSecureModeSetting(data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    _result = addWhiteList(data.readString(), data.readInt(), data.createStringArray());
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    _result = removeWhiteList(data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getWhiteListFirstIndex();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getWhiteListNextIndex(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    String _result3 = getWhiteListName(data.readInt());
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getWhiteListCod(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    String[] _result4 = getWhiteListUuids(data.readInt());
                    reply.writeNoException();
    ...
    boolean addWhiteList(String str, int i, String[] strArr) throws RemoteException;

    boolean enableSecureMode(boolean z) throws RemoteException;

    boolean enableWhiteList(boolean z) throws RemoteException;

    int getSecureModeSetting(String str) throws RemoteException;

    int getWhiteListCod(int i) throws RemoteException;

    int getWhiteListFirstIndex() throws RemoteException;

    String getWhiteListName(int i) throws RemoteException;

    int getWhiteListNextIndex(int i) throws RemoteException;

    String[] getWhiteListUuids(int i) throws RemoteException;

    boolean isSecureModeEnabled() throws RemoteException;

    boolean isWhiteListEnabled() throws RemoteException;

    boolean removeWhiteList(String str, int i) throws RemoteException;

    boolean setSecureModeSetting(String str, int i) throws RemoteException;
}
