...
public final class BluetoothHeadsetClient implements BluetoothProfile {
    ...
    public static final String ACTION_SET_BIA = "android.bluetooth.headsetclient.profile.action.SET_BIA";
    public static final int BIA_INDICATOR_BATTERYCHG = 1;
    public static final int BIA_INDICATOR_CALL = 8;
    public static final int BIA_INDICATOR_CALLHELD = 64;
    public static final int BIA_INDICATOR_CALLSETUP = 32;
    public static final int BIA_INDICATOR_ROAM = 16;
    public static final int BIA_INDICATOR_SERVICE = 4;
    public static final int BIA_INDICATOR_SIGNAL = 2;
    ...
    public static final String EXTRA_BIA_VALUE = "android.bluetooth.headsetclient.extra.BIA_VALUE";
