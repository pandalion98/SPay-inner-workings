...
public final class BluetoothClass implements Parcelable {
    ...
    public int getPeripheralMinorClass() {
        return this.mClass & Device.PERIPHERAL_KEYBOARD_POINTING;
    }

    public int getPeripheralMinorSubClass() {
        return this.mClass & 1340;
    }
    ...
    public boolean doesClassMatch(int profile) {
        if (profile == 1) {
            ...
            if (hasService(131072) || (getDeviceClass() & 768) == 768) {
                return true;
            }
            return false;
        }
