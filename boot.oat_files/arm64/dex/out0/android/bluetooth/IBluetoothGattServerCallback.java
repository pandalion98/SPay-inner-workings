...
public interface IBluetoothGattServerCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothGattServerCallback {
        ...
        static final int TRANSACTION_onServerConnParamsChanged = 12;
        ...
        private static class Proxy implements IBluetoothGattServerCallback {
            ...
            public void onServerConnParamsChanged(String address, int interval, int status) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(address);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    onServerConnParamsChanged(data.readString(), data.readInt(), data.readInt());
                    return true;
    ...
    void onServerConnParamsChanged(String str, int i, int i2) throws RemoteException;
