...
public final class Debug {
    ...
    public static native void dumpResetReason(String str, String str2);
    ...
    public static native void getBuddyInfo(long[] jArr);
    ...
    public static native void getPssSwapPss(int i, long[] jArr, long[] jArr2);

    private static native int isProductShipNative();

    private static native void saveDumpstateNative(String str);
    ...
    public static int isProductShip() {
        return isProductShipNative();
    }

    public static void saveDumpstate(String str) {
        saveDumpstateNative(str);
    }
