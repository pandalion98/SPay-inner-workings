...
public interface IMountService extends IInterface {
    ...
    public static final int ENCRYPTION_STATE_ERROR_INCOMPLETE_DECRYPTION = -6;
    public static final int ENCRYPTION_STATE_ERROR_INCONSISTENT = -3;
    public static final int ENCRYPTION_STATE_ERROR_INTEGRITY_FAILURE = -7;
    ...
    public static abstract class Stub extends Binder implements IMountService {
        ...
        static final int TRANSACTION_changeEncryptionPassword2 = 203;
        static final int TRANSACTION_clearPassword = 38;
        static final int TRANSACTION_createNewUserDir = 63;
        static final int TRANSACTION_createSecureContainer = 11;
        static final int TRANSACTION_cryptoMount = 204;
        static final int TRANSACTION_decryptStorage = 27;
        static final int TRANSACTION_deleteUserKey = 64;
        static final int TRANSACTION_destroySecureContainer = 13;
        static final int TRANSACTION_disableStorageEncryption = 202;
        ...
        static final int TRANSACTION_getCCmodeForCryptKeeper = 212;
        static final int TRANSACTION_getCurrentEncryptionFailCount = 213;
        ...
        static final int TRANSACTION_getPropertyFromFooter = 209;
        ...
        static final int TRANSACTION_isEncryptedWithForceEncrypt = 210;
        ...
        static final int TRANSACTION_isStorageFullyEncrypted = 206;
        ...
        static final int TRANSACTION_moveDumpstates = 207;
        static final int TRANSACTION_odeNativeTest = 211;
        ...
        static final int TRANSACTION_prepareDecryptOnRecovery = 201;
        ...
        private static class Proxy implements IMountService {
            ...
            public void setVolumeState(String path, String state) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int prepareDecryptOnRecovery(int type, String password) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int disableStorageEncryption(int type, String password) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int changeEncryptionPassword2(String passwd, String newPasswd) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(passwd);
                    _data.writeString(newPasswd);
            ...
            public int cryptoMount(String passwd, String mountpoint) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int setNullSDCardPassword(String password) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int isStorageFullyEncrypted() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int moveDumpstates() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int odeNativeTest(String module) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int isEncryptedWithForceEncrypt() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int getCCmodeForCryptKeeper() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int setPropertyIntoFooter(String name, String value) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public String getPropertyFromFooter(String name) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int getCurrentEncryptionFailCount() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                    StorageVolume[] result4 = getVolumeList(data.readInt(), data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeTypedArray(result4, 1);
                    return true;
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 63:
                    data.enforceInterface(DESCRIPTOR);
                    createNewUserDir(data.readInt(), data.readString());
                    reply.writeNoException();
                    return true;
                case 64:
                    data.enforceInterface(DESCRIPTOR);
                    deleteUserKey(data.readInt());
                    reply.writeNoException();
                    return true;
                case 105:
                    data.enforceInterface(DESCRIPTOR);
                    setVolumeState(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 201:
                    data.enforceInterface(DESCRIPTOR);
                    resultCode = prepareDecryptOnRecovery(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                case 202:
                    data.enforceInterface(DESCRIPTOR);
                    result2 = disableStorageEncryption(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(result2);
                    return true;
                case 203:
                    data.enforceInterface(DESCRIPTOR);
                    resultCode = changeEncryptionPassword2(data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                case 204:
                    data.enforceInterface(DESCRIPTOR);
                    resultCode = cryptoMount(data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                case 205:
                    data.enforceInterface(DESCRIPTOR);
                    result2 = setNullSDCardPassword(data.readString());
                    reply.writeNoException();
                    reply.writeInt(result2);
                    return true;
                case 206:
                    data.enforceInterface(DESCRIPTOR);
                    result2 = isStorageFullyEncrypted();
                    reply.writeNoException();
                    reply.writeInt(result2);
                    return true;
                case 207:
                    data.enforceInterface(DESCRIPTOR);
                    result2 = moveDumpstates();
                    reply.writeNoException();
                    reply.writeInt(result2);
                    return true;
                case 208:
                    data.enforceInterface(DESCRIPTOR);
                    result2 = setPropertyIntoFooter(data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(result2);
                    return true;
                case 209:
                    data.enforceInterface(DESCRIPTOR);
                    result3 = getPropertyFromFooter(data.readString());
                    reply.writeNoException();
                    reply.writeString(result3);
                    return true;
                case 210:
                    data.enforceInterface(DESCRIPTOR);
                    result2 = isEncryptedWithForceEncrypt();
                    reply.writeNoException();
                    reply.writeInt(result2);
                    return true;
                case 211:
                    data.enforceInterface(DESCRIPTOR);
                    result2 = odeNativeTest(data.readString());
                    reply.writeNoException();
                    reply.writeInt(result2);
                    return true;
                case 212:
                    data.enforceInterface(DESCRIPTOR);
                    result2 = getCCmodeForCryptKeeper();
                    reply.writeNoException();
                    reply.writeInt(result2);
                    return true;
                case 213:
                    data.enforceInterface(DESCRIPTOR);
                    result2 = getCurrentEncryptionFailCount();
                    reply.writeNoException();
                    reply.writeInt(result2);
                    return true;
    ...
    int changeEncryptionPassword2(String str, String str2) throws RemoteException;

    void clearPassword() throws RemoteException;

    void createNewUserDir(int i, String str) throws RemoteException;

    int createSecureContainer(String str, int i, String str2, String str3, int i2, boolean z) throws RemoteException;

    int cryptoMount(String str, String str2) throws RemoteException;

    int decryptStorage(String str) throws RemoteException;

    void deleteUserKey(int i) throws RemoteException;

    int destroySecureContainer(String str, boolean z) throws RemoteException;

    int disableStorageEncryption(int i, String str) throws RemoteException;
    ...
    int getCCmodeForCryptKeeper() throws RemoteException;

    int getCurrentEncryptionFailCount() throws RemoteException;
    ...
    String getPropertyFromFooter(String str) throws RemoteException;
    ...
    int isEncryptedWithForceEncrypt() throws RemoteException;
    ...
    int isStorageFullyEncrypted() throws RemoteException;
    ...
    int moveDumpstates() throws RemoteException;

    int odeNativeTest(String str) throws RemoteException;
    ...
    int prepareDecryptOnRecovery(int i, String str) throws RemoteException;
    ...
    int setNullSDCardPassword(String str) throws RemoteException;

    void setPrimaryStorageUuid(String str, IPackageMoveObserver iPackageMoveObserver) throws RemoteException;

    int setPropertyIntoFooter(String str, String str2) throws RemoteException;
    ...
    void setVolumeState(String str, String str2) throws RemoteException;
