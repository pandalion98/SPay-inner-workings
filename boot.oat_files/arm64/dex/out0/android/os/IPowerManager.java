...
public interface IPowerManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPowerManager {
        ...
        static final int TRANSACTION_boostScreenBrightness = 20;
        static final int TRANSACTION_crash = 18;
        static final int TRANSACTION_getCurrentBrightness = 29;
        static final int TRANSACTION_getMultipleScreenState = 45;
        static final int TRANSACTION_goToSleep = 10;
        static final int TRANSACTION_isAlpmMode = 38;
        static final int TRANSACTION_isDeviceIdleMode = 15;
        static final int TRANSACTION_isForceUnblankDisplay = 36;
        static final int TRANSACTION_isInteractive = 12;
        static final int TRANSACTION_isPowerSaveMode = 13;
        static final int TRANSACTION_isScreenBrightnessBoosted = 21;
        ...
        static final int TRANSACTION_setAlpmMode = 37;
        static final int TRANSACTION_setAttentionLight = 24;
        static final int TRANSACTION_setAutoBrightnessForEbookOnly = 31;
        static final int TRANSACTION_setAutoBrightnessLimit = 25;
        static final int TRANSACTION_setButtonBrightnessLimit = 34;
        static final int TRANSACTION_setClearViewBrightnessMode = 26;
        static final int TRANSACTION_setColorWeaknessMode = 27;
        static final int TRANSACTION_setCoverType = 39;
        static final int TRANSACTION_setDozeOverrideFromAod = 42;
        static final int TRANSACTION_setForceUnblankDisplay = 35;
        static final int TRANSACTION_setHallstateForMultipleScreen = 44;
        static final int TRANSACTION_setKeyboardVisibility = 30;
        static final int TRANSACTION_setMasterBrightnessLimit = 28;
        static final int TRANSACTION_setMultipleScreenStateOverride = 47;
        static final int TRANSACTION_setPowerSaveMode = 14;
        static final int TRANSACTION_setStayOnSetting = 19;
        static final int TRANSACTION_setSubScreenState = 46;
        static final int TRANSACTION_setTemporaryMarkerScreenBrightnessSettingOverride = 43;
        static final int TRANSACTION_setTemporaryScreenAutoBrightnessAdjustmentSettingOverride = 23;
        static final int TRANSACTION_setTemporaryScreenBrightnessSettingOverride = 22;
        static final int TRANSACTION_shutdown = 17;
        static final int TRANSACTION_switchForceLcdBacklightOffState = 33;
        static final int TRANSACTION_systemShutdown = 40;
        static final int TRANSACTION_updateCoverState = 32;
        ...
        static final int TRANSACTION_wakeUpWithReason = 41;
        ...
        private static class Proxy implements IPowerManager {
            ...
            public void setAutoBrightnessLimit(int lowerLimit, int upperLimit) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setClearViewBrightnessMode(boolean enable, int delayAfterRelease, IBinder binder) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeInt(i);
                    _data.writeInt(delayAfterRelease);
            ...
            public void setColorWeaknessMode(boolean enable, IBinder binder) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void setMasterBrightnessLimit(int reserved, int upperLimit) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setAutoBrightnessForEbookOnly(boolean enabled) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void setButtonBrightnessLimit(int brightness) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setForceUnblankDisplay(boolean unblank) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public boolean isForceUnblankDisplay() throws RemoteException {
                boolean _result = false;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void setAlpmMode(int mode, int startLine, int endLine, IBinder binder) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(mode);
                    _data.writeInt(startLine);
                    _data.writeInt(endLine);
                    _data.writeStrongBinder(binder);
            ...
            public boolean isAlpmMode() throws RemoteException {
                boolean _result = false;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void wakeUpWithReason(long time, int reason) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setDozeOverrideFromAod(int mode, int screenState, int screenBrightness, IBinder binder) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setTemporaryMarkerScreenBrightnessSettingOverride(int brightness) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setHallstateForMultipleScreen(int state) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int getMultipleScreenState() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setSubScreenState(boolean on) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void setMultipleScreenStateOverride(int state, int reason) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    setAutoBrightnessLimit(data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                    setClearViewBrightnessMode(data.readInt() != 0, data.readInt(), data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                    setColorWeaknessMode(data.readInt() != 0, data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 28:
                    data.enforceInterface(DESCRIPTOR);
                    setMasterBrightnessLimit(data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 29:
                    data.enforceInterface(DESCRIPTOR);
                    float _result2 = getCurrentBrightness(data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeFloat(_result2);
                    return true;
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                    setKeyboardVisibility(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                    setAutoBrightnessForEbookOnly(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                    updateCoverState(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 33:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    setButtonBrightnessLimit(data.readInt());
                    reply.writeNoException();
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    setForceUnblankDisplay(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isForceUnblankDisplay();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 37:
                    data.enforceInterface(DESCRIPTOR);
                    setAlpmMode(data.readInt(), data.readInt(), data.readInt(), data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 38:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 41:
                    data.enforceInterface(DESCRIPTOR);
                    wakeUpWithReason(data.readLong(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 42:
                    data.enforceInterface(DESCRIPTOR);
                    setDozeOverrideFromAod(data.readInt(), data.readInt(), data.readInt(), data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    setTemporaryMarkerScreenBrightnessSettingOverride(data.readInt());
                    reply.writeNoException();
                    return true;
                case 44:
                    data.enforceInterface(DESCRIPTOR);
                    setHallstateForMultipleScreen(data.readInt());
                    reply.writeNoException();
                    return true;
                case 45:
                    data.enforceInterface(DESCRIPTOR);
                    int _result3 = getMultipleScreenState();
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 46:
                    data.enforceInterface(DESCRIPTOR);
                    setSubScreenState(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 47:
                    data.enforceInterface(DESCRIPTOR);
                    setMultipleScreenStateOverride(data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
    ...
    int getMultipleScreenState() throws RemoteException;

    void goToSleep(long j, int i, int i2) throws RemoteException;

    boolean isAlpmMode() throws RemoteException;

    boolean isDeviceIdleMode() throws RemoteException;

    boolean isForceUnblankDisplay() throws RemoteException;
    ...
    void setAlpmMode(int i, int i2, int i3, IBinder iBinder) throws RemoteException;

    void setAttentionLight(boolean z, int i) throws RemoteException;

    void setAutoBrightnessForEbookOnly(boolean z) throws RemoteException;

    void setAutoBrightnessLimit(int i, int i2) throws RemoteException;

    void setButtonBrightnessLimit(int i) throws RemoteException;

    void setClearViewBrightnessMode(boolean z, int i, IBinder iBinder) throws RemoteException;

    void setColorWeaknessMode(boolean z, IBinder iBinder) throws RemoteException;

    void setCoverType(int i) throws RemoteException;

    void setDozeOverrideFromAod(int i, int i2, int i3, IBinder iBinder) throws RemoteException;

    void setForceUnblankDisplay(boolean z) throws RemoteException;

    void setHallstateForMultipleScreen(int i) throws RemoteException;

    void setKeyboardVisibility(boolean z) throws RemoteException;

    void setMasterBrightnessLimit(int i, int i2) throws RemoteException;

    void setMultipleScreenStateOverride(int i, int i2) throws RemoteException;

    boolean setPowerSaveMode(boolean z) throws RemoteException;

    void setStayOnSetting(int i) throws RemoteException;

    void setSubScreenState(boolean z) throws RemoteException;

    void setTemporaryMarkerScreenBrightnessSettingOverride(int i) throws RemoteException;
    ...
    void systemShutdown() throws RemoteException;
    ...
    void wakeUpWithReason(long j, int i) throws RemoteException;
}
