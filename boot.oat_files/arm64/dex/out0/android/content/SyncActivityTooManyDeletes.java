...
public class SyncActivityTooManyDeletes extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter adapter = new ArrayAdapter(this, R.layout.simple_list_item_1, R.id.text1, new CharSequence[]{getResources().getText(17040492), getResources().getText(17040493), getResources().getText(17040494)});
        ListView listView = new ListView(this);
        listView.setAdapter(adapter);
        listView.setItemsCanFocus(true);
        listView.setOnItemClickListener(this);
        TextView textView = new TextView(this);
        textView.setText(String.format(getResources().getText(17040491).toString(), new Object[]{Long.valueOf(this.mNumDeletes), this.mProvider, this.mAccount.name}));
