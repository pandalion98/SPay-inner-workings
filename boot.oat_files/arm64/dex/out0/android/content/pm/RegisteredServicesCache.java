...
public abstract class RegisteredServicesCache<V> {
                ...
                if (user != null) {
                    ...
                    if (file.getBaseFile().exists()) {
                        ...
                        try {
                            ...
                            readPersistentServicesLocked(inputStream);
                        } catch (Exception e) {
    ...
    protected List<ResolveInfo> queryIntentServices(int userId) {
        return this.mContext.getPackageManager().queryIntentServicesAsUser(new Intent(this.mInterfaceName), 128, userId);
    }
    ...
    private void generateServicesMap(int[] changedUids, int userId) {
        ...
        synchronized (this.mServicesLock) {
            ...
            for (V v1 : user.persistentServices.keySet()) {
                V v12;
                if (!containsType(serviceInfos, v12) && containsUid(changedUids, ((Integer) user.persistentServices.get(v12)).intValue())) {
                    toBeRemoved.add(v12);
                }
            }
