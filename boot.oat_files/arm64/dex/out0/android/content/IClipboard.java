...
public interface IClipboard extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IClipboard {
        ...
        static final int TRANSACTION_isSEContainerAndIsolated = 8;
        ...
        private static class Proxy implements IClipboard {
            ...
            public boolean isSEContainerAndIsolated(String packageName) throws RemoteException {
                boolean _result = false;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isSEContainerAndIsolated(data.readString());
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
    ...
    boolean isSEContainerAndIsolated(String str) throws RemoteException;
