...
public interface ISyncCallBack extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISyncCallBack {
        private static final String DESCRIPTOR = "android.content.ISyncCallBack";
        ...
        private static class Proxy implements ISyncCallBack {
            ...
            public void doSync(String mSyncerName, int mUserId) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    doSync(data.readString(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    deletePersonaData(data.readInt());
                    reply.writeNoException();
                    return true;
