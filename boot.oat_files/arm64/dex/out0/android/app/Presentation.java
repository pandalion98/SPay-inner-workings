...
public class Presentation extends Dialog {
    ...
    protected void onStart() {
        ...
        Intent virtualKey_Intent = new Intent("com.samsung.intent.action.SEC_PRESENTATION_START");
        virtualKey_Intent.putExtra(Directory.DISPLAY_NAME, this.mDisplay.getName().hashCode());
        virtualKey_Intent.putExtra("displayID", this.mDisplay.getDisplayId());
        this.mContext.sendBroadcast(virtualKey_Intent);
    ...
    protected void onStop() {
        Intent virtualKey_Intent = new Intent("com.samsung.intent.action.SEC_PRESENTATION_STOP");
        virtualKey_Intent.putExtra(Directory.DISPLAY_NAME, this.mDisplay.getName().hashCode());
        virtualKey_Intent.putExtra("displayID", -1);
        this.mContext.sendBroadcast(virtualKey_Intent);
