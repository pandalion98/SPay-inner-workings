...
class ApplicationThreadProxy implements IApplicationThread {
    ...
    public final void forceCallResumeActivity(IBinder token) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeStrongBinder(token);
        this.mRemote.transact(IApplicationThread.FORCE_RESUME_ACTIVITY_TRANSACTION, data, null, 1);
        data.recycle();
    }
    ...
    public final void scheduleLaunchActivity(Intent intent, IBinder token, int ident, ActivityInfo info, Configuration curConfig, Configuration overrideConfig, CompatibilityInfo compatInfo, String referrer, IVoiceInteractor voiceInteractor, int procState, Bundle state, PersistableBundle persistentState, List<ResultInfo> pendingResults, List<ReferrerIntent> pendingNewIntents, boolean notResumed, boolean isForward, ProfilerInfo profilerInfo, MultiWindowStyle multiWindowStyle, int displayId) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        ...
        multiWindowStyle.writeToParcel(data, 0);
        data.writeInt(displayId);
        this.mRemote.transact(7, data, null, 1);
        data.recycle();
    }

    public final void scheduleRelaunchActivity(IBinder token, List<ResultInfo> pendingResults, List<ReferrerIntent> pendingNewIntents, int configChanges, boolean notResumed, Configuration config, Configuration overrideConfig, MultiWindowStyle multiWindowStyle, int displayId) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeStrongBinder(token);
        data.writeTypedList(pendingResults);
    ...
    public final void updateOverlayPath(String path, String packageName, int isDisable) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeString(path);
        data.writeString(packageName);
        data.writeInt(isDisable);
        this.mRemote.transact(2001, data, null, 1);
        data.recycle();
    }
    ...
    public final void scheduleCreateService(IBinder token, ServiceInfo info, CompatibilityInfo compatInfo, int processState, int displayId, IBinder callerActivityToken) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeStrongBinder(token);
        info.writeToParcel(data, 0);
        ...
        this.mRemote.transact(IApplicationThread.SCHEDULE_CREATE_SERVICE_FOR_DUAL_SCREEN_TRANSACTION, data, null, 1);
        data.recycle();
    }
    ...
    public final void bindApplication(String packageName, ApplicationInfo info, List<ProviderInfo> providers, ComponentName testName, ProfilerInfo profilerInfo, Bundle testArgs, IInstrumentationWatcher testWatcher, IUiAutomationConnection uiAutomationConnection, int debugMode, boolean openGlTrace, boolean restrictedBackupMode, boolean persistent, UnRestrictedArrayList<Configuration> configs, CompatibilityInfo compatInfo, Map<String, IBinder> services, Bundle coreSettings, int displayId) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeString(packageName);
        info.writeToParcel(data, 0);
        ...
        ((Configuration) configs.get(0)).writeToParcel(data, 0);
        compatInfo.writeToParcel(data, 0);
    ...
    public void setHttpProxy(String proxy, String port, String username, String password, String exclList, Uri pacFileUrl) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeString(proxy);
        data.writeString(port);
        ...
        data.writeString(exclList);
        pacFileUrl.writeToParcel(data, 0);
        this.mRemote.transact(1501, data, null, 1);
        data.recycle();
    }
    ...
    public void setHttpProxy(ProxyInfo proxyInfo) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        proxyInfo.writeToParcel(data, 0);
        this.mRemote.transact(3010, data, null, 1);
        data.recycle();
    }
    ...
    public final void scheduleActivityConfigurationChanged(IBinder token, Configuration overrideConfig) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeStrongBinder(token);
        if (overrideConfig != null) {
    ...
    public void scheduleMultiWindowStyleChanged(IBinder activityToken, MultiWindowStyle style, int notifyReason) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeStrongBinder(activityToken);
        style.writeToParcel(data, 0);
        data.writeInt(notifyReason);
        this.mRemote.transact(1001, data, null, 1);
        data.recycle();
    }

    public void scheduleMultiWindowFocusChanged(IBinder activityToken, int notifyReason, boolean focus, boolean keepInputMethod) throws RemoteException {
        int i;
        int i2 = 0;
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        ...
        data.writeInt(i2);
        this.mRemote.transact(1002, data, null, 1);
        data.recycle();
    }

    public void scheduleMultiWindowExitByCloseBtn(IBinder activityToken) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeStrongBinder(activityToken);
        this.mRemote.transact(1003, data, null, 1);
        data.recycle();
    }

    public void scheduleActivityDisplayIdChanged(IBinder token, int displayId) throws RemoteException {
    }

    public void dumpContextRelationInfo(FileDescriptor fd, String prefix, String[] args) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeFileDescriptor(fd);
        data.writeString(prefix);
        data.writeStringArray(args);
        this.mRemote.transact(IApplicationThread.DUMP_CONTEXT_RELATION_INFO_TRANSACTION, data, null, 1);
        data.recycle();
    }

    public final void scheduleConfigurationsChanged(UnRestrictedArrayList<Configuration> configs) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        ...
        this.mRemote.transact(IApplicationThread.SCHEDULE_CONFIGURATIONS_CHANGED_TRANSACTION, data, null, 1);
        data.recycle();
    }

    public void scheduleApplicationDisplayIdChanged(int displayId) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeInt(displayId);
        this.mRemote.transact(IApplicationThread.SCHEDULE_APPLICATION_DISPLAY_ID_CHANGED_TRANSACTION, data, null, 1);
        data.recycle();
    }

    public void setShrinkRequestedState(boolean shrinkRequested) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeInt(shrinkRequested ? 1 : 0);
        this.mRemote.transact(IApplicationThread.SET_SHRINK_REQUESTED_STATE, data, null, 1);
        data.recycle();
    }

    public void scheduleSendShrinkRequest(IBinder token, int targetDisplayId, int notifyReason) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeStrongBinder(token);
        data.writeInt(targetDisplayId);
        data.writeInt(notifyReason);
        this.mRemote.transact(3008, data, null, 1);
        data.recycle();
    }

    public void scheduleSendExpandRequest(IBinder token, int notifyReason) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeStrongBinder(token);
        data.writeInt(notifyReason);
        this.mRemote.transact(3009, data, null, 1);
        data.recycle();
    }
    ...
    public void dumpMemInfo(FileDescriptor fd, MemoryInfo mem, boolean checkin, boolean dumpInfo, boolean dumpDalvik, boolean dumpSummaryOnly, String[] args) throws RemoteException {
        int i;
        int i2 = 1;
        Parcel data = Parcel.obtain();
    ...
    public void scheduleResetTargetHeapUtilization(IBinder activityToken, String currentComponentName) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeStrongBinder(activityToken);
        data.writeString(currentComponentName);
        this.mRemote.transact(2000, data, null, 1);
        data.recycle();
    }
    ...
    public final void scheduleDisplayMetricsChanged(DisplayInfo dInfo) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        dInfo.writeToParcel(data, 0);
        this.mRemote.transact(IApplicationThread.SCHEDULE_DISPLAYMETRICS_CHANGED_TRANSACTION, data, null, 1);
        data.recycle();
    }
}
