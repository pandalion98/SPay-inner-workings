...
public interface IWallpaperManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWallpaperManager {
        ...
        static final int TRANSACTION_getWallpaperForMultiSim = 6;
        ...
        static final int TRANSACTION_setWallpaperForMultiSim = 4;
        ...
        private static class Proxy implements IWallpaperManager {
            ...
            public ParcelFileDescriptor setWallpaper(String name, String callingPackage) throws RemoteException {
            ...
            public ParcelFileDescriptor setWallpaperForMultiSim(String name, int simSlot) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ParcelFileDescriptor _result;
            ...
            public ParcelFileDescriptor getWallpaperForMultiSim(IWallpaperManagerCallback cb, Bundle outParams, int simSlot) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ParcelFileDescriptor _result;
            ...
            public void clearWallpaper(String callingPackage) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            ParcelFileDescriptor _result;
            ComponentName _arg0;
            IWallpaperManagerCallback _arg02;
            Bundle _arg1;
            boolean _result2;
            int _result3;
            switch (code) {
                case 1:
                    ...
                    _result = setWallpaper(data.readString(), data.readString());
                ...
                case 2:
                    ...
                    setWallpaperComponentChecked(_arg0, data.readString());
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setWallpaperForMultiSim(data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = android.app.IWallpaperManagerCallback.Stub.asInterface(data.readStrongBinder());
                    _arg1 = new Bundle();
                ...
                case 6:
                    ...
                    _arg02 = android.app.IWallpaperManagerCallback.Stub.asInterface(data.readStrongBinder());
                    _arg1 = new Bundle();
                    _result = getWallpaperForMultiSim(_arg02, _arg1, data.readInt());
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    clearWallpaper(data.readString());
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void clearWallpaper(String str) throws RemoteException;
    ...
    ParcelFileDescriptor getWallpaperForMultiSim(IWallpaperManagerCallback iWallpaperManagerCallback, Bundle bundle, int i) throws RemoteException;
    ...
    ParcelFileDescriptor setWallpaper(String str, String str2) throws RemoteException;
    ...
    ParcelFileDescriptor setWallpaperForMultiSim(String str, int i) throws RemoteException;
