...
public final class UsageStatsManager {
    ...
    public List<UsageStats> queryUsageStatsForUser(int userId, int intervalType, long beginTime, long endTime) {
        try {
            ParceledListSlice<UsageStats> slice = this.mService.queryUsageStatsForUser(userId, intervalType, beginTime, endTime, this.mContext.getOpPackageName());
            if (slice != null) {
                return slice.getList();
            }
        } catch (RemoteException e) {
    ...
    public Map<String, UsageStats> queryAndAggregateUsageStats(long beginTime, long endTime) {
        ...
        Map<String, UsageStats> aggregatedStats = new ArrayMap();
    ...
    public void registerUsageStatsWatcher(IUsageStatsWatcher watcher) {
        try {
            this.mService.registerUsageStatsWatcher(watcher);
        } catch (RemoteException e) {
        }
    }
    ...
    public void unregisterUsageStatsWatcher(IUsageStatsWatcher watcher) {
        try {
            this.mService.unregisterUsageStatsWatcher(watcher);
        } catch (RemoteException e) {
        }
    }
}
