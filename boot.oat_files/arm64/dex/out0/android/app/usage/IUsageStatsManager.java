...
public interface IUsageStatsManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUsageStatsManager {
        ...
        static final int TRANSACTION_isAppInactive = 6;
        ...
        static final int TRANSACTION_queryUsageStatsForUser = 2;
        static final int TRANSACTION_registerUsageStatsWatcher = 8;
        static final int TRANSACTION_setAppInactive = 5;
        static final int TRANSACTION_unregisterUsageStatsWatcher = 9;
        static final int TRANSACTION_whitelistAppTemporarily = 7;
        ...
        private static class Proxy implements IUsageStatsManager {
            ...
            public ParceledListSlice queryUsageStatsForUser(int userId, int bucketType, long beginTime, long endTime, String callingPackage) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ParceledListSlice _result;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    _result = queryUsageStatsForUser(data.readInt(), data.readInt(), data.readLong(), data.readLong(), data.readString());
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    registerUsageStatsWatcher(android.app.usage.IUsageStatsWatcher.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    unregisterUsageStatsWatcher(android.app.usage.IUsageStatsWatcher.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
    ...
    ParceledListSlice queryUsageStatsForUser(int i, int i2, long j, long j2, String str) throws RemoteException;
