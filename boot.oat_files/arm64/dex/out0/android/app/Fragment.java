...
public class Fragment implements ComponentCallbacks2, OnCreateContextMenuListener {
    ...
    private class FeatureContextMenuListener implements OnCreateContextMenuListener {
        ...
        public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfo) {
            Fragment.this.onCreateContextMenu(menu, view, menuInfo);
            if (Fragment.this.mInjectionManager != null) {
                Fragment.this.mInjectionManager.dispatchCreateContextMenu(Fragment.this, menu, view, menuInfo, true);
            }
        }
    }
    ...
    void performCreate(Bundle savedInstanceState) {
        ...
        if (this.mInjectionManager != null) {
            this.mInjectionManager.dispatchParentCallToFeature(DispatchParentCall.ONCREATE, this, savedInstanceState, true);
        }
        if ((this instanceof PreferenceFragment) && this.mInjectionManager != null) {
            this.mInjectionManager.dispatchPreferences((PreferenceFragment) this);
        }
        if (!this.mCalled) {
    ...
    void performConfigurationChanged(Configuration newConfig) {
        if (InjectionManager.getInstance() != null) {
            InjectionManager.getInstance().dispatchParentCallToFeature(DispatchParentCall.ONCONFIGURATIONCHANGED, (Object) this, newConfig);
        }
    ...
    boolean performCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (this.mHasMenu && this.mMenuVisible) {
            ...
            if (this.mInjectionManager != null) {
                this.mInjectionManager.dispatchCreateOptionsMenu(this, menu, inflater, true);
            }
        }
        if (this.mChildFragmentManager != null) {
    ...
    boolean performPrepareOptionsMenu(Menu menu) {
        ...
        if (this.mHasMenu && this.mMenuVisible) {
            ...
            if (this.mInjectionManager != null) {
                this.mInjectionManager.dispatchPrepareOptionsMenu(this, menu);
            }
        }
        if (this.mChildFragmentManager != null) {
    ...
    boolean performOptionsItemSelected(MenuItem item) {
        if (!this.mHidden) {
            if (this.mHasMenu && this.mMenuVisible && ((this.mInjectionManager != null && this.mInjectionManager.dispatchOptionsItemSelected(this, item)) || onOptionsItemSelected(item))) {
                return true;
            }
    ...
    boolean performContextItemSelected(MenuItem item) {
        if (!this.mHidden) {
            if ((this.mInjectionManager != null && this.mInjectionManager.dispatchContextItemSelected(this, item)) || onContextItemSelected(item)) {
                return true;
            }
    ...
    void performSaveInstanceState(Bundle outState) {
        if (this.mInjectionManager != null) {
            this.mInjectionManager.dispatchParentCallToFeature(DispatchParentCall.ONSAVEINSTANCESTATE, this, outState, true);
        }
