...
public class SystemUpdatePolicy implements Parcelable {
    ...
    public boolean isValid() {
        ...
        if (this.mMaintenanceWindowStart < 0 || this.mMaintenanceWindowStart >= WINDOW_BOUNDARY || this.mMaintenanceWindowEnd < 0 || this.mMaintenanceWindowEnd >= WINDOW_BOUNDARY) {
            return false;
        }
        return true;
    }
