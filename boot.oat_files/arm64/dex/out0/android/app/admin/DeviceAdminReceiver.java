...
public class DeviceAdminReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_READY_FOR_USER_INITIALIZATION = "android.app.action.READY_FOR_USER_INITIALIZATION";
    public static final String ACTION_RECOVERY_PASSWORD_REQUESTED = "android.app.action.ACTION_RECOVERY_PASSWORD_REQUESTED";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (ACTION_RECOVERY_PASSWORD_REQUESTED.equals(action)) {
            onRecoveryPasswordRequested(context, intent);
