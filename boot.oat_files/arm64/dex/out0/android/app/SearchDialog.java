...
public class SearchDialog extends Dialog {
    ...
    private void createContentView() {
        setContentView(17367279);
        this.mSearchView = (SearchView) findViewById(16909433);
        ...
        this.mBadgeLabel = (TextView) this.mSearchView.findViewById(16909435);
        this.mSearchAutoComplete = (AutoCompleteTextView) this.mSearchView.findViewById(16909440);
        this.mAppIcon = (ImageView) findViewById(16909432);
        this.mSearchPlate = this.mSearchView.findViewById(16909439);
        this.mWorkingSpinner = getContext().getDrawable(17303293);
        setWorking(false);
