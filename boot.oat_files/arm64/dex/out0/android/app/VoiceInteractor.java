...
public final class VoiceInteractor {
    ...
    public android.app.VoiceInteractor.Request getActiveRequest(java.lang.String r6) {
        /*
        r5 = this;
        r4 = r5.mActiveRequests;
        monitor-enter(r4);
        r3 = r5.mActiveRequests;	 Catch:{ all -> 0x002e }
        r0 = r3.size();	 Catch:{ all -> 0x002e }
        r1 = 0;
    L_0x000a:
        if (r1 >= r0) goto L_0x002b;
    L_0x000c:
        r3 = r5.mActiveRequests;	 Catch:{ all -> 0x002e }
        r2 = r3.valueAt(r1);	 Catch:{ all -> 0x002e }
        r2 = (android.app.VoiceInteractor.Request) r2;	 Catch:{ all -> 0x002e }
        r3 = r2.getName();	 Catch:{ all -> 0x002e }
        if (r6 == r3) goto L_0x0026;
    L_0x001a:
        if (r6 == 0) goto L_0x0028;
    L_0x001c:
        r3 = r2.getName();	 Catch:{ all -> 0x002e }
        r3 = r6.equals(r3);	 Catch:{ all -> 0x002e }
