...
public interface IBackupAgent extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBackupAgent {
        ...
        static final int TRANSACTION_doRestoreFile = 5;
        static final int TRANSACTION_doRestoreFinished = 6;
        static final int TRANSACTION_fail = 7;
        static final int TRANSACTION_getBackupDataSize = 8;
        ...
        private static class Proxy implements IBackupAgent {
            ...
            public long getBackupDataSize() throws RemoteException {
                Parcel _data = Parcel.obtain();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    doBackup(_arg0, _arg1, _arg2, data.readInt(), android.app.backup.IBackupManager.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 3:
                    ...
                    doFullBackup(_arg0, data.readInt(), android.app.backup.IBackupManager.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 5:
                    ...
                    doRestoreFile(_arg0, _arg13, _arg22, _arg3, data.readString(), data.readLong(), data.readLong(), data.readInt(), android.app.backup.IBackupManager.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    long _result = getBackupDataSize();
    ...
    long getBackupDataSize() throws RemoteException;
}
