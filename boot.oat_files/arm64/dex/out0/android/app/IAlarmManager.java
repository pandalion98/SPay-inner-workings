...
public interface IAlarmManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAlarmManager {
        ...
        static final int TRANSACTION_setAutoPowerUp = 6;
        static final int TRANSACTION_setTime = 2;
        static final int TRANSACTION_setTimeZone = 3;
        static final int TRANSACTION_updateBlockedUids = 8;
        ...
        private static class Proxy implements IAlarmManager {
            ...
            public void set(int type, long triggerAtTime, long windowLength, long interval, int flags, PendingIntent operation, WorkSource workSource, AlarmClockInfo alarmClock) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    if (data.readInt() != 0) {
                        _arg6 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        _arg6 = null;
                    }
                    if (data.readInt() != 0) {
                        _arg7 = (AlarmClockInfo) AlarmClockInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg7 = null;
                    }
                    set(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7);
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    setAutoPowerUp(data.readString());
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void set(int i, long j, long j2, long j3, int i2, PendingIntent pendingIntent, WorkSource workSource, AlarmClockInfo alarmClockInfo) throws RemoteException;
