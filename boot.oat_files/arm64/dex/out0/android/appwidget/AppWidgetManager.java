...
public class AppWidgetManager {
    ...
    public static final String EXTRA_SECRET_MODE = "secretMode";
    ...
    public List<AppWidgetProviderInfo> getInstalledProvidersForProfile(int categoryFilter, UserHandle profile) {
        ...
        try {
            ...
            if (Build.IS_SYSTEM_SECURE && providers == null) {
            }
    ...
    public AppWidgetProviderInfo getSecretAppWidgetInfo(int appWidgetId) {
        return null;
    }
}
