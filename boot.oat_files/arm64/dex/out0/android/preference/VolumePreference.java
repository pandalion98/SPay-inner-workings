...
public class VolumePreference extends SeekBarDialogPreference implements OnActivityStopListener, OnKeyListener, Callback {
    ...
    public void setStreamType(int streamType) {
        Log.d(TAG, "setSteamType : " + streamType);
    ...
    protected void onBindDialogView(View view) {
        ...
        Log.d(TAG, "onBindDialogView : mStreamType : " + this.mStreamType);
    ...
    private void cleanup() {
        ...
        if (this.mSeekBarVolumizer != null) {
            ...
            if (dialog != null && dialog.isShowing()) {
                View view = dialog.getWindow().getDecorView().findViewById(16909390);
                if (view != null) {
