...
public abstract class DialogPreference extends Preference implements OnClickListener, OnDismissListener, OnActivityDestroyListener {
    ...
    public DialogPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (this.mDialogTitle == null) {
            ...
            context.getResources().addPreferenceString(this.mDialogTitle, a.getResourceId(0, 0));
        }
        ...
        if (Build.IS_SYSTEM_SECURE) {
            ...
            res.addPreferenceString(this.mDialogMessage, a.getResourceId(1, 0));
            res.addPreferenceString(this.mPositiveButtonText, a.getResourceId(3, 0));
            res.addPreferenceString(this.mNegativeButtonText, a.getResourceId(4, 0));
        }
        a.recycle();
    }
