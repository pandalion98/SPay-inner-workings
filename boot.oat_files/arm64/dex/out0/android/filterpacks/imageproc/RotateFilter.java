...
public class RotateFilter extends Filter {
    ...
    private void updateParameters() {
        if (this.mAngle % 90 == 0) {
            ...
            ((ShaderProgram) this.mProgram).setTargetRegion(new Quad(new Point((((-cosTheta) + sinTheta) + 1.0f) * 0.5f, (((-sinTheta) - cosTheta) + 1.0f) * 0.5f), new Point(((cosTheta + sinTheta) + 1.0f) * 0.5f, ((sinTheta - cosTheta) + 1.0f) * 0.5f), new Point((((-cosTheta) - sinTheta) + 1.0f) * 0.5f, (((-sinTheta) + cosTheta) + 1.0f) * 0.5f), new Point(((cosTheta - sinTheta) + 1.0f) * 0.5f, (1.0f + (sinTheta + cosTheta)) * 0.5f)));
            return;
        }
