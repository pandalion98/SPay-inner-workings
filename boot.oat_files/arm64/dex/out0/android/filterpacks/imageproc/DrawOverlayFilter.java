...
public class DrawOverlayFilter extends Filter {
    ...
    public void setupPorts() {
        ...
        addMaskedInputPort(PersonaManager.INTENT_EXTRA_SOURCE, imageFormatMask);
        addMaskedInputPort("overlay", imageFormatMask);
        addMaskedInputPort("box", ObjectFormat.fromClass(Quad.class, 1));
        addOutputBasedOnInput("image", PersonaManager.INTENT_EXTRA_SOURCE);
    }
    ...
    public void process(FilterContext env) {
        Frame sourceFrame = pullInput(PersonaManager.INTENT_EXTRA_SOURCE);
