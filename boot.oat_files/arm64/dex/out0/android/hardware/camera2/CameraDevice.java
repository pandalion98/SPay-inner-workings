...
public abstract class CameraDevice implements AutoCloseable {
    ...
    public abstract void createCaptureSessionByOutputConfiguration(List<OutputConfiguration> list, android.hardware.camera2.CameraCaptureSession.StateCallback stateCallback, Handler handler) throws CameraAccessException;
