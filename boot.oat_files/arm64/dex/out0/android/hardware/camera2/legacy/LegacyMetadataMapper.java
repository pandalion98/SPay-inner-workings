...
public class LegacyMetadataMapper {
    ...
    private static void mapControlAe(CameraMetadataNative m, Parameters p) {
        ...
        int i3 = 4;
        Object aeAvail = ArrayUtils.convertStringListToIntArray(p.getSupportedFlashModes(), new String[]{"off", "auto", "on", Parameters.FLASH_MODE_RED_EYE, Parameters.FLASH_MODE_TORCH}, new int[]{1, 2, 3, 4});
