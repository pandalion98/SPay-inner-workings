...
public class SurfaceTextureRenderer {
    ...
    private void configureEGLContext() {
        ...
        if (EGL14.eglInitialize(this.mEGLDisplay, version, 0, version, 1)) {
            ...
            int i = 0;
            EGL14.eglChooseConfig(this.mEGLDisplay, new int[]{EGL14.EGL_RED_SIZE, 8, EGL14.EGL_GREEN_SIZE, 8, EGL14.EGL_BLUE_SIZE, 8, EGL14.EGL_RENDERABLE_TYPE, 4, EGL_RECORDABLE_ANDROID, 1, EGL14.EGL_SURFACE_TYPE, 5, EGL14.EGL_NONE}, 0, configs, i, configs.length, new int[1], 0);
    ...
    public void configureSurfaces(Collection<Pair<Surface, Size>> surfaces) {
        ...
        makeCurrent(this.mSurfaces.size() > 0 ? ((EGLSurfaceHolder) this.mSurfaces.get(0)).eglSurface : ((EGLSurfaceHolder) this.mConversionSurfaces.get(0)).eglSurface);
        initializeGLState();
