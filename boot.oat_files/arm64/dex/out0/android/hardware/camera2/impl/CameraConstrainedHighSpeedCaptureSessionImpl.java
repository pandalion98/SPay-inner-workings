...
public class CameraConstrainedHighSpeedCaptureSessionImpl extends CameraConstrainedHighSpeedCaptureSession implements CameraCaptureSessionCore {
    ...
    CameraConstrainedHighSpeedCaptureSessionImpl(int id, List<Surface> outputs, StateCallback callback, Handler stateHandler, CameraDeviceImpl deviceImpl, Handler deviceStateHandler, boolean configureSuccess, CameraCharacteristics characteristics) {
        this.mCharacteristics = characteristics;
        this.mSessionImpl = new CameraCaptureSessionImpl(id, null, outputs, new WrapperCallback(callback), stateHandler, deviceImpl, deviceStateHandler, configureSuccess);
    }
