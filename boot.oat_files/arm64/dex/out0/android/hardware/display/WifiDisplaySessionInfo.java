...
public final class WifiDisplaySessionInfo implements Parcelable {
    ...
    public String toString() {
        return "WifiDisplaySessionInfo: Client/Owner: " + (this.mClient ? "Client" : "Owner") + " GroupId: " + this.mGroupId + " Passphrase: " + this.mPassphrase + " SessionId: " + this.mSessionId + " IP Address: " + this.mIP;
    }
}
