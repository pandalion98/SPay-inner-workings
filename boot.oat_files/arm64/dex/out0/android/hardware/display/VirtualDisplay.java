...
public final class VirtualDisplay {
    ...
    public void setMirroringDisplay(int displayId) {
        this.mGlobal.setVirtualDisplayMirroringDisplay(this.mToken, displayId);
    }

    public void setFixedOrientation(int orientation) {
        this.mGlobal.setVirtualDisplayFixedOrientation(this.mToken, orientation);
    }
