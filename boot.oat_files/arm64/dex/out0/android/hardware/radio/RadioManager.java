...
public class RadioManager {
    ...
    public static class BandConfig implements Parcelable {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.mDescriptor != ((BandConfig) obj).getDescriptor()) {
                return false;
            }
            return true;
        }
    ...
    public static class BandDescriptor implements Parcelable {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.mSpacing != other.getSpacing()) {
                return false;
            }
            return true;
        }
    ...
    public static class FmBandConfig extends BandConfig {
        ...
        FmBandConfig(int region, int type, int lowerLimit, int upperLimit, int spacing, boolean stereo, boolean rds, boolean ta, boolean af) {
            super(region, type, lowerLimit, upperLimit, spacing);
            this.mStereo = stereo;
            this.mRds = rds;
            this.mTa = ta;
    ...
    public static class FmBandDescriptor extends BandDescriptor {
        ...
        FmBandDescriptor(int region, int type, int lowerLimit, int upperLimit, int spacing, boolean stereo, boolean rds, boolean ta, boolean af) {
            super(region, type, lowerLimit, upperLimit, spacing);
            this.mStereo = stereo;
            this.mRds = rds;
            this.mTa = ta;
    ...
    public static class ProgramInfo implements Parcelable {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.mChannel != other.getChannel()) {
                return false;
            }
            if (this.mSubChannel != other.getSubChannel()) {
                return false;
            }
    ...
    public RadioTuner openTuner(int moduleId, BandConfig config, boolean withAudio, Callback callback, Handler handler) {
        ...
        RadioTuner module = new RadioModule(moduleId, config, withAudio, callback, handler);
