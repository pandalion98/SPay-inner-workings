...
public class HdmiDeviceInfo implements Parcelable {
    ...
    public String toString() {
        ...
        switch (this.mHdmiDeviceType) {
            ...
            case 1:
                s.append("MHL: ");
                s.append("device_id: ").append(String.format("0x%04X", new Object[]{Integer.valueOf(this.mDeviceId)})).append(" ");
                s.append("adopter_id: ").append(String.format("0x%04X", new Object[]{Integer.valueOf(this.mAdopterId)})).append(" ");
                break;
            case 2:
                s.append("Hardware: ");
                break;
