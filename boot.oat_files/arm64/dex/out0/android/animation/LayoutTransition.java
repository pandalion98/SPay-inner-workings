...
public class LayoutTransition {
    ...
    private void runAppearingTransition(final ViewGroup parent, final View child) {
        ...
        if (this.mAppearingAnim != null) {
            ...
            anim.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator anim) {
                    ...
                    if (LayoutTransition.this.hasListeners()) {
                        Iterator i$ = ((ArrayList) LayoutTransition.this.mListeners.clone()).iterator();
                        while (i$.hasNext()) {
                            ((TransitionListener) i$.next()).endTransition(LayoutTransition.this, parent, child, 2);
                        }
                    }
                }
            });
            ...
            while (i$.hasNext()) {
                ((TransitionListener) i$.next()).endTransition(this, parent, child, 2);
            }
        }
    }
    ...
    private void runDisappearingTransition(final ViewGroup parent, final View child) {
        ...
        if (this.mDisappearingAnim != null) {
            ...
            anim.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator anim) {
                    ...
                    if (LayoutTransition.this.hasListeners()) {
                        Iterator i$ = ((ArrayList) LayoutTransition.this.mListeners.clone()).iterator();
                        while (i$.hasNext()) {
                            ((TransitionListener) i$.next()).endTransition(LayoutTransition.this, parent, child, 3);
                        }
                    }
                }
            });
            ...
            Iterator i$ = ((ArrayList) this.mListeners.clone()).iterator();
            while (i$.hasNext()) {
                ((TransitionListener) i$.next()).endTransition(this, parent, child, 3);
            }
        }
    }
    ...
    private void addChild(ViewGroup parent, View child, boolean changesLayout) {
        if (parent.getWindowVisibility() == 0) {
            ...
            if (hasListeners() && (this.mTransitionTypes & 1) == 1) {
                Iterator i$ = ((ArrayList) this.mListeners.clone()).iterator();
                while (i$.hasNext()) {
                    ((TransitionListener) i$.next()).startTransition(this, parent, child, 2);
                }
            }
            if (changesLayout && (this.mTransitionTypes & 4) == 4) {
    ...
    private void removeChild(ViewGroup parent, View child, boolean changesLayout) {
        if (parent.getWindowVisibility() == 0) {
            ...
            if (hasListeners() && (this.mTransitionTypes & 2) == 2) {
                Iterator i$ = ((ArrayList) this.mListeners.clone()).iterator();
                while (i$.hasNext()) {
                    ((TransitionListener) i$.next()).startTransition(this, parent, child, 3);
                }
            }
            if (changesLayout && (this.mTransitionTypes & 8) == 8) {
