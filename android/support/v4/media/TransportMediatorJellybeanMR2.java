...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00171 implements OnWindowAttachListener {
        C00171() {
        }
    ...
    class C00182 implements OnWindowFocusChangeListener {
        C00182() {
        }
    ...
    class C00193 extends BroadcastReceiver {
        C00193() {
        }
    ...
    class C00204 implements OnAudioFocusChangeListener {
        C00204() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportMediatorCallback) {
        this.mWindowAttachListener = new C00171();
        this.mWindowFocusListener = new C00182();
        this.mMediaButtonReceiver = new C00193();
        this.mAudioFocusChangeListener = new C00204();
        this.mPlayState = 0;
