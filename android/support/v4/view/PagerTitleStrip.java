...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    public void setNonPrimaryAlpha(float f) {
        this.mNonPrimaryAlpha = ((int) (255.0f * f)) & GF2Field.MASK;
    ...
    void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        count = MeasureSpec.makeMeasureSpec((int) (((float) ((getWidth() - getPaddingLeft()) - getPaddingRight())) * 0.8f), PKIFailureInfo.systemUnavail);
        height = MeasureSpec.makeMeasureSpec(height, PKIFailureInfo.systemUnavail);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec((int) (((float) size) * 0.8f), PKIFailureInfo.systemUnavail);
        i3 = MeasureSpec.makeMeasureSpec(i3, PKIFailureInfo.systemUnavail);
        ...
        if (mode2 == PKIFailureInfo.systemFailure) {
