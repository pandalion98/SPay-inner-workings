...
public class FileProvider extends ContentProvider {
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) {
        ...
        XmlResourceParser loadXmlMetaData = context.getPackageManager().resolveContentProvider(str, X509KeyUsage.digitalSignature).loadXmlMetaData(context.getPackageManager(), META_DATA_FILE_PROVIDER_PATHS);
