...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
    ...
    static class C03051 implements TypeAdapterFactory {
        C03051() {
        }
    ...
    public Object read(JsonReader jsonReader) {
        switch (C03062.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
