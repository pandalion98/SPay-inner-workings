...
public class AndroidByteArrayFactory extends ByteArrayFactory {
    ...
    public ByteArray getByteArray(int i) {
        return new AndroidByteArray(i);
    }

    public ByteArray getByteArray(byte[] bArr, int i) {
        return new AndroidByteArray(bArr, i);
    }
    ...
    public ByteArray getFromWord(int i) {
        return new AndroidByteArray(ByteBuffer.allocate(2).putShort((short) i).array(), 2);
    }
    ...
    public ByteArray fromHexString(String str) {
        return new AndroidByteArray(str);
    }
    ...
    public ByteArray convertString(String str) {
        return new AndroidByteArray(str.getBytes(), str.length());
    }
