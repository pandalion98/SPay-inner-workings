...
public class HexUtil {
    ...
    /* renamed from: com.americanexpress.sdkmodulelib.tlv.HexUtil.1 */
    static class C00741 extends SecurityManager {
        C00741() {
        }
    ...
    public static Class getCallerClass(int i) {
        int i2 = 0;
        Class[] classContext = new C00741().getClassContext();
        if (classContext != null) {
            while (i2 < classContext.length) {
                if (classContext[i2] == HexUtil.class) {
            ...
            try {
                ...
                while (i2 < stackTrace.length) {
                    if (Class.forName(stackTrace[i2].getClassName()) == HexUtil.class) {
