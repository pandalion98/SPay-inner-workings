...
public class ServerResponseData implements Parcelable {
    public static final Creator<ServerResponseData> CREATOR;
    private String content;
    private ParcelFileDescriptor fd;

    /* renamed from: com.samsung.android.spayfw.appinterface.ServerResponseData.1 */
    static class C03891 implements Creator<ServerResponseData> {
        C03891() {
        }

        public ServerResponseData createFromParcel(Parcel parcel) {
            return new ServerResponseData(null);
        }

        public ServerResponseData[] newArray(int i) {
            return new ServerResponseData[i];
        }
    }
    ...
    L_0x00ad:
        ...
        goto L_0x002e;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.samsung.android.spayfw.appinterface.ServerResponseData.copyContentFromFd():void");
    }
