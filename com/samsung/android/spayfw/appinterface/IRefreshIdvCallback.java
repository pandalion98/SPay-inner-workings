...
public interface IRefreshIdvCallback extends IInterface {

    public static abstract class Stub extends Binder implements IRefreshIdvCallback {
        private static final String DESCRIPTOR = "com.samsung.android.spayfw.appinterface.IRefreshIdvCallback";
        static final int TRANSACTION_onFail = 2;
        static final int TRANSACTION_onSuccess = 1;

        private static class Proxy implements IRefreshIdvCallback {
        ...
        public static IRefreshIdvCallback asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IRefreshIdvCallback)) {
                return new Proxy(iBinder);
            }
            return (IRefreshIdvCallback) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case TRANSACTION_onSuccess /*1*/:
                    ...
                    onSuccess(parcel.readString(), parcel.createTypedArrayList(IdvMethod.CREATOR));
                    return true;
    ...
    void onSuccess(String str, List<IdvMethod> list);
}
