...
public final class McDbContract {
    ...
    public static abstract class CardMaster implements BaseColumns {
    ...
    public static abstract class CardProvisionData implements BaseColumns {
    ...
    public static abstract class Certificates implements BaseColumns {
    ...
    public static abstract class TdsMetaData implements BaseColumns {
