...
public class Fingerprint extends FingerprintCore {
    ...
    public static final int VCS_SNSR_TEST_ID_CPID_CALIBRATE_BACKGROUND_ID = 1006;
    public static final int VCS_SNSR_TEST_ID_CPID_CALIBRATE_COLL_DARK_SCRIPT_ID = 1014;
    public static final int VCS_SNSR_TEST_ID_CPID_CALIBRATE_COLL_REF_HIGH_SCRIPT_ID = 1012;
    public static final int VCS_SNSR_TEST_ID_CPID_CALIBRATE_COLL_REF_SCRIPT_ID = 1013;
    public static final int VCS_SNSR_TEST_ID_CPID_CALIBRATE_REFERENCE_ID = 1005;
    public static final int VCS_SNSR_TEST_ID_CPID_CALIBRATE_SCRIPT_ID = 1000;
    public static final int VCS_SNSR_TEST_ID_CPID_COLL_LIVE_RIDGED_STIMULUS_SCRIPT_ID = 1016;
    ...
    public static final int VCS_SNSR_TEST_ID_CPID_FW_UPDATE_SCRIPT_ID = 1010;
    public static final int VCS_SNSR_TEST_ID_CPID_LOAD_SIMULATED_DATA_SCRIPT_ID = 1015;
    public static final int VCS_SNSR_TEST_ID_CPID_NO_STIMULUS_SCRIPT_ID = 1001;
    public static final int VCS_SNSR_TEST_ID_CPID_STIMULUS_SCRIPT_ID = 1002;
    public static final int VCS_SNSR_TEST_ID_CPID_WRITE_CONFIG_170124_135003_SCRIPT_ID = 1020;
    public static final int VCS_SNSR_TEST_ID_CPID_WRITE_CONFIG_170214_142142_SCRIPT_ID = 1021;
    public static final int VCS_SNSR_TEST_ID_IQ_SCRIPT_ID = 1003;
