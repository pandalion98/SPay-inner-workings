...
public class GyroscopeIcSTMicro extends BaseActivity {
    ...
    private Handler UIUpdateHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1000:
                    GyroscopeIcSTMicro.this.mGyroZeroRateText.setText(String.format("Zero Rate Level Check:  FAIL(%s,%s,%s)", new Object[]{GyroscopeIcSTMicro.this.mSelfTestResults[0], GyroscopeIcSTMicro.this.mSelfTestResults[1], GyroscopeIcSTMicro.this.mSelfTestResults[2]}));
                    GyroscopeIcSTMicro.this.mGyroZeroRateText.setTextColor(-65536);
                    return;
                case 1001:
                    GyroscopeIcSTMicro.this.mGyroZeroRateText.setText("Zero Rate Level Check:  PASS");
                    GyroscopeIcSTMicro.this.mGyroZeroRateText.setTextColor(-16776961);
                    return;
                default:
                    return;
            }
    ...
    public GyroscopeIcSTMicro() {
        super("GyroscopeIcSTMicro");
    }

    /* access modifiers changed from: protected */
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(C0268R.layout.gyroscope_icstmicro);
    ...
    public void onResume() {
        ...
        new Thread() {
            public void run() {
                ...
                String str = "";
                try {
                    if (GyroscopeIcSTMicro.this.mIsSubGyro) {
                        GyroscopeIcSTMicro.this.mGyroTitle.setText("SUB GYROSCOPE SENSOR");
                    ...
                    GyroscopeIcSTMicro.this.mSelfTestResults = selfTestResult.split(",");
                    if (GyroscopeIcSTMicro.this.mSelfTestResults.length > 4) {
                        GyroscopeIcSTMicro.this.mZeroRatePass = true;
                    } else {
                        GyroscopeIcSTMicro.this.mZeroRatePass = false;
                    }
                    StringBuilder sb = new StringBuilder();
                    sb.append(" ZeroRatePass : ");
                    sb.append(GyroscopeIcSTMicro.this.mZeroRatePass);
                    sb.append(", length : ");
                    sb.append(GyroscopeIcSTMicro.this.mSelfTestResults.length);
                    LtUtil.log_d(GyroscopeIcSTMicro.CLASS_NAME, "SelfTest", sb.toString());
                    GyroscopeIcSTMicro.this.mHandler.postDelayed(new Runnable() {
                        public void run() {
                            GyroscopeIcSTMicro.this.mGyroSelfTestLayout.setVisibility(0);
                            GyroscopeIcSTMicro.this.showTestResults(GyroscopeIcSTMicro.this.mSelfTestResults);
                        }
                    }, 1000);
                } catch (IOException e) {
                    e.printStackTrace();
