...
public interface IFPAuthService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFPAuthService {
        private static final String DESCRIPTOR = "egistec.optical.csa.client.api.IFPAuthService";
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 9:
                        data.enforceInterface(descriptor);
                        registerCallback(egistec.optical.csa.client.api.IFPAuthServiceCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 10:
                        data.enforceInterface(descriptor);
                        unregisterCallback(egistec.optical.csa.client.api.IFPAuthServiceCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 11:
                        data.enforceInterface(descriptor);
