...
public class Fingerprint {
    ...
    public static final int SENSOR_TEST_SNR_BKBOX_ON_COMMAND = 100110;
    public static final int SENSOR_TEST_SNR_CHART_ON_COMMAND = 100111;
    public static final int SENSOR_TEST_SNR_INIT_COMMAND = 100108;
    public static final int SENSOR_TEST_SNR_UNINIT_COMMAND = 100112;
    public static final int SENSOR_TEST_SNR_WKBOX_ON_COMMAND = 100109;
    public static final int SENSOR_WORKING = 2005;
    public static final String TAG = "FpJar_Fingerprint";
    ...
    public static class FingerprintRawData {
        public byte[] ImageInfoData;
        public int height;
        public int width;
    }
    ...
    public void triggerTouchEvent(int motionEventCase) {
        mIFingerprint.triggerTouchEvent(motionEventCase);
    }

    public void setForCaptureFrame(int expTime, int hwIntegrate, int pgaGain) {
        mIFingerprint.setForCaptureFrame(expTime, hwIntegrate, pgaGain);
    }

    public void calibration() {
        mIFingerprint.calibration();
    }
    ...
    public int eepromTest(int cmd, int addr, int value) {
        return mIFingerprint.eepromTest(cmd, addr, value);
    }
