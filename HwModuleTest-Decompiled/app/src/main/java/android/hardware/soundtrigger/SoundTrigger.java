...
public class SoundTrigger {
    ...
    public static class ConfidenceLevel implements Parcelable {
        ...
        public String toString() {
            ...
            sb.append("ConfidenceLevel [userId=");
    ...
    public static class GenericRecognitionEvent extends RecognitionEvent {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("GenericRecognitionEvent ::");
    ...
    public static class Keyphrase implements Parcelable {
        ...
        public Keyphrase(int id, int recognitionModes2, String locale2, String text2, int[] users2) {
            this.f1id = id;
        ...
        public static Keyphrase fromParcel(Parcel in) {
            ...
            Keyphrase keyphrase = new Keyphrase(id, recognitionModes2, locale2, text2, users2);
            return keyphrase;
        }

        public void writeToParcel(Parcel dest, int flags) {
            dest.writeInt(this.f1id);
        ...
        public int hashCode() {
            int i = 0;
            int result = 31 * ((31 * ((31 * 1) + (this.text == null ? 0 : this.text.hashCode()))) + this.f1id);
            if (this.locale != null) {
        ...
        public String toString() {
            ...
            sb.append(this.text);
            sb.append(", users=");
            sb.append(Arrays.toString(this.users));
            sb.append("]");
            return sb.toString();
        }
    }
    ...
    public static class KeyphraseRecognitionEvent extends RecognitionEvent {
        ...
        public String toString() {
            ...
            if (this.captureFormat == null) {
                ...
                sb2.append(this.captureFormat.getSampleRate());
                str = sb2.toString();
            }
            sb.append(str);
            if (this.captureFormat == null) {
                ...
                sb3.append(", encoding=");
                sb3.append(this.captureFormat.getEncoding());
                str2 = sb3.toString();
            }
            sb.append(str2);
            if (this.captureFormat == null) {
                ...
                sb4.append(", channelMask=");
                sb4.append(this.captureFormat.getChannelMask());
                str3 = sb4.toString();
            }
            sb.append(str3);
            sb.append(", data=");
    ...
    public static class KeyphraseRecognitionExtra implements Parcelable {
        ...
        /* renamed from: id */
        public final int f2id;
        public final int recognitionModes;

        public KeyphraseRecognitionExtra(int id, int recognitionModes2, int coarseConfidenceLevel2, ConfidenceLevel[] confidenceLevels2) {
            this.f2id = id;
            this.recognitionModes = recognitionModes2;
        ...
        public int hashCode() {
            return (31 * ((31 * ((31 * ((31 * 1) + Arrays.hashCode(this.confidenceLevels))) + this.f2id)) + this.recognitionModes)) + this.coarseConfidenceLevel;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (Arrays.equals(this.confidenceLevels, other.confidenceLevels) && this.f2id == other.f2id && this.recognitionModes == other.recognitionModes && this.coarseConfidenceLevel == other.coarseConfidenceLevel) {
                return true;
            }
            return false;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("KeyphraseRecognitionExtra [id=");
            sb.append(this.f2id);
            sb.append(", recognitionModes=");
            sb.append(this.recognitionModes);
            sb.append(", coarseConfidenceLevel=");
            sb.append(this.coarseConfidenceLevel);
            sb.append(", confidenceLevels=");
            sb.append(Arrays.toString(this.confidenceLevels));
            sb.append("]");
            return sb.toString();
        }
    }
    ...
    public static class ModuleProperties implements Parcelable {
        ...
        public String toString() {
            ...
            sb.append(this.supportsCaptureTransition);
            sb.append(", maxBufferMs=");
            sb.append(this.maxBufferMs);
            sb.append(", supportsConcurrentCapture=");
            sb.append(this.supportsConcurrentCapture);
            sb.append(", powerConsumptionMw=");
            sb.append(this.powerConsumptionMw);
            sb.append(", returnsTriggerInEvent=");
            sb.append(this.returnsTriggerInEvent);
            sb.append("]");
            return sb.toString();
        }
    }
    ...
    public static class RecognitionConfig implements Parcelable {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("RecognitionConfig [captureRequested=");
            sb.append(this.captureRequested);
            sb.append(", allowMultipleTriggers=");
            sb.append(this.allowMultipleTriggers);
    ...
    public static class RecognitionEvent implements Parcelable {
        ...
        protected static RecognitionEvent fromParcel(Parcel in) {
            ...
            if (in.readByte() == 1) {
                captureFormat2 = new Builder().setChannelMask(in.readInt()).setEncoding(in.readInt()).setSampleRate(in.readInt()).build();
            }
