...
public interface BrokenPBE {
    ...
    public static class Util {
        ...
        static CipherParameters makePBEMacParameters(BCPBEKey bCPBEKey, AlgorithmParameterSpec algorithmParameterSpec, int i, int i2, int i3) {
            ...
            for (int i4 = BrokenPBE.PKCS5S1; i4 != encoded.length; i4 += BrokenPBE.SHA1) {
                encoded[i4] = (byte) 0;
            }
        ...
        static CipherParameters makePBEParameters(BCPBEKey bCPBEKey, AlgorithmParameterSpec algorithmParameterSpec, int i, int i2, String str, int i3, int i4) {
            ...
            for (int i5 = BrokenPBE.PKCS5S1; i5 != encoded.length; i5 += BrokenPBE.SHA1) {
                encoded[i5] = (byte) 0;
            }
        ...
        private static void setOddParity(byte[] bArr) {
            for (int i = BrokenPBE.PKCS5S1; i < bArr.length; i += BrokenPBE.SHA1) {
                byte b = bArr[i];
                bArr[i] = (byte) ((((b >> 7) ^ ((((((b >> BrokenPBE.SHA1) ^ (b >> BrokenPBE.RIPEMD160)) ^ (b >> BrokenPBE.OLD_PKCS12)) ^ (b >> 4)) ^ (b >> 5)) ^ (b >> 6))) ^ BrokenPBE.SHA1) | (b & 254));
            }
        }
    }
}
