        ...
        if (keySpec instanceof PKCS8EncodedKeySpec) {
            try {
                try {
                    ...
                    return new BCMcEliecePrivateKey(new McEliecePrivateKeySpec(OID, intValue, intValue2, octets, octets2, octets3, octets4, octets5, octets6, bArr));
                } catch (IOException e) {
        ...
        if (keySpec instanceof X509EncodedKeySpec) {
            try {
                try {
                    ...
                    ((ASN1ObjectIdentifier) aSN1Sequence.getObjectAt(0)).toString();
                    int intValue = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
                    return new BCMcEliecePublicKey(new McEliecePublicKeySpec(OID, ((ASN1Integer) aSN1Sequence.getObjectAt(2)).getValue().intValue(), intValue, ((ASN1OctetString) aSN1Sequence.getObjectAt(3)).getOctets()));
                } catch (IOException e) {
