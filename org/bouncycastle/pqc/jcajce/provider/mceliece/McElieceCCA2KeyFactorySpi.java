        ...
        if (keySpec instanceof PKCS8EncodedKeySpec) {
            try {
                try {
                    ...
                    return new BCMcElieceCCA2PrivateKey(new McElieceCCA2PrivateKeySpec(OID, intValue, intValue2, octets, octets2, octets3, octets4, bArr));
                } catch (IOException e) {
        ...
        if (keySpec instanceof X509EncodedKeySpec) {
            try {
                try {
                    ...
                    ((ASN1ObjectIdentifier) aSN1Sequence.getObjectAt(0)).toString();
                    return new BCMcElieceCCA2PublicKey(new McElieceCCA2PublicKeySpec(OID, ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue(), ((ASN1Integer) aSN1Sequence.getObjectAt(2)).getValue().intValue(), ((ASN1OctetString) aSN1Sequence.getObjectAt(3)).getOctets()));
                } catch (IOException e) {
