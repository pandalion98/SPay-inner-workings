...
public class CamelliaEngine implements BlockCipher {
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        i2 = SBOX1_1110[(i2 >>> 24) & MASK8] ^ ((SBOX4_4404[i2 & MASK8] ^ SBOX3_3033[(i2 >>> 8) & MASK8]) ^ SBOX2_0222[(i2 >>> BLOCK_SIZE) & MASK8]);
        int i3 = iArr[1] ^ iArr2[i + 1];
        i3 = SBOX2_0222[(i3 >>> 24) & MASK8] ^ ((SBOX1_1110[i3 & MASK8] ^ SBOX4_4404[(i3 >>> 8) & MASK8]) ^ SBOX3_3033[(i3 >>> BLOCK_SIZE) & MASK8]);
        iArr[2] = iArr[2] ^ (i2 ^ i3);
