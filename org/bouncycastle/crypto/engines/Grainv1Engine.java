...
public class Grainv1Engine implements StreamCipher {
    ...
    private int getOutput() {
        ...
        int i6 = (this.nfsr[2] >>> 11) | (this.nfsr[3] << STATE_SIZE);
        ...
        int i12 = this.lfsr[4];
        return (((((((i ^ ((i8 & (i11 & i12)) ^ ((((i9 & i11) & i8) ^ ((((((i10 ^ i8) ^ (i9 & i12)) ^ (i11 & i12)) ^ (i12 & i8)) ^ ((i9 & i10) & i11)) ^ ((i9 & i11) & i12))) ^ ((i10 & i11) & i8)))) ^ i2) ^ i3) ^ i4) ^ i5) ^ i6) ^ i7) & HCEClientConstants.HIGHEST_ATC_DEC_VALUE;
    }
    ...
    private int getOutputLFSR() {
        ...
        return (((((this.lfsr[0] ^ ((this.lfsr[0] >>> 13) | (this.lfsr[1] << 3))) ^ i) ^ i2) ^ i3) ^ ((this.lfsr[3] >>> 14) | (this.lfsr[4] << 2))) & HCEClientConstants.HIGHEST_ATC_DEC_VALUE;
    }

    private int getOutputNFSR() {
        int i = (this.nfsr[0] >>> 9) | (this.nfsr[1] << 7);
        int i2 = (this.nfsr[0] >>> 15) | (this.nfsr[1] << 1);
        int i3 = (this.nfsr[1] >>> STATE_SIZE) | (this.nfsr[2] << 11);
        int i4 = (this.nfsr[1] >>> 12) | (this.nfsr[2] << 4);
        int i5 = (this.nfsr[2] >>> 1) | (this.nfsr[3] << 15);
        int i6 = (this.nfsr[2] >>> STATE_SIZE) | (this.nfsr[3] << 11);
        ...
        return ((((((((((((this.nfsr[0] ^ ((((this.nfsr[0] >>> 14) | (this.nfsr[1] << 2)) ^ (((((((((this.nfsr[3] >>> 14) | (this.nfsr[4] << 2)) ^ i9) ^ i8) ^ i7) ^ i6) ^ i5) ^ i4) ^ i3)) ^ i)) ^ (i10 & i9)) ^ (i6 & i5)) ^ (i2 & i)) ^ ((i9 & i8) & i7)) ^ ((i5 & i4) & i3)) ^ (((i10 & i7) & i4) & i)) ^ (((i9 & i8) & i6) & i5)) ^ (((i10 & i9) & i3) & i2)) ^ ((((i10 & i9) & i8) & i7) & i6)) ^ (i & (((i5 & i4) & i3) & i2))) ^ (((((i8 & i7) & i6) & i5) & i4) & i3)) & HCEClientConstants.HIGHEST_ATC_DEC_VALUE;
    }
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (i < this.nfsr.length) {
            this.nfsr[i] = ((this.workingKey[i2 + 1] << 8) | (this.workingKey[i2] & GF2Field.MASK)) & HCEClientConstants.HIGHEST_ATC_DEC_VALUE;
            this.lfsr[i] = ((this.workingIV[i2 + 1] << 8) | (this.workingIV[i2] & GF2Field.MASK)) & HCEClientConstants.HIGHEST_ATC_DEC_VALUE;
            i2 += 2;
            i++;
        }
    }
