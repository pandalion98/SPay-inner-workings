...
public class SHA512tDigest extends LongDigest {
    ...
    private void tIvGenerate(int i) {
        ...
        update(ApplicationInfoManager.TERMINAL_MODE_CL_EMV);
        update((byte) 72);
        update((byte) 65);
        update(SetResetParamApdu.INS);
        update(ApplicationInfoManager.MOB_CVM_TYP_DEV_PATTERN);
        update((byte) 49);
        update((byte) 50);
        update((byte) 47);
        if (i > 100) {
