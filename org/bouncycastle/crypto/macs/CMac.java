...
public class CMac implements Mac {
    ...
    private static byte[] doubleLu(byte[] bArr) {
        ...
        bArr2[length] = (byte) ((((bArr.length == 16 ? -121 : 27) & GF2Field.MASK) >>> ((1 - shiftLeft(bArr, bArr2)) << 3)) ^ bArr2[length]);
        return bArr2;
    }
    ...
    private static int shiftLeft(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            int i2 = bArr[length] & GF2Field.MASK;
    ...
    public void init(CipherParameters cipherParameters) {
        ...
        this.f185L = new byte[this.ZEROES.length];
        this.cipher.processBlock(this.ZEROES, 0, this.f185L, 0);
        this.Lu = doubleLu(this.f185L);
