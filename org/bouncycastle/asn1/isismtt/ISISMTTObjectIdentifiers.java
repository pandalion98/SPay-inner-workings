...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        id_isismtt_cp = id_isismtt.branch(TransactionInfo.VISA_TRANSACTIONTYPE_REFUND);
        id_isismtt_cp_accredited = id_isismtt_cp.branch(TransactionInfo.VISA_TRANSACTIONTYPE_REFUND);
        id_isismtt_at = id_isismtt.branch(TransactionInfo.VISA_TRANSACTIONSTATUS_DECLINED);
        id_isismtt_at_dateOfCertGen = id_isismtt_at.branch(TransactionInfo.VISA_TRANSACTIONTYPE_REFUND);
        id_isismtt_at_procuration = id_isismtt_at.branch(TransactionInfo.VISA_TRANSACTIONSTATUS_REFUNDED);
        id_isismtt_at_admission = id_isismtt_at.branch(TransactionInfo.VISA_TRANSACTIONSTATUS_DECLINED);
        id_isismtt_at_monetaryLimit = id_isismtt_at.branch(DiscoverInAppCryptoData.DEFAULT_ECI_INDICATOR);
        ...
        id_isismtt_at_requestedCertificate = id_isismtt_at.branch(Constants.CLIENT_MINOR_VERSION);
        id_isismtt_at_namingAuthorities = id_isismtt_at.branch(HCEClientConstants.API_INDEX_TOKEN_REFRESH_STATUS);
