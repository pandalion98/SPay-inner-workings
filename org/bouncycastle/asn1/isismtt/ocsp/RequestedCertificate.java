...
public class RequestedCertificate extends ASN1Object implements ASN1Choice {
    ...
    private RequestedCertificate(ASN1TaggedObject aSN1TaggedObject) {
        ...
        } else if (aSN1TaggedObject.getTagNo() == attributeCertificate) {
    ...
    public int getType() {
        return this.cert != null ? certificate : this.publicKeyCert != null ? 0 : attributeCertificate;
    }

    public ASN1Primitive toASN1Primitive() {
        return this.publicKeyCert != null ? new DERTaggedObject(0, new DEROctetString(this.publicKeyCert)) : this.attributeCert != null ? new DERTaggedObject(attributeCertificate, new DEROctetString(this.attributeCert)) : this.cert.toASN1Primitive();
    }
}
