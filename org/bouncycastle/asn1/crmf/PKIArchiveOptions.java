...
public class PKIArchiveOptions extends ASN1Object implements ASN1Choice {
    ...
    public int getType() {
        return this.value instanceof EncryptedKey ? encryptedPrivKey : this.value instanceof ASN1OctetString ? keyGenParameters : archiveRemGenPrivKey;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        return this.value instanceof EncryptedKey ? new DERTaggedObject(true, encryptedPrivKey, this.value) : this.value instanceof ASN1OctetString ? new DERTaggedObject(false, keyGenParameters, this.value) : new DERTaggedObject(false, archiveRemGenPrivKey, this.value);
    }
}
