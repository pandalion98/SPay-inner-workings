    ...
    public void setNonce(BigInteger bigInteger) {
        if (this.initialInfo != null) {
            if (this.initialInfo.getNonce() == null) {
                ...
                System.arraycopy(toByteArray, TAG_REQUESTER, obj, TAG_REQUESTER, toByteArray.length);
                System.arraycopy(asUnsignedByteArray, TAG_REQUESTER, obj, toByteArray.length, asUnsignedByteArray.length);
