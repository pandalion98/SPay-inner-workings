...
public class SecP256R1Point extends AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (isOne) {
            iArr = secP256R1FieldElement3.f368x;
            iArr2 = secP256R1FieldElement4.f368x;
            iArr3 = iArr;
        } else {
            SecP256R1Field.square(secP256R1FieldElement5.f368x, create2);
            SecP256R1Field.multiply(create2, secP256R1FieldElement3.f368x, create);
            SecP256R1Field.multiply(create2, secP256R1FieldElement5.f368x, create2);
            SecP256R1Field.multiply(create2, secP256R1FieldElement4.f368x, create2);
            iArr2 = create2;
            iArr3 = create;
        }
        boolean isOne2 = secP256R1FieldElement6.isOne();
        if (isOne2) {
            iArr = secP256R1FieldElement.f368x;
            iArr4 = secP256R1FieldElement2.f368x;
            iArr5 = iArr;
        } else {
            SecP256R1Field.square(secP256R1FieldElement6.f368x, create3);
            SecP256R1Field.multiply(create3, secP256R1FieldElement.f368x, createExt);
            SecP256R1Field.multiply(create3, secP256R1FieldElement6.f368x, create3);
            SecP256R1Field.multiply(create3, secP256R1FieldElement2.f368x, create3);
            iArr4 = create3;
            iArr5 = createExt;
        }
        iArr = Nat256.create();
        ...
        if (Nat256.isZero(iArr)) {
            ...
            SecP256R1Field.square(create, secP256R1FieldElement7.f368x);
            SecP256R1Field.subtract(secP256R1FieldElement7.f368x, iArr3, secP256R1FieldElement7.f368x);
            ECFieldElement secP256R1FieldElement8 = new SecP256R1FieldElement(iArr3);
            SecP256R1Field.subtract(create2, secP256R1FieldElement7.f368x, secP256R1FieldElement8.f368x);
            SecP256R1Field.multiplyAddToExt(secP256R1FieldElement8.f368x, create, createExt);
            SecP256R1Field.reduce(createExt, secP256R1FieldElement8.f368x);
            secP256R1FieldElement = new SecP256R1FieldElement(iArr);
            if (!isOne) {
                SecP256R1Field.multiply(secP256R1FieldElement.f368x, secP256R1FieldElement5.f368x, secP256R1FieldElement.f368x);
            }
            if (!isOne2) {
                SecP256R1Field.multiply(secP256R1FieldElement.f368x, secP256R1FieldElement6.f368x, secP256R1FieldElement.f368x);
            }
    ...
    public ECPoint twice() {
        ...
        int[] create2 = Nat256.create();
        int[] create3 = Nat256.create();
        SecP256R1Field.square(secP256R1FieldElement.f368x, create3);
        int[] create4 = Nat256.create();
        SecP256R1Field.square(create3, create4);
        boolean isOne = secP256R1FieldElement3.isOne();
        int[] iArr = secP256R1FieldElement3.f368x;
        if (!isOne) {
            SecP256R1Field.square(secP256R1FieldElement3.f368x, create2);
            iArr = create2;
        }
        SecP256R1Field.subtract(secP256R1FieldElement2.f368x, iArr, create);
        SecP256R1Field.add(secP256R1FieldElement2.f368x, iArr, create2);
        ...
        SecP256R1Field.square(create2, secP256R1FieldElement4.f368x);
        SecP256R1Field.subtract(secP256R1FieldElement4.f368x, create3, secP256R1FieldElement4.f368x);
        SecP256R1Field.subtract(secP256R1FieldElement4.f368x, create3, secP256R1FieldElement4.f368x);
        ECFieldElement secP256R1FieldElement5 = new SecP256R1FieldElement(create3);
        SecP256R1Field.subtract(create3, secP256R1FieldElement4.f368x, secP256R1FieldElement5.f368x);
        SecP256R1Field.multiply(secP256R1FieldElement5.f368x, create2, secP256R1FieldElement5.f368x);
        SecP256R1Field.subtract(secP256R1FieldElement5.f368x, create, secP256R1FieldElement5.f368x);
        SecP256R1FieldElement secP256R1FieldElement6 = new SecP256R1FieldElement(create2);
        SecP256R1Field.twice(secP256R1FieldElement.f368x, secP256R1FieldElement6.f368x);
        if (!isOne) {
            SecP256R1Field.multiply(secP256R1FieldElement6.f368x, secP256R1FieldElement3.f368x, secP256R1FieldElement6.f368x);
        }
