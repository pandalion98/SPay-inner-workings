...
public class SecP192K1FieldElement extends ECFieldElement {
    public static final BigInteger f344Q;
    protected int[] f345x;

    static {
        f344Q = SecP192K1Curve.f342q;
    }

    public SecP192K1FieldElement() {
        this.f345x = Nat192.create();
    }

    public SecP192K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f344Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP192K1FieldElement");
        }
        this.f345x = SecP192K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP192K1Field.add(this.f345x, ((SecP192K1FieldElement) eCFieldElement).f345x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat192.create();
        SecP192K1Field.addOne(this.f345x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        Mod.invert(SecP192K1Field.f343P, ((SecP192K1FieldElement) eCFieldElement).f345x, create);
        SecP192K1Field.multiply(create, this.f345x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat192.eq(this.f345x, ((SecP192K1FieldElement) obj).f345x);
    }
    ...
    public int getFieldSize() {
        return f344Q.bitLength();
    }

    public int hashCode() {
        return f344Q.hashCode() ^ Arrays.hashCode(this.f345x, 0, 6);
    }

    public ECFieldElement invert() {
        int[] create = Nat192.create();
        Mod.invert(SecP192K1Field.f343P, this.f345x, create);
        return new SecP192K1FieldElement(create);
    }

    public boolean isOne() {
        return Nat192.isOne(this.f345x);
    }

    public boolean isZero() {
        return Nat192.isZero(this.f345x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.multiply(this.f345x, ((SecP192K1FieldElement) eCFieldElement).f345x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat192.create();
        SecP192K1Field.negate(this.f345x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public ECFieldElement square() {
        int[] create = Nat192.create();
        SecP192K1Field.square(this.f345x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.subtract(this.f345x, ((SecP192K1FieldElement) eCFieldElement).f345x, create);
        return new SecP192K1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat192.getBit(this.f345x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat192.toBigInteger(this.f345x);
    }
}
