...
public final class DESede {
    ...
    public static class KeyGenerator3 extends BaseKeyGenerator {
        public KeyGenerator3() {
            super("DESede3", CipherSuite.TLS_RSA_WITH_CAMELLIA_256_CBC_SHA256, new DESedeKeyGenerator());
        }
    }
    ...
    public static class PBEWithSHAAndDES3KeyFactory extends DESPBEKeyFactory {
        public PBEWithSHAAndDES3KeyFactory() {
            super("PBEwithSHAandDES3Key-CBC", PKCSObjectIdentifiers.pbeWithSHAAnd3_KeyTripleDES_CBC, true, 2, 1, CipherSuite.TLS_RSA_WITH_CAMELLIA_256_CBC_SHA256, 64);
        }
    }
