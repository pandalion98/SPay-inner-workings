...
public final class ARC4 {
    ...
    public static class KeyGen extends BaseKeyGenerator {
        public KeyGen() {
            super("RC4", X509KeyUsage.digitalSignature, new CipherKeyGenerator());
        }
    }
    ...
    public static class PBEWithSHAAnd128BitKeyFactory extends PBESecretKeyFactory {
        public PBEWithSHAAnd128BitKeyFactory() {
            super("PBEWithSHAAnd128BitRC4", PKCSObjectIdentifiers.pbeWithSHAAnd128BitRC4, true, 2, 1, X509KeyUsage.digitalSignature, 0);
        }
    }
