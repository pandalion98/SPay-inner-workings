...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f287c.getExtensions();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f287c.equals(((X509CRLEntryObject) obj).f287c);
    }
    ...
    public byte[] getEncoded() {
        try {
            return this.f287c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Date getRevocationDate() {
        return this.f287c.getRevocationDate().getDate();
    }

    public BigInteger getSerialNumber() {
        return this.f287c.getUserCertificate().getValue();
    }

    public boolean hasExtensions() {
        return this.f287c.getExtensions() != null;
    }
