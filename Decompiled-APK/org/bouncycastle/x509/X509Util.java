...
class X509Util {
    ...
    static ASN1ObjectIdentifier getAlgorithmOID(String str) {
        ...
        return algorithms.containsKey(toUpperCase) ? (ASN1ObjectIdentifier) algorithms.get(toUpperCase) : new ASN1ObjectIdentifier(toUpperCase);
    }
    ...
    static AlgorithmIdentifier getSigAlgID(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        String toUpperCase = Strings.toUpperCase(str);
        return params.containsKey(toUpperCase) ? new AlgorithmIdentifier(aSN1ObjectIdentifier, (ASN1Encodable) params.get(toUpperCase)) : new AlgorithmIdentifier(aSN1ObjectIdentifier, DERNull.INSTANCE);
    }
