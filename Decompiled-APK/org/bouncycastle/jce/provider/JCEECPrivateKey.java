...
public class JCEECPrivateKey implements ECPrivateKey, ECPointEncoder, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public JCEECPrivateKey(String str, ECPrivateKeySpec eCPrivateKeySpec) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f292d = eCPrivateKeySpec.getS();
    ...
    public JCEECPrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f292d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public JCEECPrivateKey(String str, JCEECPrivateKey jCEECPrivateKey) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f292d = jCEECPrivateKey.f292d;
    ...
    public JCEECPrivateKey(String str, org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f292d = eCPrivateKeySpec.getD();
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo privateKeyInfo) {
        ...
        if (parsePrivateKey instanceof ASN1Integer) {
            this.f292d = ASN1Integer.getInstance(parsePrivateKey).getValue();
            return;
        }
        ECPrivateKeyStructure eCPrivateKeyStructure = new ECPrivateKeyStructure((ASN1Sequence) parsePrivateKey);
        this.f292d = eCPrivateKeyStructure.getKey();
    ...
    public String toString() {
        ...
        stringBuffer.append("             S: ").append(this.f292d.toString(16)).append(property);
