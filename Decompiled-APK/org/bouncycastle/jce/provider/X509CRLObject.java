...
public class X509CRLObject extends X509CRL {
    ...
    private Set getExtensionOIDs(boolean z) {
        if (getVersion() == 2) {
            Extensions extensions = this.f301c.getTBSCertList().getExtensions();
            if (extensions != null) {
    ...
    private Set loadCRLEntries() {
        Set hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f301c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        return (this.isHashCodeSet && x509CRLObject.isHashCodeSet && x509CRLObject.hashCodeValue != this.hashCodeValue) ? false : this.f301c.equals(x509CRLObject.f301c);
    }
    ...
    public byte[] getEncoded() {
        try {
            return this.f301c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f301c.getIssuer().toASN1Primitive()));
    }

    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f301c.getIssuer().getEncoded());
        } catch (IOException e) {
    ...
    public Date getNextUpdate() {
        return this.f301c.getNextUpdate() != null ? this.f301c.getNextUpdate().getDate() : null;
    }
    ...
    public String getSigAlgOID() {
        return this.f301c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f301c.getSignature().getBytes();
    }

    public byte[] getTBSCertList() {
        try {
            return this.f301c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f301c.getThisUpdate().getDate();
    }

    public int getVersion() {
        return this.f301c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f301c.getRevokedCertificateEnumeration();
            X500Name issuer = this.f301c.getIssuer();
    ...
    public void verify(PublicKey publicKey, String str) {
        if (this.f301c.getSignatureAlgorithm().equals(this.f301c.getTBSCertList().getSignature())) {
