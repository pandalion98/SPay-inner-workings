...
public final class CAST6 {
    ...
    public static class ECB extends BaseBlockCipher {
        ...
        /* renamed from: org.bouncycastle.jcajce.provider.symmetric.CAST6.ECB.1 */
        class C07601 implements BlockCipherProvider {
            C07601() {
            }
    ...
    public static class KeyGen extends BaseKeyGenerator {
        public KeyGen() {
            super("CAST6", SkeinMac.SKEIN_256, new CipherKeyGenerator());
        }
    }
    ...
    public static class Poly1305KeyGen extends BaseKeyGenerator {
        public Poly1305KeyGen() {
            super("Poly1305-CAST6", SkeinMac.SKEIN_256, new Poly1305KeyGenerator());
        }
    }
