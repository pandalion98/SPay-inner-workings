...
public class SHA512 {
    ...
    public static class HashMacT256 extends BaseMac {
        public HashMacT256() {
            super(new HMac(new SHA512tDigest((int) SkeinMac.SKEIN_256)));
        }
    }

    public static class KeyGenerator extends BaseKeyGenerator {
        public KeyGenerator() {
            super("HMACSHA512", SkeinMac.SKEIN_512, new CipherKeyGenerator());
        }
    }
    ...
    public static class KeyGeneratorT256 extends BaseKeyGenerator {
        public KeyGeneratorT256() {
            super("HMACSHA512/256", SkeinMac.SKEIN_256, new CipherKeyGenerator());
        }
    }
