...
public class BCDHPublicKey implements DHPublicKey {
    ...
    private BigInteger f270y;

    BCDHPublicKey(BigInteger bigInteger, DHParameterSpec dHParameterSpec) {
        this.f270y = bigInteger;
        this.dhSpec = dHParameterSpec;
    }

    BCDHPublicKey(DHPublicKey dHPublicKey) {
        this.f270y = dHPublicKey.getY();
        this.dhSpec = dHPublicKey.getParams();
    }

    BCDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f270y = dHPublicKeySpec.getY();
    ...
    public BCDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f270y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    BCDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f270y = dHPublicKeyParameters.getY();
    ...
    public byte[] getEncoded() {
        return this.info != null ? KeyUtil.getEncodedSubjectPublicKeyInfo(this.info) : KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL()).toASN1Primitive()), new ASN1Integer(this.f270y));
    }
