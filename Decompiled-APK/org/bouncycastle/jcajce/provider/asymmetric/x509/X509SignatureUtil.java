...
class X509SignatureUtil {
    ...
    static String getSignatureName(AlgorithmIdentifier algorithmIdentifier) {
        ...
        if (provider != null) {
            property = provider.getProperty("Alg.Alias.Signature." + algorithmIdentifier.getAlgorithm().getId());
            if (property != null) {
                return property;
            }
        }
        ...
        while (i != providers.length) {
            property = providers[i].getProperty("Alg.Alias.Signature." + algorithmIdentifier.getAlgorithm().getId());
            if (property != null) {
                return property;
            }
            i++;
