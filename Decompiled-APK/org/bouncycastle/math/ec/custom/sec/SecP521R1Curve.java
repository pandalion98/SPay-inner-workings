...
public class SecP521R1Curve extends AbstractFp {
    ...
    public static final BigInteger f374q;
    protected SecP521R1Point infinity;

    static {
        f374q = new BigInteger(1, Hex.decode("01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"));
    }
    ...
    public boolean supportsCoordinateSystem(int i) {
        switch (i) {
            case SecP521R1_DEFAULT_COORDS /*2*/:
                return true;
            default:
                return false;
        }
