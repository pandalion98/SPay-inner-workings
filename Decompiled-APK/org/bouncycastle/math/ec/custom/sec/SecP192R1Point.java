...
public class SecP192R1Point extends AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (isOne) {
            iArr = secP192R1FieldElement3.f350x;
            iArr2 = secP192R1FieldElement4.f350x;
            iArr3 = iArr;
        } else {
            SecP192R1Field.square(secP192R1FieldElement5.f350x, create2);
            SecP192R1Field.multiply(create2, secP192R1FieldElement3.f350x, create);
            SecP192R1Field.multiply(create2, secP192R1FieldElement5.f350x, create2);
            SecP192R1Field.multiply(create2, secP192R1FieldElement4.f350x, create2);
            iArr2 = create2;
            iArr3 = create;
        }
        boolean isOne2 = secP192R1FieldElement6.isOne();
        if (isOne2) {
            iArr = secP192R1FieldElement.f350x;
            iArr4 = secP192R1FieldElement2.f350x;
            iArr5 = iArr;
        } else {
            SecP192R1Field.square(secP192R1FieldElement6.f350x, create3);
            SecP192R1Field.multiply(create3, secP192R1FieldElement.f350x, createExt);
            SecP192R1Field.multiply(create3, secP192R1FieldElement6.f350x, create3);
            SecP192R1Field.multiply(create3, secP192R1FieldElement2.f350x, create3);
            iArr4 = create3;
            iArr5 = createExt;
        }
        iArr = Nat192.create();
        ...
        if (Nat192.isZero(iArr)) {
            ...
            SecP192R1Field.square(create, secP192R1FieldElement7.f350x);
            SecP192R1Field.subtract(secP192R1FieldElement7.f350x, iArr3, secP192R1FieldElement7.f350x);
            ECFieldElement secP192R1FieldElement8 = new SecP192R1FieldElement(iArr3);
            SecP192R1Field.subtract(create2, secP192R1FieldElement7.f350x, secP192R1FieldElement8.f350x);
            SecP192R1Field.multiplyAddToExt(secP192R1FieldElement8.f350x, create, createExt);
            SecP192R1Field.reduce(createExt, secP192R1FieldElement8.f350x);
            secP192R1FieldElement = new SecP192R1FieldElement(iArr);
            if (!isOne) {
                SecP192R1Field.multiply(secP192R1FieldElement.f350x, secP192R1FieldElement5.f350x, secP192R1FieldElement.f350x);
            }
            if (!isOne2) {
                SecP192R1Field.multiply(secP192R1FieldElement.f350x, secP192R1FieldElement6.f350x, secP192R1FieldElement.f350x);
            }
    ...
    public ECPoint twice() {
        ...
        int[] create2 = Nat192.create();
        int[] create3 = Nat192.create();
        SecP192R1Field.square(secP192R1FieldElement.f350x, create3);
        int[] create4 = Nat192.create();
        SecP192R1Field.square(create3, create4);
        boolean isOne = secP192R1FieldElement3.isOne();
        int[] iArr = secP192R1FieldElement3.f350x;
        if (!isOne) {
            SecP192R1Field.square(secP192R1FieldElement3.f350x, create2);
            iArr = create2;
        }
        SecP192R1Field.subtract(secP192R1FieldElement2.f350x, iArr, create);
        SecP192R1Field.add(secP192R1FieldElement2.f350x, iArr, create2);
        ...
        SecP192R1Field.square(create2, secP192R1FieldElement4.f350x);
        SecP192R1Field.subtract(secP192R1FieldElement4.f350x, create3, secP192R1FieldElement4.f350x);
        SecP192R1Field.subtract(secP192R1FieldElement4.f350x, create3, secP192R1FieldElement4.f350x);
        ECFieldElement secP192R1FieldElement5 = new SecP192R1FieldElement(create3);
        SecP192R1Field.subtract(create3, secP192R1FieldElement4.f350x, secP192R1FieldElement5.f350x);
        SecP192R1Field.multiply(secP192R1FieldElement5.f350x, create2, secP192R1FieldElement5.f350x);
        SecP192R1Field.subtract(secP192R1FieldElement5.f350x, create, secP192R1FieldElement5.f350x);
        SecP192R1FieldElement secP192R1FieldElement6 = new SecP192R1FieldElement(create2);
        SecP192R1Field.twice(secP192R1FieldElement.f350x, secP192R1FieldElement6.f350x);
        if (!isOne) {
            SecP192R1Field.multiply(secP192R1FieldElement6.f350x, secP192R1FieldElement3.f350x, secP192R1FieldElement6.f350x);
        }
