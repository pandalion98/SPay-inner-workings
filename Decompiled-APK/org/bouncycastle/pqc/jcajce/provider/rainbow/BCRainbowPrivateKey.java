...
public class BCRainbowPrivateKey implements PrivateKey {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof BCRainbowPrivateKey)) {
            ...
            boolean z3 = (RainbowUtil.equals(this.A1inv, bCRainbowPrivateKey.getInvA1())) && RainbowUtil.equals(this.A2inv, bCRainbowPrivateKey.getInvA2());
            z3 = z3 && RainbowUtil.equals(this.b1, bCRainbowPrivateKey.getB1());
            z3 = z3 && RainbowUtil.equals(this.b2, bCRainbowPrivateKey.getB2());
            if (!(z3 && Arrays.equals(this.vi, bCRainbowPrivateKey.getVi()))) {
                z = false;
            }
