...
public class X962NamedCurves {
    ...
    static class C07271 extends X9ECParametersHolder {
        C07271() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(fp, fp.decodePoint(Hex.decode("03188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012")), bigInteger, valueOf, Hex.decode("3045AE6FC8422f64ED579528D38120EAE12196D5"));
        }
    }

    /* renamed from: org.bouncycastle.asn1.x9.X962NamedCurves.2 */
    static class C07282 extends X9ECParametersHolder {
        C07282() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(fp, fp.decodePoint(Hex.decode("03eea2bae7e1497842f2de7769cfe9c989c072ad696f48034a")), bigInteger, valueOf, Hex.decode("31a92ee2029fd10d901b113e990710f0d21ac6b6"));
        }
    }

    /* renamed from: org.bouncycastle.asn1.x9.X962NamedCurves.3 */
    static class C07293 extends X9ECParametersHolder {
        C07293() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(fp, fp.decodePoint(Hex.decode("027d29778100c65a1da1783716588dce2b8b4aee8e228f1896")), bigInteger, valueOf, Hex.decode("c469684435deb378c4b65ca9591e2a5763059a2e"));
        }
    }

    /* renamed from: org.bouncycastle.asn1.x9.X962NamedCurves.4 */
    static class C07304 extends X9ECParametersHolder {
        C07304() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(fp, fp.decodePoint(Hex.decode("020ffa963cdca8816ccc33b8642bedf905c3d358573d3f27fbbd3b3cb9aaaf")), bigInteger, valueOf, Hex.decode("e43bb460f0b80cc0c0b075798e948060f8321b7d"));
        }
    }

    /* renamed from: org.bouncycastle.asn1.x9.X962NamedCurves.5 */
    static class C07315 extends X9ECParametersHolder {
        C07315() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(fp, fp.decodePoint(Hex.decode("0238af09d98727705120c921bb5e9e26296a3cdcf2f35757a0eafd87b830e7")), bigInteger, valueOf, Hex.decode("e8b4011604095303ca3b8099982be09fcb9ae616"));
        }
    }

    /* renamed from: org.bouncycastle.asn1.x9.X962NamedCurves.6 */
    static class C07326 extends X9ECParametersHolder {
        C07326() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(fp, fp.decodePoint(Hex.decode("036768ae8e18bb92cfcf005c949aa2c6d94853d0e660bbf854b1c9505fe95a")), bigInteger, valueOf, Hex.decode("7d7374168ffe3471b60a857686a19475d3bfa2ff"));
        }
    }

    /* renamed from: org.bouncycastle.asn1.x9.X962NamedCurves.7 */
    static class C07337 extends X9ECParametersHolder {
        C07337() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(fp, fp.decodePoint(Hex.decode("036b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296")), bigInteger, valueOf, Hex.decode("c49d360886e704936a6678e1139d26b7819f7e90"));
        }
    }

    /* renamed from: org.bouncycastle.asn1.x9.X962NamedCurves.8 */
    static class C07348 extends X9ECParametersHolder {
        C07348() {
        }
    ...
    static class C07359 extends X9ECParametersHolder {
        C07359() {
        }
    ...
    static {
        prime192v1 = new C07271();
        prime192v2 = new C07282();
        prime192v3 = new C07293();
        prime239v1 = new C07304();
        prime239v2 = new C07315();
        prime239v3 = new C07326();
        prime256v1 = new C07337();
        c2pnb163v1 = new C07348();
        c2pnb163v2 = new C07359();
        ...
        c2pnb208w1 = new X9ECParametersHolder() {
            protected X9ECParameters createParameters() {
                ...
                ECCurve f2m = new F2m(208, 1, 2, 83, new BigInteger(TransactionInfo.VISA_TRANSACTIONTYPE_PURCHASE, 16), new BigInteger("00C8619ED45A62E6212E1160349E2BFA844439FAFC2A3FD1638F9E", 16), bigInteger, valueOf);
