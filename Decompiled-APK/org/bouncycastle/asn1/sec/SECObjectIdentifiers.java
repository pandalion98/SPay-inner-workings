...
public interface SECObjectIdentifiers {
    ...
    static {
        ...
        sect163k1 = ellipticCurve.branch(TransactionInfo.VISA_TRANSACTIONTYPE_REFUND);
        sect163r1 = ellipticCurve.branch(TransactionInfo.VISA_TRANSACTIONSTATUS_REFUNDED);
        sect239k1 = ellipticCurve.branch(TransactionInfo.VISA_TRANSACTIONSTATUS_DECLINED);
        sect113r1 = ellipticCurve.branch(DiscoverInAppCryptoData.DEFAULT_ECI_INDICATOR);
        ...
        secp256k1 = ellipticCurve.branch(Constants.CLIENT_MINOR_VERSION);
