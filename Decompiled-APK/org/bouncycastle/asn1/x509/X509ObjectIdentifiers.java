...
public interface X509ObjectIdentifiers {
    ...
    static {
        ...
        id_pe = id_pkix.branch(TransactionInfo.VISA_TRANSACTIONTYPE_REFUND);
        id_ce = new ASN1ObjectIdentifier("2.5.29");
        id_ad = id_pkix.branch(Constants.TOKEN_META_SUPPRESS_EMV_TAG);
        id_ad_caIssuers = id_ad.branch(TransactionInfo.VISA_TRANSACTIONSTATUS_REFUNDED);
        id_ad_ocsp = id_ad.branch(TransactionInfo.VISA_TRANSACTIONTYPE_REFUND);
