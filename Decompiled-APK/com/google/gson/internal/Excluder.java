...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    class C02891 extends TypeAdapter<T> {
        ...
        C02891(boolean z, boolean z2, Gson gson, TypeToken typeToken) {
    ...
    public Excluder() {
        ...
        this.modifiers = CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA;
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        if (excludeClass || excludeClass2) {
            return new C02891(excludeClass2, excludeClass, gson, typeToken);
        }
        return null;
    }
