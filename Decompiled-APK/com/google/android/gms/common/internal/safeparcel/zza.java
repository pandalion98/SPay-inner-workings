...
public class zza {
    ...
    public static int zza(Parcel parcel, int i) {
        return (i & SupportMenu.CATEGORY_MASK) != SupportMenu.CATEGORY_MASK ? (i >> 16) & HCEClientConstants.HIGHEST_ATC_DEC_VALUE : parcel.readInt();
    }
    ...
    public static int zzaP(int i) {
        return HCEClientConstants.HIGHEST_ATC_DEC_VALUE & i;
    }
