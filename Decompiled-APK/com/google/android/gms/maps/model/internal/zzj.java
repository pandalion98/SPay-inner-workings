...
public interface zzj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzj {
        ...
        private static class zza implements zzj {
            ...
            public boolean zzb(zzj com_google_android_gms_maps_model_internal_zzj) {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                ...
                case ECCurve.COORD_LAMBDA_AFFINE /*5*/:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    isUnderground = zzb(zzbZ(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    if (isUnderground) {
                        i3 = 1;
                    }
    ...
    boolean zzb(zzj com_google_android_gms_maps_model_internal_zzj);
}
