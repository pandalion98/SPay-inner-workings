...
/* renamed from: com.samsung.android.spayfw.payprovider.amexv2.b */
public class AmexTransactionManager {
    private static AmexTransactionManager qJ;
    private Context mContext;
    private CertificateInfo pl;
    private SharedPreferences pp;
    private AmexTAController qA;

    /* renamed from: com.samsung.android.spayfw.payprovider.amexv2.b.1 */
    class AmexTransactionManager extends C0413a<Response<TokenResponseData>, QueryTokenRequest> {
        ...
        final /* synthetic */ AmexTransactionManager qK;
        ...
        AmexTransactionManager(AmexTransactionManager amexTransactionManager, ProviderTokenKey providerTokenKey, TransactionResponse transactionResponse, String str) {
            this.qK = amexTransactionManager;
            this.pd = providerTokenKey;
            this.pu = transactionResponse;
            this.pv = str;
        }

        public void m794a(int i, Response<TokenResponseData> response) {
            String str = null;
            ...
            switch (i) {
                case DisplayText.DISPLAY_TEXT_MAXIMUM_SIZE /*200*/:
                    ...
                    if (str == null || asString == null) {
                        this.qK.m799a(this.pd, this.pu);
                    } else if (this.qK.m801a(this.pd, this.pu, str, asString) != 0) {
                        Log.m286e("AmexTransactionManager", "saveTransactionData failed");
                    } else {
                        this.qK.m805b(this.pd, this.pu, this.pv);
                    }
                default:
    ...
    /* renamed from: com.samsung.android.spayfw.payprovider.amexv2.b.2 */
    class AmexTransactionManager implements AsyncNetworkHttpClient {
        ...
        final /* synthetic */ AmexTransactionManager qK;
        final /* synthetic */ AmexTransactionManager qL;
        ...
        AmexTransactionManager(AmexTransactionManager amexTransactionManager, Gson gson, TransactionResponse transactionResponse, ProviderTokenKey providerTokenKey, String str, JsonObject jsonObject, AmexTransactionManager amexTransactionManager2) {
            ...
            this.px = str;
            this.py = jsonObject;
            this.qL = amexTransactionManager2;
        }
        ...
        public void onComplete(int i, Map<String, List<String>> map, byte[] bArr) {
            ...
            switch (i) {
                ...
                case 401:
                    this.qK.pp.edit().remove(this.px + "_transaction_json_data").apply();
                    ProviderResponseData providerResponseData = new ProviderResponseData();
                    JsonObject jsonObject = new JsonObject();
                    jsonObject.add("secureDeviceData", this.py);
                    jsonObject.addProperty("tokenRefIdSignature", this.qL.pA);
    ...
    /* renamed from: com.samsung.android.spayfw.payprovider.amexv2.b.a */
    public class AmexTransactionManager {
    ...
    public static synchronized AmexTransactionManager m803a(Context context, AmexTAController amexTAController, CertificateInfo certificateInfo, SharedPreferences sharedPreferences) {
        AmexTransactionManager amexTransactionManager;
        synchronized (AmexTransactionManager.class) {
            if (qJ == null) {
                qJ = new AmexTransactionManager(context, amexTAController, certificateInfo, sharedPreferences);
            }
            amexTransactionManager = qJ;
        }
    ...
    private AmexTransactionManager(Context context, AmexTAController amexTAController, CertificateInfo certificateInfo, SharedPreferences sharedPreferences) {
        ...
        this.qA = amexTAController;
        this.pl = certificateInfo;
        this.pp = sharedPreferences;
    }

    int m806a(ProviderTokenKey providerTokenKey, Bundle bundle, TransactionResponse transactionResponse) {
        ...
        if (string == null) {
            ...
            return m799a(providerTokenKey, transactionResponse);
        }
        if (this.pp.getString(providerTokenKey.cn() + "_transaction_json_data", null) == null) {
            ...
            return m800a(providerTokenKey, transactionResponse, string);
        }
        Log.m285d("AmexTransactionManager", "get transaction data");
        return m805b(providerTokenKey, transactionResponse, string);
    }

    TransactionDetails m807a(ProviderTokenKey providerTokenKey, Object obj) {
        ...
        for (AmexTransactionData amexTransactionData : amexTransactionDataArr) {
            ...
            if (amexTransactionData.getTransactionIdentifier() == null || amexTransactionData.getTransactionIdentifier().isEmpty()) {
                transactionData.setTransactionId(m804a(amexTransactionData));
            } else {
    ...
    private String m804a(AmexTransactionData amexTransactionData) {
    ...
    private int m800a(ProviderTokenKey providerTokenKey, TransactionResponse transactionResponse, String str) {
    ...
    private JsonObject cs() {
        ...
        try {
            ...
            if (cA.deviceEncryptionCertificate != null) {
                jsonObject.addProperty("deviceEncryptionPublicKeyCert", cA.deviceEncryptionCertificate);
            }
    ...
    private int m801a(ProviderTokenKey providerTokenKey, TransactionResponse transactionResponse, String str, String str2) {
        int i = -6;
        Gson create = new GsonBuilder().disableHtmlEscaping().create();
        String cn = providerTokenKey.cn();
        try {
            String str3 = new String(Base64.decode(this.qA.m818o(str, str2), 2));
            try {
                try {
                    try {
                        this.pp.edit().putString(cn + "_transaction_json_data", this.qA.m812a(create.toJson(new AmexTransactionManager(this, str3, this.qA.m817c(this.pl.getContent(), null, str3).requestDataSignature, this.qA.m817c(this.pl.getContent(), null, cn).requestDataSignature)), true)).apply();
                        return 0;
                    } catch (Throwable e) {
                        Log.m284c("AmexTransactionManager", e.getMessage(), e);
    ...
    private int m805b(ProviderTokenKey providerTokenKey, TransactionResponse transactionResponse, String str) {
        Gson create = new GsonBuilder().disableHtmlEscaping().create();
        String cn = providerTokenKey.cn();
        ...
        try {
            AmexTransactionManager amexTransactionManager = (AmexTransactionManager) create.fromJson(this.qA.m812a(string, false), AmexTransactionManager.class);
            JsonObject cs = cs();
            if (cs == null) {
                return -6;
            }
    ...
    private int m799a(ProviderTokenKey providerTokenKey, TransactionResponse transactionResponse) {
        int i = -6;
        ...
        try {
            jsonObject.addProperty("tokenRefIdSignature", this.qA.m817c(this.pl.getContent(), null, cn).requestDataSignature);
            providerResponseData.m1057b(jsonObject);
            providerResponseData.setErrorCode(-8);
            providerResponseData.as("PAYFW_ERROR_PAY_PROVIDER_NETWORK_AUTH");
