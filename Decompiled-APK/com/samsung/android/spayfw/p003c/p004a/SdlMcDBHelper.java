...
/* renamed from: com.samsung.android.spayfw.c.a.f */
public class SdlMcDBHelper extends SdlBaseDBHelper {
    private static SdlMcDBHelper Bv;
    private static SQLiteDatabase Bw;
    private static final String TAG;

    static {
        TAG = SdlMcDBHelper.class.getSimpleName();
    }

    public static synchronized SdlMcDBHelper m298U(Context context) {
        SdlMcDBHelper sdlMcDBHelper;
        synchronized (SdlMcDBHelper.class) {
            if (Bv == null) {
                Bv = new SdlMcDBHelper(context);
            }
            sdlMcDBHelper = Bv;
        }
        return sdlMcDBHelper;
    }

    private SdlMcDBHelper(Context context) {
