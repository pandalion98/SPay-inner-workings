...
public class DefaultByteArrayFactory
extends ByteArrayFactory {
    ...
    public ByteArray convertString(String string) {
        return ByteArrayFactory.getInstance().getByteArray(string.getBytes(), string.length());
    }
    ...
    public ByteArray fromHexString(String string) {
        return new DefaultByteArrayImpl(string);
    }

    @Override
    public ByteArray getByteArray(int n2) {
        return new DefaultByteArrayImpl(n2);
    }

    @Override
    public ByteArray getByteArray(byte[] arrby, int n2) {
        return new DefaultByteArrayImpl(arrby, n2);
    }
    ...
    public ByteArray getFromWord(int n2) {
        return new DefaultByteArrayImpl(ByteBuffer.allocate((int)2).putShort((short)n2).array(), 2);
    }
