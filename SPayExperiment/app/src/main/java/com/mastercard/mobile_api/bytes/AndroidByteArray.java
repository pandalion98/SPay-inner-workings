...
public class AndroidByteArray
implements ByteArray {
    private byte[] data;
    private int length;

    public AndroidByteArray(int n2) {
        this.length = n2;
     ...
     */
    public AndroidByteArray(String string) {
        if (string == null) {
            this.length = 0;
            return;
        } else {
    ...
    public ByteArray bitWiseAnd(ByteArray byteArray) {
        ...
        AndroidByteArray androidByteArray = new AndroidByteArray(this.getLength());
        int n3 = 0;
        while (n3 < n2) {
            androidByteArray.setByte(n3, (byte)(this.data[n3] & byteArray.getByte(n3)));
            ++n3;
        }
    ...
    public ByteArray clone() {
        return new AndroidByteArray(this.getBytes());
    }
    ...
    public ByteArray copyOfRange(int n2, int n3) {
        int n4 = n3 - n2;
        return new AndroidByteArray(Arrays.copyOfRange((byte[])this.data, (int)n2, (int)n3), n4);
    }
    ...
    public ByteArray getUTF8() {
        try {
            AndroidByteArray androidByteArray = new AndroidByteArray(this.getHexString().getBytes("UTF-8"));
            return androidByteArray;
        }
    ...
    public ByteArray makeXor(ByteArray byteArray) {
        AndroidByteArray androidByteArray = new AndroidByteArray(this.getLength());
        int n2 = 0;
        while (n2 < androidByteArray.getLength()) {
            androidByteArray.setByte(n2, (byte)(this.getByte(n2) ^ byteArray.getByte(n2)));
            ++n2;
        }
        return androidByteArray;
    }
