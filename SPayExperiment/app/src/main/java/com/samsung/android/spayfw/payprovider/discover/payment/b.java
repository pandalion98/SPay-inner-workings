...
extends com.samsung.android.spayfw.payprovider.discover.payment.a {
    ...
    private com.samsung.android.spayfw.payprovider.discover.payment.data.a a(ByteBuffer byteBuffer) {
        ...
        Log.d("DCSDK_DiscoverGetDataApduHandler", stringBuilder.append(string).toString());
        if (byteBuffer == null) {
            Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, tag is null, tag.");
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27272);
        }
        if (c.A(byteBuffer)) {
            Log.i("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, profile tag found." + byteBuffer.toHexString());
            byteBuffer2 = c.a(byteBuffer, this.cM());
        } else if (c.B(byteBuffer)) {
            Log.i("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, IDDT tag found." + byteBuffer.toHexString());
            ...
            if (discoverIDDTag != null) {
                if ((64 & discoverIDDTag.getAccess()) == 64 && this.cN().dM() == null) {
                    Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, IDDT tag requested, GPO access required, but not executed");
        ...
        if (byteBuffer2 == null) {
            Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, tag data is null, tag = " + byteBuffer.toHexString());
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27272);
        }
        Log.i("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, return data for tag = " + byteBuffer.toHexString());
    ...
    public com.samsung.android.spayfw.payprovider.discover.payment.data.a cK() {
        ...
        if (this.td.dk() != 128) {
            Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, cla is not supported, cla = " + this.td.dk() + ", expected " + 128);
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(28160);
        }
        if ((255 & this.td.getINS()) != 202) {
            Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, ins is not supported, ins = " + (255 & this.td.getINS()) + ", expected " + 202);
        ...
        if (!c.w(byteBuffer)) {
            Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, tag is not supported, tag = " + byteBuffer.toHexString());
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27272);
        }
        if (this.td.dj().getByte(-1 + this.td.dj().getSize()) != 0) {
            Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, Lc != 0, Lc value " + this.td.dj().getByte(-1 + this.td.dj().getSize()));
            ByteBuffer byteBuffer2 = c.x(byteBuffer);
            if (byteBuffer2 == null) {
                Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, tag not found, Le = 0.");
                return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27648);
            }
            short s2 = (short)byteBuffer2.getSize();
            Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, return tag size, Le = " + s2);
        ...
        if (this.cM().getDiscoverApplicationData().getCLApplicationConfigurationOptions().checkBit(2, 2) && this.cN().dM() == null) {
            Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, GPO is not executed, required by CL ACO B2b2, 27013");
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27013);
        }
        if (c.y(byteBuffer)) {
            Log.d("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, counter/limit, tag = " + byteBuffer.toHexString());
            if (this.cN().dM() == null) {
                Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, GPO is not executed, return 27013");
                return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27013);
            }
            if (this.cM().getCaco().checkBit(1, 1)) {
                Log.i("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, tag is retrievable, return tag = " + byteBuffer.toHexString());
                return this.a(byteBuffer);
            }
            Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, tag is not retrievable, tag = " + byteBuffer.toHexString());
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27013);
        }
        Log.d("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, check IDDT tag...");
        if (!c.z(byteBuffer)) {
            Log.i("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, not IDD tag, return tag = " + byteBuffer.toHexString());
            return this.a(byteBuffer);
        }
        if (this.cM().getDiscoverApplicationData().getCLApplicationConfigurationOptions().checkBit(2, 5)) {
            Log.i("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, IDD tag & IDDT enabled, return tag = " + byteBuffer.toHexString());
            return this.a(byteBuffer);
        }
        Log.e("DCSDK_DiscoverGetDataApduHandler", "processApdu, C-APDU GET DATA, IDD tag & IDDT disabled, tag = " + byteBuffer.toHexString());
        return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27013);
    }
}
