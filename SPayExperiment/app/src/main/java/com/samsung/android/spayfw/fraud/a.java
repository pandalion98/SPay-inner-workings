...
public class a {
    ...
    public final void W(String string) {
        ...
        if (nc.a(a2) > 0L) {
            com.samsung.android.spayfw.b.c.d("FraudDataCollector", "add a new " + string + " record");
            return;
        }
    ...
    public void X(String string) {
        ...
        com.samsung.android.spayfw.b.c.d("FraudDataCollector", "add a new provision attempts " + l3);
    }
    ...
    public final void a(EnrollCardInfo enrollCardInfo, BillingInfo billingInfo) {
        ...
        com.samsung.android.spayfw.b.c.d("FraudDataCollector", "name is |" + string7 + "|");
        ...
        com.samsung.android.spayfw.b.c.d("FraudDataCollector", "first name is |" + string2 + "|");
        com.samsung.android.spayfw.b.c.d("FraudDataCollector", "last name is |" + string3 + "|");
    ...
    public final void e(PaymentDetailsRecord paymentDetailsRecord) {
        ...
        long l2 = nc.a(b2);
        com.samsung.android.spayfw.b.c.d("FraudDataCollector", "storeFTransactionDetail: add a new transaction detail row " + l2 + ": " + b2.toString());
    }
    ...
    public void k(String string, String string2) {
        ...
        com.samsung.android.spayfw.b.c.d("FraudDataCollector", "find " + l2 + " token");
    }
