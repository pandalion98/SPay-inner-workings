...
public class MCAPDUConstants {
    static final byte ATC_LEN = 2;
    static final byte CDA_DDA_HEADER = 106;
    static final byte CDA_DDA_TRAILER = -68;
    static final byte CDA_PADDING_BYTE = -69;
    public static final int CHECK_CONTEXT_POSCII_CONTEXT_CONFLICT_VALUE = 8;
    static final byte ICCDN_LEN = 16;
    static final byte MIN_PROFILE_LEN = 15;
    static final ByteArray PPSE_AID = ByteArrayFactory.getInstance().fromHexString("325041592E5359532E4444463031");
    static final int SET_CONTEXT_RESPONSE_LEN = 33;

    public static final class MCCommandCCCConstants {
        static final byte CCC_CLA = -128;
        ...
        static final byte CCC_MOBILE_SUPPORT_INDICATOR = 1;
    ...
    public static final class MCCommandGACConstants {
        ...
        static final byte DAD_HASH_ALGORITHM_INDICATOR = 1;
        static final byte DAD_ICC_DYNAMIC_DATA_LENGTH = 38;
        static final byte DAD_ICC_DYNAMIC_RRP_DATA_LENGTH = 52;
        static final byte DAD_SIGNED_DATA_FORMAT = 5;
        static final byte GAC_CLA = -128;
        ...
        static final byte GENAC_CVR_RRP_NOT_PERFORMED = 64;
        ...
        static final byte GENAC_TVR_RRP_NOT_PERFORMED = 1;
        static final byte GENAC_TVR_RRP_PERFORMED = 2;
    ...
    public static final class MCCommandGPOConstants {
        ...
        static final short GPO_AIP_BYTE1_POSITION = 4;
        static final byte GPO_AIP_LENGTH_LC_3 = 2;
        static final int GPO_AIP_LENGTH_LC_D = 2;
        static final short GPO_AIP_MASK = -129;
        static final byte GPO_AIP_OFFSET_LC_3 = 4;
        static final int GPO_AIP_OFFSET_LC_D = 4;
        static final byte GPO_CLA = -128;
        static final int GPO_LC_3 = 3;
        static final int GPO_LC_D = 13;
        static final byte GPO_TEMPLATE_TYPE_3_LENGTH = 1;
        static final byte GPO_TEMPLATE_TYPE_3_TAG = -125;
        static final byte GPO_TEMPLATE_TYPE_D_LENGTH = 11;
        static final byte GPO_TEMPLATE_TYPE_D_TAG = -125;
        ...
        static final short TERMINAL_COUNTRY_CODE_1 = 2112;
    }

    public static final class MCCommandRRConstants {
        static final byte READ_RECORD_BAD_P1 = 0;
        static final byte READ_RECORD_BAD_P2_AFTER_MASK = 4;
        static final byte READ_RECORD_CLA = 0;
        static final byte READ_RECORD_NOT_FOUND = -1;
        static final byte READ_RECORD_P2_MASK = 7;
    }

    public static final class MCCommandRRPConstants {
        static final byte RRP_CLA = -128;
        static final byte RRP_LC = 4;
        static final byte RRP_MAX_COUNTER = 3;
        static final byte RRP_RSP_TAG = -128;
        static final byte RRP_RSP_TAG_LENGTH = 10;
    }

    public static final class MCCommandSELECTConstants {
        static final byte SELECT_CLA = -128;
        static final byte SELECT_P1 = 4;
        static final byte SELECT_P2;
        static final byte SELECT_PPSE_CLA;
    }
    ...
    public static final class MCFilterConstants {
        ...
        public static final class UK {
            ...
            static {
                ...
                ByteArray[] arrbyteArray = new ByteArray[]{ByteArrayFactory.getInstance().fromHexString("4111"), ByteArrayFactory.getInstance().fromHexString("4131"), ByteArrayFactory.getInstance().fromHexString("4784")};
                MCC_LIST = arrbyteArray;
            }
        }
