...
extends h {
    ...
    protected float by() {
        ...
        int n4 = b.a(b2, list4);
        int n5 = b.b(b2, list3);
        Log.d("SimpleRiskScoreV1", "matchingNameCount=" + n2 + ", nonmatchingNameCount=" + n3 + ", matchingAddressCount= " + n4 + ", nonmatchingAddressCount= " + n5);
        if (n4 >= 2) {
            arrn[5] = 1 + arrn[5];
        } else if (n4 == 1) {
            arrn[4] = 1 + arrn[4];
        ...
        int n6 = b.ag("24 hour");
        Log.d("SimpleRiskScoreV1", "recent provisioning attempts: " + n6);
        if (n6 >= 6) {
            arrn[2] = 1 + arrn[2];
        }
        if (n6 >= 9) {
        ...
        int n7 = b.ah("7 day");
        Log.d("SimpleRiskScoreV1", "recent reset count: " + n7);
        if (n7 > 2) {
            arrn[2] = 1 + arrn[2];
        }
        if (n7 > 10) {
        ...
        int n8 = b.ai("6 month");
        Log.d("SimpleRiskScoreV1", "6 month token count: " + n8);
        if (n8 > 0) {
            arrn[4] = 1 + arrn[4];
        }
        int n9 = b.ai("12 month");
        Log.d("SimpleRiskScoreV1", "12 month token count: " + n9);
        if (n9 > 0) {
            arrn[5] = 1 + arrn[5];
        }
        ...
        for (int i2 = 0; i2 < arrn.length; ++i2) {
            Log.d("SimpleRiskScoreV1", "bucket[" + i2 + "] = " + arrn[i2]);
        }
        if (arrn[1] >= 2) {
            return 1.0f;
        }
