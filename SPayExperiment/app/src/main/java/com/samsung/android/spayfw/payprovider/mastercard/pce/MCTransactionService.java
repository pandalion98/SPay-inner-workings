...
public class MCTransactionService {
    ...
    public boolean authenticateTransaction(SecuredObject securedObject) {
        if (securedObject != null && securedObject.getSecureObjectData() != null) {
            Log.i(TAG, "Obtained so, start transaction authentication.");
            long l2 = this.mMCController.authenticateTransaction(securedObject.getSecureObjectData());
            Log.i(TAG, "authenticateTransaction: authentication result: " + l2);
            long l3 = l2 LCMP 0L;
            boolean bl = false;
            if (l3 == false) {
                bl = true;
        ...
        Log.e(TAG, "authenticateTransaction: authentication failed, secure object not found. Unload TA.");
        return false;
    }
    ...
    public int getIssuerCountryCode(f f2) {
        ...
        try {
            ...
            Log.d(TAG, "getIssuerCountryCode: CrmCountry : " + Integer.toHexString((int)n2));
            return n2;
        }
        catch (NullPointerException nullPointerException) {
            nullPointerException.printStackTrace();
            Log.c(TAG, "Exception CRM!!!!", nullPointerException);
            return -1;
        }
    }
    ...
    public DSRPOutputData getPayInfoData(DSRPInputData dSRPInputData) {
        ...
        if (this.mCurrentCard != null) {
            if (!this.mCurrentCard.isReadyForRPTransaction()) {
                Log.e(TAG, "getPayInfoData: MC card profile doesn't support in-app transaction.");
                return null;
            }
            Log.e(TAG, "getPayInfoData: start remote payment transaction.");
            return this.mCurrentCard.getPayInfoData(dSRPInputData);
        }
        Log.e(TAG, "getPayInfoData: card is null, not selected.");
        return null;
    }

    public void initTransaction(boolean bl) {
        Log.i(TAG, "initTransaction is authenticated " + bl);
        if (this.mCurrentCard == null) {
            Log.e(TAG, "initTransaction: card not selected!!! ");
            return;
        }
        if (!bl) {
    ...
    public void interruptMstPay() {
        Log.i(TAG, "MCProvider: interruptMstPay");
        this.mMCController.abortMstTransmission();
    }

    public boolean isDSRPSupportedByProfile() {
        if (this.mCurrentCard == null) {
            Log.e(TAG, "MCProvider: isDSRPSupportedByProfile: current card is not selected.");
            return false;
        }
    ...
    public boolean isDSRPSupportedByProfile(f f2) {
        ...
        try {
            ...
            Log.c(TAG, string, (Throwable)((Object)mTBPPaymentException));
            return false;
        }
    ...
    public boolean isMSTSupportedByProfile(f f2) {
        Log.i(TAG, "MCProvider: isMSTTransactionSupported");
        if (f2 == null) {
            Log.e(TAG, "MCProvider: providerTokenKey is null");
            return false;
        }
        if (this.mDao == null) {
            this.mDao = new McCardProfileDaoImpl(McProvider.getContext(), (Type)DC_CP.class);
        ...
        try {
            ...
            Log.e(TAG, "MCProvider: dao access exception: " + exception.getMessage());
            exception.printStackTrace();
            return false;
        }
        Log.e(TAG, "MCProvider: isMSTTransactionSupported: profiles table is null.");
        return false;
    }

    public void loadTA() {
        Log.i(TAG, "MCProvider: load MC TA");
        if (!this.mMCController.loadTA()) {
            Log.e(TAG, "MC TA loading failed");
        }
    }
    ...
    public boolean prepareMstPay() {
        if (this.mCurrentCard != null && this.mCurrentCard.isReadyForMSTTransaction()) {
            if (this.mCurrentCard.prepareMSTData() != 0L) {
                Log.e(TAG, "prepareMstPay: MST prepareMSTData failed.");
                return false;
            }
            Log.i(TAG, "prepareMstPay: MST prepareMSTData success.");
            return true;
        }
        Log.e(TAG, "prepareMstPay: the card is not found or not ready for the MST payment.");
        return false;
    }

    public byte[] processApdu(byte[] arrby, Bundle bundle) {
        if (this.mCurrentCard == null) {
            Log.e(TAG, "processApdu: Card not found. Activation failed.");
    ...
    public SelectCardResult selectCard(f var1_1) {
        ...
        try {
            Log.e("mcpce_MCTransactionService", "selectCard: invalid tokenRefId.");
            return var2_2;
lbl6: // 1 sources:
            Log.i("mcpce_MCTransactionService", "selectCard: Id :" + var1_1.cm());
            this.mCurrentCard = this.getDigitalizedCard(var1_1.cm());
            var5_3 = this.mCurrentCard.getCardProfile();
            if (var5_3 == null) {
                Log.e("mcpce_MCTransactionService", "selectCard: invalid card profile.");
                return var2_2;
            }
            if (var5_3.getDigitalizedCardContainer() == null) {
                Log.e("mcpce_MCTransactionService", "selectCard: invalid card profile Contactless");
                return var2_2;
            }
            if (var5_3.getTADataContainer() == null) {
                Log.e("mcpce_MCTransactionService", "selectCard: invalid card profile TA");
                return var2_2;
            }
            var6_4 = McTAController.getTaid();
            if (var6_4 == null) {
                Log.e("mcpce_MCTransactionService", "Cannot find TA id for the MC TA.");
                return var2_2;
            }
            if (this.mMCController.isTALoaded()) {
                var7_5 = this.mMCController.getNonce(var5_3.getTADataContainer(), var5_3.getTaAtcContainer());
                if (var7_5 != null) {
                    Log.i("mcpce_MCTransactionService", "MC TA nonce len: " + var7_5.length);
                    var2_2.setNonce((byte[])var7_5.clone());
                    var2_2.setTaid(var6_4);
                    return var2_2;
                }
                Log.e("mcpce_MCTransactionService", "MC TA Controller getNonce() failed. Unload TA.");
                this.mMCController.unloadTA();
                return var2_2;
            }
            Log.e("mcpce_MCTransactionService", "selectCard: MC TA is not loaded.");
            return var2_2;
        }
        catch (MTBPPaymentException var3_6) {
            var4_7 = "selectCard: Id " + var1_1 == null ? "null" : var1_1.cn();
            Log.c("mcpce_MCTransactionService", var4_7, (Throwable)var3_6);
            return var2_2;
        }
    }
    ...
    public boolean startMstPay(int n2, byte[] arrby) {
        ...
        if (mCBaseCardProfile == null || mCBaseCardProfile.getTADataContainer() == null) {
            Log.e(TAG, "startMstPay: invalid card profile.");
            return false;
        }
    ...
    public void unloadTA() {
        Log.i(TAG, "MCProvider: start unload MC TA");
    ...
    public void validateAlternateProfile(f f2) {
        ...
        try {
            ...
            if (mCProfilesTable.getTAProfileReference(MCProfilesTable.TAProfile.PROFILE_CL_ALT_TA_GAC_DECLINE_NO_CVM) == 0 || mCProfilesTable.getTAProfileReference(MCProfilesTable.TAProfile.PROFILE_CL_ALT_TA_GAC_ONLINE_NO_CVM) == 0) {
                Log.e(TAG, "validateAlternateProfile: alternate profile is not supported in the profile table.");
                return;
            }
            DC_CP_MPP dC_CP_MPP = dC_CP.getDC_CP_MPP();
            if (dC_CP_MPP == null) {
                Log.e(TAG, "validateAlternateProfile: dc_cp_mpp is null.");
                return;
            }
            ContactlessPaymentData contactlessPaymentData = dC_CP_MPP.getContactlessPaymentData();
            if (contactlessPaymentData == null) {
                Log.e(TAG, "validateAlternateProfile: contactless payment data is null.");
                return;
            }
            Log.i(TAG, "validateAlternateProfile: fillAlternatePaymentData...");
            if (!McCardClearData.fillAlternateProfile(contactlessPaymentData)) {
                Log.e(TAG, "validateAlternateProfile: alternate profile is not supported...");
                return;
            }
            ...
            Log.i(TAG, "validateAlternateProfile: updateData...: " + bl);
            byte[] arrby = mCBaseCardProfile.getTADataContainer();
            if (arrby == null) {
                Log.e(TAG, "validateAlternateProfile: secure object is null for tokenId = " + f2.cm());
                return;
            }
            try {
                byte[] arrby2 = this.mMCController.copyACKey(arrby);
                if (arrby2 != null) {
                    Log.i(TAG, "validateAlternateProfile: update secure data...");
                    mcCardProfileDaoImpl.updateTaData(arrby2, f2.cm());
                    Log.i(TAG, "validateAlternateProfile: profile has been updated.");
                    return;
                }
                Log.e(TAG, "validateAlternateProfile: updated secure profile is null...");
                return;
            }
            catch (Exception exception) {
                Log.e(TAG, "validateAlternateProfile: cannot get MCTAController: " + exception.getMessage());
                exception.printStackTrace();
                return;
            }
        }
    ...
    public void validateDSRPProfile(f f2) {
        ...
        block14 : {
            try {
                ...
                if (mCBaseCardProfile == null) {
                    Log.e(TAG, "validateDSRPProfile: cannot find card profile.");
                    return;
                }
                MCProfilesTable mCProfilesTable = mCBaseCardProfile.getTAProfilesTable();
                if (mCProfilesTable == null) {
                    Log.e(TAG, "validateDSRPProfile: profiles table is null.");
                    return;
                }
                if (!mCProfilesTable.isDSRPProfileExist()) {
                    Log.e(TAG, "validateDSRPProfile: DSRP secure profiles are not supported.");
                    return;
                }
            }
            catch (MTBPPaymentException mTBPPaymentException) {
                Log.c(TAG, "validateDSRPProfile: Id " + f2.cn(), (Throwable)((Object)mTBPPaymentException));
                return;
            }
            dC_CP = (DC_CP)mCBaseCardProfile.getDigitalizedCardContainer();
            if (dC_CP == null) {
                Log.e(TAG, "validateDSRPProfile: dc_cp is null.");
                return;
            }
            dC_CP_MPP = dC_CP.getDC_CP_MPP();
            if (dC_CP_MPP == null) {
                Log.e(TAG, "validateDSRPProfile: dc_cp_mpp is null.");
                return;
            }
            RemotePaymentData remotePaymentData2 = dC_CP_MPP.getRemotePaymentData();
            if (remotePaymentData2 == null) {
                Log.i(TAG, "validateDSRPProfile: add remote payment data.");
        ...
        Log.i(TAG, "validateDSRPProfile: fillRemotePaymentData...");
        ...
        if (list != null && !list.isEmpty()) {
            ...
            Log.d(TAG, "validateDSRPProfile: PAR..." + remotePaymentData.getPaymentAccountReference());
        }
        dC_CP_MPP.setRemotePaymentData(remotePaymentData);
        Log.i(TAG, "validateDSRPProfile: updateData...");
        Type type = new TypeToken<DC_CP>(){}.getType();
        boolean bl = new McCardProfileDaoImpl(McTokenManager.getContext(), type).updateData(mCBaseCardProfile, f2.cm());
        Log.i(TAG, "validateDSRPProfile: profile has been updated :" + bl);
    }
