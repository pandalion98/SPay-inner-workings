...
public interface ISelectCardCallback
extends IInterface {
    public void onFail(String var1, int var2);

    public void onSuccess(String var1, SelectCardResult var2);

    public static abstract class Stub
    extends Binder
    implements ISelectCardCallback {
        ...
        public static ISelectCardCallback asInterface(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof ISelectCardCallback) {
                return (ISelectCardCallback)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) {
            switch (n2) {
                ...
                case 1: {
                    ...
                    SelectCardResult selectCardResult = parcel.readInt() != 0 ? (SelectCardResult)SelectCardResult.CREATOR.createFromParcel(parcel) : null;
                    this.onSuccess(string, selectCardResult);
                    return true;
                }
                case 2: 
            }
            ...
            public void onSuccess(String string, SelectCardResult selectCardResult) {
                ...
                try {
                    ...
                    if (selectCardResult != null) {
                        parcel.writeInt(1);
                        selectCardResult.writeToParcel(parcel, 0);
                    } else {
                        parcel.writeInt(0);
                    }
