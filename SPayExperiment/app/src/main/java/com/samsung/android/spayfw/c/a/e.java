...
extends a {
    ...
    public static e T(Context context) {
        if (Bu == null) {
            Bu = new e(context.getApplicationContext());
        }
        return Bu;
    }
    ...
    public void onConfigure(SQLiteDatabase sQLiteDatabase) {
        if (!sQLiteDatabase.isReadOnly()) {
            ...
            Log.i((String)"SdlFraudDBHelper", (String)"FOREIGN KEY constraint enabled");
        }
    }
    ...
    public void onCreate(SQLiteDatabase sQLiteDatabase) {
        try {
            if (sQLiteDatabase.isOpen()) {
                ...
                Log.i((String)"SdlFraudDBHelper", (String)"second database is created");
            }
            return;
        }
        catch (Exception exception) {
            Log.e((String)"SdlFraudDBHelper", (String)"Database is not fully created, any schema error?");
            Log.e((String)"SdlFraudDBHelper", (String)exception.getMessage(), (Throwable)exception);
            return;
        }
    }
    ...
    public void onDowngrade(SQLiteDatabase sQLiteDatabase, int n2, int n3) {
        Log.d((String)"SdlFraudDBHelper", (String)"cannot downgrade the db");
    }
    ...
    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int n2, int n3) {
        Log.d((String)"SdlFraudDBHelper", (String)("upgrade second database from version " + n2 + " to version " + n3));
        if (n2 == n3) {
            Log.i((String)"SdlFraudDBHelper", (String)"no need to upgrade second db");
            return;
        } else {
            if (n2 > n3) {
                Log.e((String)"SdlFraudDBHelper", (String)"database cannot be downgraded, please update to the latest version");
                return;
            }
            if (n2 <= 2) {
            ...
            if (n2 != 3) return;
            {
                Log.d((String)"SdlFraudDBHelper", (String)"This is the current version");
                return;
            }
        }
    }
