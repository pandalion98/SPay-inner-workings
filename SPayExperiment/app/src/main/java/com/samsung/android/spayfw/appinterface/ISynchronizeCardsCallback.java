...
public interface ISynchronizeCardsCallback
extends IInterface {
    public void onFail(String var1, int var2);

    public void onSuccess(String var1, List<CardState> var2);

    public static abstract class Stub
    extends Binder
    implements ISynchronizeCardsCallback {
        ...
        public static ISynchronizeCardsCallback asInterface(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof ISynchronizeCardsCallback) {
                return (ISynchronizeCardsCallback)iInterface;
            }
        ...
        public boolean onTransact(int n2, Parcel parcel, Parcel parcel2, int n3) {
            switch (n2) {
                ...
                case 1: {
                    ...
                    this.onSuccess(parcel.readString(), (List)parcel.createTypedArrayList(CardState.CREATOR));
                    return true;
                }
                case 2: 
            }
