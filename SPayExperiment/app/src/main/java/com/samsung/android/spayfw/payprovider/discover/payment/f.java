...
extends com.samsung.android.spayfw.payprovider.discover.payment.a {
    ...
    private int c(ByteBuffer byteBuffer) {
        if (byteBuffer == null) {
            Log.e("DCSDK_", "findAliasAid, aid is null.");
            return -1;
        }
        List<ByteBuffer> list = this.cM().getAliasList();
        if (list == null || list.isEmpty()) {
            Log.e("DCSDK_", "findAliasAid, alias list is empty.");
            return -1;
        }
        int n2 = 0;
        while (n2 < list.size()) {
    ...
    public boolean a(ByteBuffer var1_1, ByteBuffer var2_2) {
        if (this.cM().getFciPpse() == null) {
            Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select, checkAidInAdf PPSE FCI is null.");
            return false;
        }
        if (var2_2 == null) {
            Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select, checkAidInAdf FCI is null.");
            return false;
        }
        ...
        if (var9_5 == null || var9_5.isEmpty() || var9_5.get(0) == null) {
            Log.e("DCSDK_", "checkAidInAdf, fci template list is empty.");
            return false;
        }
        var10_6 = a.c(((ByteBuffer)var9_5.get(0)).getBytes(), 0, ((ByteBuffer)var9_5.get(0)).getSize());
        Log.d("DCSDK_", "checkAidInAdf, returned parsed proprietaryTemplate.");
        if (var10_6 != null && var10_6.O(c.vP.getInt()) != null) {
            ...
            if (var11_7 == null || var11_7.isEmpty() || var11_7.get(0) == null) {
                Log.e("DCSDK_", "checkAidInAdf, df not found empty.");
                return false;
            }
        ...
        if (var5_8 == null) {
            Log.e("DCSDK_", "checkAidInAdf, df is null.");
            return false;
        }
        var6_9 = var5_8.toHexString();
        Log.i("DCSDK_", "checkAidInAdf, df: " + var6_9);
    ...
    public com.samsung.android.spayfw.payprovider.discover.payment.data.a cK() {
        ...
        Log.d("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select start...");
        if (this.td.dk() != 0) {
            Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select, cla is not supported, cla = " + this.td.dk() + ", expected " + 0);
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(28160);
        }
        if (this.td.getINS() != -92) {
            Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select, ins is not supported, ins = " + this.td.getINS() + ", expected " + -92);
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27904);
        }
        if (this.td.getP1() != 4) {
            Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select, wrong p1, p1 = " + this.td.getP1() + ", expected " + 4);
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27270);
        }
        if (this.td.getP2() != 0 && this.td.getP2() != 2) {
            Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select, wrong p2, p2 = " + this.td.getP2() + ", expected " + 0 + " or " + 2);
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27270);
        }
        ...
        if (byteBuffer2 == null || this.td.getLc() != byteBuffer2.getSize()) {
            ...
            Log.e("DCSDK_DiscoverSelectApduHandler", stringBuilder.append((Object)n2).toString());
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(26368);
        }
        if (this.td.dl() != 0) {
            Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select, wrong Le = " + this.td.dl() + ", expected Le  = " + 0);
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(26368);
        }
        if (this.cM() == null) {
            Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Payment profile not found.");
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27266);
        }
        Log.i("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select aid = " + byteBuffer2.toHexString());
        if (byteBuffer2.toHexString().startsWith(DiscoverCLTransactionContext.ui.toHexString())) {
            Log.i("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select ppse aid");
            ...
            Log.i("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select emv aid");
            ...
            Log.i("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select zip aid");
            ...
            Log.i("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select emv debit aid");
            ...
            if (this.cM().getFciAltAid() == null) {
                Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select, not supported aid, aid = " + byteBuffer2.toHexString());
                return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27266);
            }
            Log.d("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select alt aid: " + byteBuffer2.toHexString());
            HashMap<String, ByteBuffer> hashMap = this.cM().getFciAltAid();
            if (hashMap == null) {
                Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select alt aid list is empty.");
                return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27266);
            }
            Log.i("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Alt FCI selected");
            ...
            for (DiscoverCLTransactionContext.DiscoverClTransactionType discoverClTransactionType : DiscoverCLTransactionContext.DiscoverClTransactionType.values()) {
                ...
                Log.d("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Alt AID found " + discoverClTransactionType.name());
                this.cN().a(discoverClTransactionType);
            }
            if (this.cN().dK() == null) {
                Log.i("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Alt AID unknown alias, set to emv.");
                this.cN().a(DiscoverCLTransactionContext.DiscoverClTransactionType.uj);
            }
            byteBuffer = byteBuffer5;
        }
        if (byteBuffer == null) {
            Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU fci is null.");
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27266);
        }
        Log.d("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select fci = " + byteBuffer.toHexString());
        if (!byteBuffer2.equals(DiscoverCLTransactionContext.ui) && !this.a(byteBuffer2, byteBuffer)) {
            Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select, aid not found in adf, aid = " + byteBuffer2.toHexString());
            return new com.samsung.android.spayfw.payprovider.discover.payment.data.a(27266);
        }
        ...
        if (list != null && !list.isEmpty() && list.contains((Object)byteBuffer2)) {
            Log.e("DCSDK_DiscoverSelectApduHandler", "processApdu, C-APDU Select, aid found in the blocked list: " + byteBuffer2.toHexString());
