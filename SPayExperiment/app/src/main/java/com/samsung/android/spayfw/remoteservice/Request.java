...
public abstract class Request<U, V, W extends c<V>, T extends Request<U, V, W, T>> {
    ...
    private void b(int n2, Map<String, List<String>> map, byte[] arrby) {
        ...
        if (string != null && !string.isEmpty()) {
            ...
            if (AD && !this.Au) {
                AE.add((Object)this);
                com.samsung.android.spayfw.b.c.i(this.TAG, "runUnattestedFlow: req added in queue : " + this.getRequestType());
                // MONITOREXIT : object2
                return;
            }
            AD = true;
        ...
        if (this.Ay != null && this.Az != null) {
            ...
            com.samsung.android.spayfw.b.c.d(this.TAG, "casd : " + string2);
            if (string2 != null && !string2.isEmpty()) {
                com.samsung.android.spayfw.b.c.d(this.TAG, "mCallback : " + this.Aq);
        ...
        com.samsung.android.spayfw.b.c.d(this.TAG, "serverCertsHash : " + string3);
        if (string3 != null && !string3.isEmpty()) {
            ...
            if (arrby != null) {
                ...
                if (n3 > 0) {
                    ...
                    com.samsung.android.spayfw.b.c.d(this.TAG, "TR Response : " + string4);
        ...
        try {
            ...
            com.samsung.android.spayfw.b.c.c(this.TAG, exception.getMessage(), exception);
            return;
        }
    }
        ...
        if (this.Ao == null) {
            this.Ao = new Client.HttpRequest.a(){
                ...
                public void a(int var1_1, Map<String, List<String>> var2_2, byte[] var3_3) {
                    block20 : {
                        try {
                            com.samsung.android.spayfw.b.c.i(Request.b(Request.this), "TR Response : " + var1_1);
                            if (var1_1 != 401 || var3_3 == null) ** GOTO lbl20
                        }
lbl4: // 3 sources:
                        catch (Exception var4_8) {
                            com.samsung.android.spayfw.b.c.c(Request.b(Request.this), "onResponse", var4_8);
                        ...
                        com.samsung.android.spayfw.b.c.e(Request.b(Request.this), "TR Response : " + var16_4);
                        ...
                        Request.a(Request.this, Request.this.e(var1_1, var16_4));
                        {
                                ...
                                com.samsung.android.spayfw.b.c.e(Request.b(Request.this), var17_7.getMessage());
                            }
lbl20: // 3 sources:
                            if (var1_1 == 412) {
...
lbl22: // 1 sources:
                                ...
                                com.samsung.android.spayfw.b.c.e(Request.b(Request.this), "TR Response : HEADER_PF_VERSION : " + var15_6);
                                break block20;
                            }
...
lbl30: // 1 sources:
                        if (var1_1 == 409) {
                            if (var3_3 != null) {
                                ...
                                com.samsung.android.spayfw.b.c.e(Request.b(Request.this), "TR Response : " + var13_9);
                                Request.a(Request.this, Request.this.b(var1_1, var13_9));
                            }
                        } else if (var1_1 == 503) {
                            var6_10 = Request.c(var2_2, "Retry-After");
                            com.samsung.android.spayfw.b.c.e(Request.b(Request.this), "TR Response ::onFailure : retry-after = " + var6_10);
                            ...
                            if (var3_3 != null) {
                                ...
                                com.samsung.android.spayfw.b.c.e(Request.b(Request.this), "TR Response Error: " + var7_11);
                                Request.a(Request.this, Request.this.e(var1_1, var7_11));
                            }
                        } else {
                            var9_12 = Request.c(var2_2, "PF-Version");
                            com.samsung.android.spayfw.b.c.d(Request.b(Request.this), "TR Response : HEADER_PF_VERSION : " + var9_12);
                            if (var3_3 != null) {
                                var10_13 = new String(var3_3);
                                com.samsung.android.spayfw.b.c.d(Request.b(Request.this), "TR Response : " + var10_13);
                                Request.a(Request.this, Request.this.b(var1_1, var10_13));
                                var12_14 = Request.c(var2_2, "Server-Tokens");
                                com.samsung.android.spayfw.b.c.d(Request.b(Request.this), "TR Response : HEADER_SERVER_TOKENS : " + var12_14);
                                if (var12_14 != null) {
                    ...
                    com.samsung.android.spayfw.b.c.d(Request.b(Request.this), "mCallback : " + Request.c(Request.this));
                    if (Request.c(Request.this) == null) return;
                ...
                public void a(IOException iOException) {
                    com.samsung.android.spayfw.b.c.e(Request.this.TAG, "TR Response : " + (Object)iOException.getClass());
    ...
    private void eX() {
        ...
        com.samsung.android.spayfw.b.c.i(this.TAG, "UserAgent : " + this.Av);
        for (String string : this.Ax.keySet()) {
            this.An.be(string);
            com.samsung.android.spayfw.b.c.d(this.TAG, string + " : " + (String)this.Ax.get((Object)string));
        ...
        com.samsung.android.spayfw.b.c.d(this.TAG, "Attestation-Blob : " + this.Ap);
        if (this.Ap != null && !this.Ap.isEmpty()) {
            this.An.setHeader("Attestation-Blob", this.Ap);
        }
        com.samsung.android.spayfw.b.c.d(this.TAG, "Server-Cert-Id : " + this.AA);
        if (this.AA != null) {
            this.An.setHeader("Server-Cert-Id", this.AA);
        }
        com.samsung.android.spayfw.b.c.d(this.TAG, "Device-Huid : " + this.Ay);
        if (this.Ay != null && !this.Ay.isEmpty()) {
            this.An.setHeader("Device-Huid", this.Ay);
        }
        com.samsung.android.spayfw.b.c.d(this.TAG, "Device-Hpk : " + this.Az);
        if (this.Az != null && !this.Az.isEmpty()) {
            this.An.setHeader("Device-Hpk", this.Az);
        }
        this.AB = this.Am.getRequestId();
        com.samsung.android.spayfw.b.c.d(this.TAG, "Request-Id : " + this.AB);
    ...
    public final void a(a<W, T> a2) {
        ...
        com.samsung.android.spayfw.b.c.d(this.TAG, "execute: data connection state: " + bl);
        if (!bl) {
        ...
        block22 : {
            block23 : {
                ...
                block14 : do {
                    ...
                    com.samsung.android.spayfw.b.c.d(this.TAG, "Fetching Card Art for Url: " + var6_6.getUrl());
                    if (var6_6.getUrl() != null) {
                        if (!var2_2.b(var6_6.getUrl(), var8_8)) break;
                        com.samsung.android.spayfw.b.c.d(this.TAG, "Card art Successfully retrieved and stored in " + var8_8.getAbsolutePath() + " Size: " + var8_8.length());
...
lbl19: // 11 sources:
                ...
                com.samsung.android.spayfw.b.c.e(this.TAG, "Trying old method for fetching card arts ");
            ...
            com.samsung.android.spayfw.b.c.e(this.TAG, "Failed retrieving card art data : " + var9_9.code());
            var8_8.delete();
        ...
        try {
            ...
            com.samsung.android.spayfw.b.c.c(this.TAG, var16_15.getMessage(), var16_15);
        }
        ** GOTO lbl19
...
lbl50: // 2 sources:
            do {
                com.samsung.android.spayfw.b.c.c(this.TAG, var12_11.getMessage(), (Throwable)var12_11);
                if (var11_10 == null) ** GOTO lbl19
                try {
                    var11_10.close();
                }
                catch (IOException var15_14) {
                    com.samsung.android.spayfw.b.c.c(this.TAG, var15_14.getMessage(), var15_14);
                }
                ** continue;
                break;
            } while (true);
...
lbl66: // 4 sources:
                do {
                    ...
                    com.samsung.android.spayfw.b.c.c(this.TAG, var14_19.getMessage(), var14_19);
                    ** continue;
                }
                break;
            } while (true);
    ...
    protected String aT(String var1_1) {
        com.samsung.android.spayfw.b.c.d(this.TAG, "writeStringToFile");
        var2_2 = this.eC();
        com.samsung.android.spayfw.b.c.d(this.TAG, "File = " + (Object)var2_2);
...
lbl-1000: // 2 sources:
        {
            com.samsung.android.spayfw.b.c.e(this.TAG, "Exception when writing string to file");
            return var7_5;
        }
    }
    ...
    public final void b(a<W, T> a2) {
        boolean bl = this.Am.eQ();
        com.samsung.android.spayfw.b.c.d(this.TAG, "executeSync: data connection state: " + bl);
        if (!bl) {
    ...
    protected String eU() {
        ...
        if (string != null) {
            com.samsung.android.spayfw.b.c.d(this.TAG, "getAbsoluteUrl : baseURL is " + string);
    ...
    W eW() {
        ...
        synchronized (object2) {
            if (AD && this.Ap == null && !this.Au) {
                AE.add((Object)this);
                com.samsung.android.spayfw.b.c.i(this.TAG, "executeInternal : req added in queue : " + this.getRequestType());
                W w3 = this.At;
                return w3;
            }
        }
        ...
        com.samsung.android.spayfw.b.c.i(this.TAG, "executeInternal : " + this.getRequestType());
        com.samsung.android.spayfw.b.c.d(this.TAG, "requestUrl : " + string);
        if (string == null) {
            ...
            this.eX();
            this.eV();
            com.samsung.android.spayfw.b.c.d(this.TAG, "TR Request : mRequestData" + this.As);
            String string2 = this.j(this.As);
            com.samsung.android.spayfw.b.c.d(this.TAG, "TR Request : requestDataString" + string2);
            this.Aw = 1 + this.Aw;
