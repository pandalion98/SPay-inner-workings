...
implements MCBaseDigitalizedCard {
    ...
    public void clearContext() {
        if (this.mMppLite != null) {
            Log.i("mcpce_MCTransactionService", "cleanContext: clean transaction context.");
            this.mMppLite.cleanTransactionContext();
            return;
        }
        Log.e("mcpce_MCTransactionService", "cleanContext: transaction context not exist.");
    }
    ...
    public DSRPOutputData getPayInfoData(DSRPInputData dSRPInputData) {
        Log.i("mcpce_MCTransactionService", "MTBP card: getPayInfoData");
        if (this.mMppLite != null && this.mMppLite.isReadyForTransaction()) {
            Log.d("mcpce_MCTransactionService", "MTBP card: start getPayInfoData");
            return this.mMppLite.generateDSRPData(dSRPInputData);
        }
        Log.e("mcpce_MCTransactionService", "MTBP card: not ready for remote payment.");
        return null;
    }

    @Override
    public MTBPCardActivationResult initTransaction(MCCVMResult mCCVMResult, MTBPCardListener mTBPCardListener) {
        Log.i("mcpce_MCTransactionService", "initTransaction: start activateContactless.");
        if (this.mCardProfile == null || this.mCardProfile.getMCPaymentProfile() == null || this.mCardProfile.getTADataContainer() == null) {
            Log.e("mcpce_MCTransactionService", "initTransaction: profile is not found.");
            return MTBPCardActivationResult.CARD_ACTIVATION_INVALID_PROFILE;
        }
        if (this.mMppLite == null) {
            Log.i("mcpce_MCTransactionService", "initTransaction: create mpplite.");
        ...
        try {
            ...
            if (this.mCardProfile.getTADataContainer() == null) {
                Log.e("mcpce_MCTransactionService", "initTransaction:  invalid secure profile.");
                return MTBPCardActivationResult.CARD_ACTIVATION_INVALID_PROFILE;
            }
            ...
            Log.e("mcpce_MCTransactionService", "initTransaction: internal error on mpplite initialization...");
    ...
    public void loadCardProfile(long l2) {
        Log.i("mcpce_MCTransactionService", "MTBPCard: Base profile id: " + l2);
        ...
        if (((MCBaseCardProfile)object).getUnusedDGIElements() == null) {
            Log.i("mcpce_MCTransactionService", "unusedDgi element is null");
        }
    ...
    public long prepareMSTData() {
        Log.i("mcpce_MCTransactionService", "prepareMSTData: Process MST transaction for card...");
        if (this.mCardProfile.getMCPaymentProfile() == null || this.mCardProfile.getTADataContainer() == null) {
            Log.e("mcpce_MCTransactionService", "prepareMSTData: payment profile not found, return code 2");
            return 2L;
        }
    ...
    public byte[] proccessApdu(byte[] arrby) {
        if (this.mMppLite == null) {
            Log.e("mcpce_MCTransactionService", "proccessApdu: card is not initialized...");
            return this.baf.getFromWord(27266).getBytes();
        }
        Log.d("mcpce_MCTransactionService", "proccessApdu: call mMppLite.processApdu...");
        ...
        if (byteArray2 == null) {
            Log.e("mcpce_MCTransactionService", "proccessApdu: call mMppLite.processApdu...");
            return this.baf.getFromWord(27266).getBytes();
        }
    ...
    public Bundle processDeactivated() {
        if (this.mMppLite == null) {
            Log.e("mcpce_MCTransactionService", "processDeactivated: no processed transaction");
            return null;
        }
