...
extends a {
    ...
    private g(Context context) {
        ...
        this.Kx = new LocationListener(){
            ...
            public void onLocationChanged(Location location) {
                if (location != null) {
                    Log.d("PassiveLocationSensor", "onLocationChanged(), newLocation: " + location.toString());
                    g.this.b(location);
                    return;
                }
                Log.d("PassiveLocationSensor", "onLocationChanged(), newLocation is null");
            }
    ...
    protected void b(Location location) {
        ...
        Log.d(this.he(), "processLocationData() invalid location");
    }
        ...
        if (this.JL != null) {
            ...
            if (list != null && list.contains((Object)string)) {
                if (this.gZ() != null) {
                    ...
                    Log.d("PassiveLocationSensor", "requestLocationUpdates(), not requesting location updates as looper is null or looper thread is not alive");
                    return;
                }
                Log.d("PassiveLocationSensor", "requestLocationUpdates(), not requesting location updates as getSensorHandler() is null");
                return;
            }
            Log.d("PassiveLocationSensor", "requestLocationUpdates(), Not registering with " + string + " as it is unavailable");
            return;
        }
        Log.d("PassiveLocationSensor", "requestLocationUpdates(), locationManager is null");
    }
    ...
    protected void hd() {
        try {
            ...
            Log.d("PassiveLocationSensor", "stopSensing(), locationManager is null");
            return;
        }
