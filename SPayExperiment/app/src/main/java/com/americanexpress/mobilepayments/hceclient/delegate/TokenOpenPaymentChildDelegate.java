...
import com.americanexpress.mobilepayments.hceclient.delegate.TokenOpenPaymentDelegate;
...
public class TokenOpenPaymentChildDelegate
extends TokenOpenPaymentDelegate {
    @Override
