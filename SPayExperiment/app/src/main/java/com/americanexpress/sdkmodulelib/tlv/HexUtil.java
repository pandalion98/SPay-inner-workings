...
public class HexUtil {
    ...
    public static int binaryCodedDecimalToInt(byte by) {
        String string = HexUtil.byte2Hex(by);
        try {
    ...
    public static int binaryHexCodedDecimalToInt(String string) {
        ...
        String string2 = HexUtil.removeSpaces(string);
    ...
    public static int binaryHexCodedDecimalToInt(byte[] arrby) {
        ...
        return HexUtil.binaryHexCodedDecimalToInt(HexUtil.byteArrayToHexString(arrby));
    }
    ...
    public static String byte2BinaryLiteral(byte by) {
        String string = Integer.toBinaryString((int)HexUtil.byteToInt(by));
        if (string.length() < 8) {
    ...
    public static String byteArrayToHexString(byte[] arrby) {
        ...
        return HexUtil.byteArrayToHexString(arrby, 0, arrby.length);
    }
    ...
    public static int byteArrayToInt(byte[] arrby) {
        return HexUtil.byteArrayToInt(arrby, 0, arrby.length);
    }
    ...
    public static int byteArrayToInt(byte[] arrby, int n2, int n3) {
        ...
        if (n3 == 4 && HexUtil.isBitSet(arrby[n2], 8)) {
            throw new IllegalArgumentException("Signed bit is set (leftmost bit): " + HexUtil.byte2Hex(arrby[n2]));
        }
        int n4 = 0;
        for (int i2 = 0; i2 < n3; ++i2) {
    ...
    public static long byteArrayToLong(byte[] arrby, int n2, int n3) {
        ...
        if (n3 == 8 && HexUtil.isBitSet(arrby[n2], 8)) {
            throw new IllegalArgumentException("Signed bit is set (leftmost bit): " + HexUtil.byte2Hex(arrby[n2]));
        }
        long l2 = 0L;
        for (int i2 = 0; i2 < n3; ++i2) {
    ...
    public static byte[] copyByteArray(byte[] arrby) {
        ...
        return HexUtil.copyByteArray(arrby, 0, arrby.length);
    }
    ...
    public static Class getCallerClass(int n2) {
        ...
        while (n3 < arrstackTraceElement.length) {
            if (Class.forName((String)arrstackTraceElement[n3].getClassName()) == HexUtil.class) {
    ...
    public static byte[] getCurrentDateAsNumericEncodedByteArray() {
        return HexUtil.fromHexString(new SimpleDateFormat("yyMMdd").format(new Date()));
    }
    ...
    public static String getSafePrintChars(byte[] arrby) {
        ...
        return HexUtil.getSafePrintChars(arrby, 0, arrby.length);
    }
    ...
    public static String int2HexZeroPad(int n2) {
        String string = HexUtil.int2Hex(n2);
        if (string.length() % 2 != 0) {
            string = "0" + string;
        }
        return string;
    ...
    public static byte[] intToBinaryEncodedDecimalByteArray(int n2) {
        ...
        return HexUtil.fromHexString(string);
    }
    ...
    public static String prettyPrintHex(String string) {
        return HexUtil.prettyPrintHex(string, 0, true);
    }

    public static String prettyPrintHex(String string, int n2) {
        return HexUtil.prettyPrintHex(string, n2, true);
    }
    ...
    public static String prettyPrintHex(BigInteger bigInteger) {
        ...
        if (arrby2[0] == 0) {
            ...
            do {
                return HexUtil.prettyPrintHex(arrby);
                break;
            } while (true);
        }
        arrby = arrby2;
    ...
    public static String prettyPrintHex(byte[] arrby) {
        return HexUtil.prettyPrintHex(HexUtil.byteArrayToHexString(arrby), 0, true);
    }

    public static String prettyPrintHex(byte[] arrby, int n2) {
        return HexUtil.prettyPrintHex(HexUtil.byteArrayToHexString(arrby), n2, true);
    }

    public static String prettyPrintHex(byte[] arrby, int n2, int n3) {
        return HexUtil.prettyPrintHex(HexUtil.byteArrayToHexString(arrby, n2, n3), 0, true);
    }

    public static String prettyPrintHexNoWrap(String string) {
        return HexUtil.prettyPrintHex(string, 0, false);
    }

    public static String prettyPrintHexNoWrap(byte[] arrby) {
        return HexUtil.prettyPrintHex(HexUtil.byteArrayToHexString(arrby), 0, false);
    }

    public static String prettyPrintHexNoWrap(byte[] arrby, int n2, int n3) {
        return HexUtil.prettyPrintHex(HexUtil.byteArrayToHexString(arrby, n2, n3), 0, false);
    }
    ...
    public static String short2Hex(short s2) {
        ...
        return HexUtil.byte2Hex(by) + HexUtil.byte2Hex(by2);
    }
