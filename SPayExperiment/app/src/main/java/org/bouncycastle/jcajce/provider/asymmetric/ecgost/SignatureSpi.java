...
X509ObjectIdentifiers {
    ...
    protected void engineInitVerify(PublicKey publicKey) {
        ...
        if (publicKey instanceof ECPublicKey) {
            ...
            asymmetricKeyParameter = asymmetricKeyParameter2 = ECUtil.generatePublicKeyParameter(BouncyCastleProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(publicKey.getEncoded())));
        }
        this.digest.reset();
