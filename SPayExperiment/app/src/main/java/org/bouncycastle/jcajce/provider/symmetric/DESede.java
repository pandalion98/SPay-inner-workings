...
public final class DESede {
    ...
    extends BaseSecretKeyFactory {
        ...
        protected KeySpec engineGetKeySpec(SecretKey secretKey, Class class_) {
            ...
            if (!DESedeKeySpec.class.isAssignableFrom(class_)) {
                throw new InvalidKeySpecException("Invalid KeySpec");
            }
            byte[] arrby = secretKey.getEncoded();
            try {
                if (arrby.length != 16) return new DESedeKeySpec(arrby);
                byte[] arrby2 = new byte[24];
                System.arraycopy((Object)arrby, (int)0, (Object)arrby2, (int)0, (int)16);
                System.arraycopy((Object)arrby, (int)0, (Object)arrby2, (int)16, (int)8);
                return new DESedeKeySpec(arrby2);
            }
            catch (Exception exception) {
    ...
    extends BaseKeyGenerator {
        ...
        protected SecretKey engineGenerateKey() {
            ...
            if (!this.keySizeSet) {
                ...
                System.arraycopy((Object)arrby, (int)0, (Object)arrby, (int)16, (int)8);
