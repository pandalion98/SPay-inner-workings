...
PKCS12BagAttributeCarrier {
    ...
    public byte[] getEncoded() {
        try {
            ...
            byte[] arrby = new PrivateKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL()).toASN1Primitive()), new ASN1Integer(this.getX())).getEncoded("DER");
            return arrby;
        }
