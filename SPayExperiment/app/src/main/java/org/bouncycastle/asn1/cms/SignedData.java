...
extends ASN1Object {
    ...
    private ASN1Integer calculateVersion(ASN1ObjectIdentifier aSN1ObjectIdentifier, ASN1Set aSN1Set, ASN1Set aSN1Set2, ASN1Set aSN1Set3) {
        ...
        if (aSN1Set != null) {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                if (!(object instanceof ASN1TaggedObject)) continue;
        ...
        if (aSN1Set2 != null) {
            ...
            while (enumeration.hasMoreElements()) {
                if (!(enumeration.nextElement() instanceof ASN1TaggedObject)) continue;
                bl4 = true;
            }
        }
        if (bl4) {
    ...
    private boolean checkForVersion3(ASN1Set aSN1Set) {
        Enumeration enumeration = aSN1Set.getObjects();
        while (enumeration.hasMoreElements()) {
            if (SignerInfo.getInstance(enumeration.nextElement()).getVersion().getValue().intValue() != 3) continue;
            return true;
        }
        return false;
    }
