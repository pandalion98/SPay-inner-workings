...
extends ASN1Object {
    ...
    private TimeStampReq(ASN1Sequence aSN1Sequence) {
        ...
        while (n3 < n2) {
            ...
            if (aSN1Sequence.getObjectAt(n3) instanceof ASN1ObjectIdentifier) {
                this.tsaPolicy = ASN1ObjectIdentifier.getInstance(aSN1Sequence.getObjectAt(n3));
            } else if (aSN1Sequence.getObjectAt(n3) instanceof ASN1Integer) {
                this.nonce = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(n3));
            } else if (aSN1Sequence.getObjectAt(n3) instanceof ASN1Boolean) {
                this.certReq = ASN1Boolean.getInstance(aSN1Sequence.getObjectAt(n3));
            } else if (aSN1Sequence.getObjectAt(n3) instanceof ASN1TaggedObject && (aSN1TaggedObject = (ASN1TaggedObject)aSN1Sequence.getObjectAt(n3)).getTagNo() == 0) {
