...
public class CertTemplateBuilder {
    ...
    private void addOptional(ASN1EncodableVector aSN1EncodableVector, int n2, boolean bl, ASN1Encodable aSN1Encodable) {
    ...
    public CertTemplateBuilder setVersion(int n2) {
