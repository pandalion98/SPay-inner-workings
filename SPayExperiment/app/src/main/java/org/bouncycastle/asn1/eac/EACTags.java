...
public class EACTags {
     ...
     */
    public static int decodeTag(int n2) {
        int n3 = 0;
        int n4 = 24;
        boolean bl = false;
        while (n4 >= 0) {
    ...
    public static int encodeTag(DERApplicationSpecific dERApplicationSpecific) {
        ...
        if ((n2 = dERApplicationSpecific.getApplicationTag()) > 31) {
            int n5 = (n4 | 31) << 8 | n2 & 127;
            int n6 = n2 >> 7;
            n3 = n5;
            for (int i2 = n6; i2 > 0; i2 >>= 7) {
                int n7 = (n3 | 128) << 8;
                i2 & 127;
                n3 = n7;
            }
    ...
    public static int getTag(int n2) {
        return EACTags.decodeTag(n2);
    }

    public static int getTagNo(int n2) {
        for (int i2 = 24; i2 >= 0; i2 -= 8) {
            if ((n2 & 255 << i2) == 0) continue;
            return n2 & (-1 ^ 255 << i2);
        }
        return 0;
    }
