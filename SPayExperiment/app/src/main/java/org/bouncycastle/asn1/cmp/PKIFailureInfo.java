...
extends DERBitString {
    ...
    public PKIFailureInfo(int n2) {
        super(PKIFailureInfo.getBytes(n2), PKIFailureInfo.getPadBits(n2));
    }
    ...
    public String toString() {
        return "PKIFailureInfo: 0x" + Integer.toHexString((int)this.intValue());
    }
}
