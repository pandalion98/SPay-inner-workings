...
public class BufferedEncoder {
    ...
    public int processByte(byte by, byte[] arrby, int n) {
        ...
        int n5 = 0;
        if (n3 == n4) {
            int n6 = this.translator.encode(this.buf, 0, this.buf.length, arrby, n);
            this.bufOff = 0;
            n5 = n6;
        }
        return n5;
    ...
    public int processBytes(byte[] arrby, int n, int n2, byte[] arrby2, int n3) {
        ...
        if (n2 > n4) {
            ...
            int n6 = 0 + this.translator.encode(this.buf, 0, this.buf.length, arrby2, n3);
            this.bufOff = 0;
            int n7 = n2 - n4;
            int n8 = n + n4;
            int n9 = n3 + n6;
            int n10 = n7 - n7 % this.buf.length;
            int n11 = n6 + this.translator.encode(arrby, n8, n10, arrby2, n9);
            n2 = n7 - n10;
            n = n8 + n10;
            n5 = n11;
        }
