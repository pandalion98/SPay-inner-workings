...
implements BlockCipher {
    ...
    private void camelliaF2(int[] arrn, int[] arrn2, int n2) {
        ...
        int n4 = SBOX4_4404[n3 & 255] ^ SBOX3_3033[255 & n3 >>> 8] ^ SBOX2_0222[255 & n3 >>> 16] ^ SBOX1_1110[255 & n3 >>> 24];
        int n5 = arrn[1] ^ arrn2[n2 + 1];
        int n6 = SBOX1_1110[n5 & 255] ^ SBOX4_4404[255 & n5 >>> 8] ^ SBOX3_3033[255 & n5 >>> 16] ^ SBOX2_0222[255 & n5 >>> 24];
        arrn[2] = arrn[2] ^ (n4 ^ n6);
        arrn[3] = arrn[3] ^ (n6 ^ n4 ^ CamelliaEngine.rightRotate(n4, 8));
        int n7 = arrn[2] ^ arrn2[n2 + 2];
        int n8 = SBOX4_4404[n7 & 255] ^ SBOX3_3033[255 & n7 >>> 8] ^ SBOX2_0222[255 & n7 >>> 16] ^ SBOX1_1110[255 & n7 >>> 24];
        int n9 = arrn[3] ^ arrn2[n2 + 3];
        int n10 = SBOX1_1110[n9 & 255] ^ SBOX4_4404[255 & n9 >>> 8] ^ SBOX3_3033[255 & n9 >>> 16] ^ SBOX2_0222[255 & n9 >>> 24];
        arrn[0] = arrn[0] ^ (n8 ^ n10);
        arrn[1] = arrn[1] ^ (n10 ^ n8 ^ CamelliaEngine.rightRotate(n8, 8));
    }

    private void camelliaFLs(int[] arrn, int[] arrn2, int n2) {
        arrn[1] = arrn[1] ^ CamelliaEngine.leftRotate(arrn[0] & arrn2[n2 + 0], 1);
        arrn[0] = arrn[0] ^ (arrn2[n2 + 1] | arrn[1]);
        arrn[2] = arrn[2] ^ (arrn2[n2 + 3] | arrn[3]);
        arrn[3] = arrn[3] ^ CamelliaEngine.leftRotate(arrn2[n2 + 2] & arrn[2], 1);
    }
    ...
    private void setKey(boolean bl, byte[] arrby) {
        ...
        if (this._keyIs128) {
            if (bl) {
                ...
                this.kw[2] = arrn[2];
                this.kw[3] = arrn[3];
                CamelliaEngine.roldq(15, arrn, 0, this.subkey, 4);
                CamelliaEngine.roldq(30, arrn, 0, this.subkey, 12);
                CamelliaEngine.roldq(15, arrn, 0, arrn4, 0);
                this.subkey[18] = arrn4[2];
                this.subkey[19] = arrn4[3];
                CamelliaEngine.roldq(17, arrn, 0, this.ke, 4);
                CamelliaEngine.roldq(17, arrn, 0, this.subkey, 24);
                CamelliaEngine.roldq(17, arrn, 0, this.subkey, 32);
                this.subkey[0] = arrn2[0];
                this.subkey[1] = arrn2[1];
                this.subkey[2] = arrn2[2];
                this.subkey[3] = arrn2[3];
                CamelliaEngine.roldq(15, arrn2, 0, this.subkey, 8);
                CamelliaEngine.roldq(15, arrn2, 0, this.ke, 0);
                CamelliaEngine.roldq(15, arrn2, 0, arrn4, 0);
                this.subkey[16] = arrn4[0];
                this.subkey[17] = arrn4[1];
                CamelliaEngine.roldq(15, arrn2, 0, this.subkey, 20);
                CamelliaEngine.roldqo32(34, arrn2, 0, this.subkey, 28);
                CamelliaEngine.roldq(17, arrn2, 0, this.kw, 4);
                return;
            }
            this.kw[4] = arrn[0];
            this.kw[5] = arrn[1];
            this.kw[6] = arrn[2];
            this.kw[7] = arrn[3];
            CamelliaEngine.decroldq(15, arrn, 0, this.subkey, 28);
            CamelliaEngine.decroldq(30, arrn, 0, this.subkey, 20);
            CamelliaEngine.decroldq(15, arrn, 0, arrn4, 0);
            this.subkey[16] = arrn4[0];
            this.subkey[17] = arrn4[1];
            CamelliaEngine.decroldq(17, arrn, 0, this.ke, 0);
            CamelliaEngine.decroldq(17, arrn, 0, this.subkey, 8);
            CamelliaEngine.decroldq(17, arrn, 0, this.subkey, 0);
            this.subkey[34] = arrn2[0];
            this.subkey[35] = arrn2[1];
            this.subkey[32] = arrn2[2];
            this.subkey[33] = arrn2[3];
            CamelliaEngine.decroldq(15, arrn2, 0, this.subkey, 24);
            CamelliaEngine.decroldq(15, arrn2, 0, this.ke, 4);
            CamelliaEngine.decroldq(15, arrn2, 0, arrn4, 0);
            this.subkey[18] = arrn4[2];
            this.subkey[19] = arrn4[3];
            CamelliaEngine.decroldq(15, arrn2, 0, this.subkey, 12);
            CamelliaEngine.decroldqo32(34, arrn2, 0, this.subkey, 4);
            CamelliaEngine.roldq(17, arrn2, 0, this.kw, 0);
            return;
        }
        ...
        if (bl) {
            ...
            this.kw[2] = arrn[2];
            this.kw[3] = arrn[3];
            CamelliaEngine.roldqo32(45, arrn, 0, this.subkey, 16);
            CamelliaEngine.roldq(15, arrn, 0, this.ke, 4);
            CamelliaEngine.roldq(17, arrn, 0, this.subkey, 32);
            CamelliaEngine.roldqo32(34, arrn, 0, this.subkey, 44);
            CamelliaEngine.roldq(15, arrn, 4, this.subkey, 4);
            CamelliaEngine.roldq(15, arrn, 4, this.ke, 0);
            CamelliaEngine.roldq(30, arrn, 4, this.subkey, 24);
            CamelliaEngine.roldqo32(34, arrn, 4, this.subkey, 36);
            CamelliaEngine.roldq(15, arrn2, 0, this.subkey, 8);
            CamelliaEngine.roldq(30, arrn2, 0, this.subkey, 20);
            this.ke[8] = arrn2[1];
            this.ke[9] = arrn2[2];
            this.ke[10] = arrn2[3];
            this.ke[11] = arrn2[0];
            CamelliaEngine.roldqo32(49, arrn2, 0, this.subkey, 40);
            this.subkey[0] = arrn3[0];
            this.subkey[1] = arrn3[1];
            this.subkey[2] = arrn3[2];
            this.subkey[3] = arrn3[3];
            CamelliaEngine.roldq(30, arrn3, 0, this.subkey, 12);
            CamelliaEngine.roldq(30, arrn3, 0, this.subkey, 28);
            CamelliaEngine.roldqo32(51, arrn3, 0, this.kw, 4);
            return;
        }
        this.kw[4] = arrn[0];
        this.kw[5] = arrn[1];
        this.kw[6] = arrn[2];
        this.kw[7] = arrn[3];
        CamelliaEngine.decroldqo32(45, arrn, 0, this.subkey, 28);
        CamelliaEngine.decroldq(15, arrn, 0, this.ke, 4);
        CamelliaEngine.decroldq(17, arrn, 0, this.subkey, 12);
        CamelliaEngine.decroldqo32(34, arrn, 0, this.subkey, 0);
        CamelliaEngine.decroldq(15, arrn, 4, this.subkey, 40);
        CamelliaEngine.decroldq(15, arrn, 4, this.ke, 8);
        CamelliaEngine.decroldq(30, arrn, 4, this.subkey, 20);
        CamelliaEngine.decroldqo32(34, arrn, 4, this.subkey, 8);
        CamelliaEngine.decroldq(15, arrn2, 0, this.subkey, 36);
        CamelliaEngine.decroldq(30, arrn2, 0, this.subkey, 24);
        this.ke[2] = arrn2[1];
        this.ke[3] = arrn2[2];
        this.ke[0] = arrn2[3];
        this.ke[1] = arrn2[0];
        CamelliaEngine.decroldqo32(49, arrn2, 0, this.subkey, 4);
        this.subkey[46] = arrn3[0];
        this.subkey[47] = arrn3[1];
        this.subkey[44] = arrn3[2];
        this.subkey[45] = arrn3[3];
        CamelliaEngine.decroldq(30, arrn3, 0, this.subkey, 32);
        CamelliaEngine.decroldq(30, arrn3, 0, this.subkey, 16);
        CamelliaEngine.roldqo32(51, arrn3, 0, this.kw, 0);
    }
