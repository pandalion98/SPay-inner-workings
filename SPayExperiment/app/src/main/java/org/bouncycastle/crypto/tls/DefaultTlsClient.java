...
extends AbstractTlsClient {
    ...
    protected TlsKeyExchange createDHEKeyExchange(int n2) {
        return new TlsDHEKeyExchange(n2, this.supportedSignatureAlgorithms, null);
    }

    protected TlsKeyExchange createDHKeyExchange(int n2) {
        return new TlsDHKeyExchange(n2, this.supportedSignatureAlgorithms, null);
    }
    ...
    public int[] getCipherSuites() {
        return new int[]{49195, 49187, 49161, 49199, 49191, 49171, 162, 64, 50, 156, 60, 47};
    }
