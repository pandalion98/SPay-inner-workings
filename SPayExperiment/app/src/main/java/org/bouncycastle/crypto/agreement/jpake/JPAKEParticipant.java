...
public class JPAKEParticipant {
    ...
    public JPAKEParticipant(String string, char[] arrc) {
        this(string, arrc, JPAKEPrimeOrderGroups.NIST_3072);
    }

    public JPAKEParticipant(String string, char[] arrc, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup) {
        this(string, arrc, jPAKEPrimeOrderGroup, new SHA256Digest(), new SecureRandom());
    }

    public JPAKEParticipant(String string, char[] arrc, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        JPAKEUtil.validateNotNull(string, "participantId");
        JPAKEUtil.validateNotNull(arrc, "password");
        JPAKEUtil.validateNotNull(jPAKEPrimeOrderGroup, "p");
        JPAKEUtil.validateNotNull(digest, "digest");
        JPAKEUtil.validateNotNull((Object)secureRandom, "random");
        if (arrc.length == 0) {
            throw new IllegalArgumentException("Password must not be empty.");
        }
        this.participantId = string;
        this.password = Arrays.copyOf((char[])arrc, (int)arrc.length);
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        BigInteger[] arrbigInteger = JPAKEUtil.calculateZeroKnowledgeProof(this.p, this.q, this.g, this.gx1, this.x1, this.participantId, this.digest, this.random);
        BigInteger[] arrbigInteger2 = JPAKEUtil.calculateZeroKnowledgeProof(this.p, this.q, this.g, this.gx2, this.x2, this.participantId, this.digest, this.random);
        this.state = 10;
        return new JPAKERound1Payload(this.participantId, this.gx1, this.gx2, arrbigInteger, arrbigInteger2);
    }
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        BigInteger[] arrbigInteger = JPAKEUtil.calculateZeroKnowledgeProof(this.p, this.q, bigInteger, bigInteger4, bigInteger3, this.participantId, this.digest, this.random);
        this.state = 30;
        return new JPAKERound2Payload(this.participantId, bigInteger4, arrbigInteger);
    }
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) {
        ...
        BigInteger[] arrbigInteger = jPAKERound1Payload.getKnowledgeProofForX1();
        BigInteger[] arrbigInteger2 = jPAKERound1Payload.getKnowledgeProofForX2();
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.p, this.q, this.g, this.gx3, arrbigInteger, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.p, this.q, this.g, this.gx4, arrbigInteger2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) {
        ...
        BigInteger[] arrbigInteger = jPAKERound2Payload.getKnowledgeProofForX2s();
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.p, this.q, bigInteger, this.b, arrbigInteger, jPAKERound2Payload.getParticipantId(), this.digest);
        this.state = 40;
    }
