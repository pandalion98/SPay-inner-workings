...
public abstract class Nat224 {
    ...
    public static void mul(int[] arrn, int n, int[] arrn2, int n2, int[] arrn3, int n3) {
        ...
        long l8 = 0xFFFFFFFFL & (long)arrn[n + 0];
        long l9 = 0L + l8 * l;
        arrn3[n3 + 0] = (int)l9;
        long l10 = (l9 >>> 32) + l8 * l2;
        arrn3[n3 + 1] = (int)l10;
        long l11 = (l10 >>> 32) + l8 * l3;
        arrn3[n3 + 2] = (int)l11;
        long l12 = (l11 >>> 32) + l8 * l4;
        arrn3[n3 + 3] = (int)l12;
        long l13 = (l12 >>> 32) + l8 * l5;
        arrn3[n3 + 4] = (int)l13;
        long l14 = (l13 >>> 32) + l8 * l6;
        arrn3[n3 + 5] = (int)l14;
        long l15 = (l14 >>> 32) + l8 * l7;
        arrn3[n3 + 6] = (int)l15;
        long l16 = l15 >>> 32;
        arrn3[n3 + 7] = (int)l16;
        for (int i = 1; i < 7; ++i) {
            long l17 = 0xFFFFFFFFL & (long)arrn[n + i];
            long l18 = 0L + (l17 * l + (0xFFFFFFFFL & (long)arrn3[++n3 + 0]));
            arrn3[n3 + 0] = (int)l18;
            long l19 = (l18 >>> 32) + (l17 * l2 + (0xFFFFFFFFL & (long)arrn3[n3 + 1]));
            arrn3[n3 + 1] = (int)l19;
            long l20 = (l19 >>> 32) + (l17 * l3 + (0xFFFFFFFFL & (long)arrn3[n3 + 2]));
            arrn3[n3 + 2] = (int)l20;
            long l21 = (l20 >>> 32) + (l17 * l4 + (0xFFFFFFFFL & (long)arrn3[n3 + 3]));
            arrn3[n3 + 3] = (int)l21;
            long l22 = (l21 >>> 32) + (l17 * l5 + (0xFFFFFFFFL & (long)arrn3[n3 + 4]));
            arrn3[n3 + 4] = (int)l22;
            long l23 = (l22 >>> 32) + (l17 * l6 + (0xFFFFFFFFL & (long)arrn3[n3 + 5]));
            arrn3[n3 + 5] = (int)l23;
            long l24 = (l23 >>> 32) + (l17 * l7 + (0xFFFFFFFFL & (long)arrn3[n3 + 6]));
            arrn3[n3 + 6] = (int)l24;
            long l25 = l24 >>> 32;
            arrn3[n3 + 7] = (int)l25;
        }
    ...
    public static void mul(int[] arrn, int[] arrn2, int[] arrn3) {
        ...
        arrn3[7] = (int)(l15 >>> 32);
        for (int i = 1; i < 7; ++i) {
            long l16 = 0xFFFFFFFFL & (long)arrn[i];
            long l17 = 0L + (l16 * l + (0xFFFFFFFFL & (long)arrn3[i + 0]));
            arrn3[i + 0] = (int)l17;
            long l18 = (l17 >>> 32) + (l16 * l2 + (0xFFFFFFFFL & (long)arrn3[i + 1]));
            arrn3[i + 1] = (int)l18;
            long l19 = (l18 >>> 32) + (l16 * l3 + (0xFFFFFFFFL & (long)arrn3[i + 2]));
            arrn3[i + 2] = (int)l19;
            long l20 = (l19 >>> 32) + (l16 * l4 + (0xFFFFFFFFL & (long)arrn3[i + 3]));
            arrn3[i + 3] = (int)l20;
            long l21 = (l20 >>> 32) + (l16 * l5 + (0xFFFFFFFFL & (long)arrn3[i + 4]));
            arrn3[i + 4] = (int)l21;
            long l22 = (l21 >>> 32) + (l16 * l6 + (0xFFFFFFFFL & (long)arrn3[i + 5]));
            arrn3[i + 5] = (int)l22;
            long l23 = (l22 >>> 32) + (l16 * l7 + (0xFFFFFFFFL & (long)arrn3[i + 6]));
            arrn3[i + 6] = (int)l23;
            long l24 = l23 >>> 32;
            arrn3[i + 7] = (int)l24;
        }
    ...
    public static int mulAddTo(int[] arrn, int n, int[] arrn2, int n2, int[] arrn3, int n3) {
        ...
        long l8 = 0L;
        for (int i = 0; i < 7; ++i) {
            long l9 = 0xFFFFFFFFL & (long)arrn[n + i];
            long l10 = 0L + (l9 * l + (0xFFFFFFFFL & (long)arrn3[n3 + 0]));
            arrn3[n3 + 0] = (int)l10;
            long l11 = (l10 >>> 32) + (l9 * l2 + (0xFFFFFFFFL & (long)arrn3[n3 + 1]));
            arrn3[n3 + 1] = (int)l11;
            long l12 = (l11 >>> 32) + (l9 * l3 + (0xFFFFFFFFL & (long)arrn3[n3 + 2]));
            arrn3[n3 + 2] = (int)l12;
            long l13 = (l12 >>> 32) + (l9 * l4 + (0xFFFFFFFFL & (long)arrn3[n3 + 3]));
            arrn3[n3 + 3] = (int)l13;
            long l14 = (l13 >>> 32) + (l9 * l5 + (0xFFFFFFFFL & (long)arrn3[n3 + 4]));
            arrn3[n3 + 4] = (int)l14;
            long l15 = (l14 >>> 32) + (l9 * l6 + (0xFFFFFFFFL & (long)arrn3[n3 + 5]));
            arrn3[n3 + 5] = (int)l15;
            long l16 = (l15 >>> 32) + (l9 * l7 + (0xFFFFFFFFL & (long)arrn3[n3 + 6]));
            arrn3[n3 + 6] = (int)l16;
            long l17 = (l16 >>> 32) + (l8 + (0xFFFFFFFFL & (long)arrn3[n3 + 7]));
            arrn3[n3 + 7] = (int)l17;
            l8 = l17 >>> 32;
            ++n3;
        }
    ...
    public static int mulAddTo(int[] arrn, int[] arrn2, int[] arrn3) {
        ...
        long l8 = 0L;
        for (int i = 0; i < 7; ++i) {
            long l9 = 0xFFFFFFFFL & (long)arrn[i];
            long l10 = 0L + (l9 * l + (0xFFFFFFFFL & (long)arrn3[i + 0]));
            arrn3[i + 0] = (int)l10;
            long l11 = (l10 >>> 32) + (l9 * l2 + (0xFFFFFFFFL & (long)arrn3[i + 1]));
            arrn3[i + 1] = (int)l11;
            long l12 = (l11 >>> 32) + (l9 * l3 + (0xFFFFFFFFL & (long)arrn3[i + 2]));
            arrn3[i + 2] = (int)l12;
            long l13 = (l12 >>> 32) + (l9 * l4 + (0xFFFFFFFFL & (long)arrn3[i + 3]));
            arrn3[i + 3] = (int)l13;
            long l14 = (l13 >>> 32) + (l9 * l5 + (0xFFFFFFFFL & (long)arrn3[i + 4]));
            arrn3[i + 4] = (int)l14;
            long l15 = (l14 >>> 32) + (l9 * l6 + (0xFFFFFFFFL & (long)arrn3[i + 5]));
            arrn3[i + 5] = (int)l15;
            long l16 = (l15 >>> 32) + (l9 * l7 + (0xFFFFFFFFL & (long)arrn3[i + 6]));
            arrn3[i + 6] = (int)l16;
            long l17 = (l16 >>> 32) + (l8 + (0xFFFFFFFFL & (long)arrn3[i + 7]));
            arrn3[i + 7] = (int)l17;
            l8 = l17 >>> 32;
        }
        return (int)l8;
    ...
    public static void square(int[] arrn, int n, int[] arrn2, int n2) {
        ...
        do {
            ...
            if (n6 <= 0) {
                ...
                long l56 = l49 + ((l55 >>> 32) + l50 * l17);
                long l57 = l48 + ((l56 >>> 32) + l50 * l26);
                long l58 = l51 + ((l57 >>> 32) + l50 * l37);
                long l59 = l52 + (l58 >>> 32);
                int n22 = (int)l54;
                ...
                int n33 = n32 >>> 31;
                int n34 = arrn2[n2 + 13] + (int)(l59 >> 32);
    ...
    public static void square(int[] arrn, int[] arrn2) {
        ...
        do {
            ...
            if (n4 <= 0) {
                ...
                int n30 = (int)l59;
                arrn2[12] = n29 | n30 << 1;
                arrn2[13] = n30 >>> 31 | arrn2[13] + (int)(l59 >> 32) << 1;
                return;
            }
            n3 = n6;
            n = n4;
