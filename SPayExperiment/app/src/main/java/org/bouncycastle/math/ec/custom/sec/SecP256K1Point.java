...
extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        boolean bl2 = secP256K1FieldElement5.isOne();
        if (bl2) {
            int[] arrn9 = secP256K1FieldElement3.x;
            arrn2 = secP256K1FieldElement4.x;
            arrn = arrn9;
        } else {
            SecP256K1Field.square(secP256K1FieldElement5.x, arrn7);
            SecP256K1Field.multiply(arrn7, secP256K1FieldElement3.x, arrn6);
            SecP256K1Field.multiply(arrn7, secP256K1FieldElement5.x, arrn7);
            SecP256K1Field.multiply(arrn7, secP256K1FieldElement4.x, arrn7);
            arrn2 = arrn7;
            arrn = arrn6;
        }
        if (bl = secP256K1FieldElement6.isOne()) {
            int[] arrn10 = secP256K1FieldElement.x;
            arrn4 = secP256K1FieldElement2.x;
            arrn3 = arrn10;
        } else {
            SecP256K1Field.square(secP256K1FieldElement6.x, arrn8);
            SecP256K1Field.multiply(arrn8, secP256K1FieldElement.x, arrn5);
            SecP256K1Field.multiply(arrn8, secP256K1FieldElement6.x, arrn8);
            SecP256K1Field.multiply(arrn8, secP256K1FieldElement2.x, arrn8);
            arrn4 = arrn8;
            arrn3 = arrn5;
        }
        int[] arrn11 = Nat256.create();
        SecP256K1Field.subtract(arrn3, arrn, arrn11);
        SecP256K1Field.subtract(arrn4, arrn2, arrn6);
        ...
        SecP256K1Field.square(arrn11, arrn7);
        int[] arrn12 = Nat256.create();
        SecP256K1Field.multiply(arrn7, arrn11, arrn12);
        SecP256K1Field.multiply(arrn7, arrn3, arrn7);
        SecP256K1Field.negate(arrn12, arrn12);
        Nat256.mul(arrn4, arrn12, arrn5);
        SecP256K1Field.reduce32(Nat256.addBothTo(arrn7, arrn7, arrn12), arrn12);
        SecP256K1FieldElement secP256K1FieldElement7 = new SecP256K1FieldElement(arrn8);
        SecP256K1Field.square(arrn6, secP256K1FieldElement7.x);
        SecP256K1Field.subtract(secP256K1FieldElement7.x, arrn12, secP256K1FieldElement7.x);
        SecP256K1FieldElement secP256K1FieldElement8 = new SecP256K1FieldElement(arrn12);
        SecP256K1Field.subtract(arrn7, secP256K1FieldElement7.x, secP256K1FieldElement8.x);
        SecP256K1Field.multiplyAddToExt(secP256K1FieldElement8.x, arrn6, arrn5);
        SecP256K1Field.reduce(arrn5, secP256K1FieldElement8.x);
        SecP256K1FieldElement secP256K1FieldElement9 = new SecP256K1FieldElement(arrn11);
        if (!bl2) {
        ...
        return new SecP256K1Point(eCCurve, secP256K1FieldElement7, secP256K1FieldElement8, new ECFieldElement[]{secP256K1FieldElement9}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        SecP256K1Field.square(secP256K1FieldElement2.x, arrn3);
        SecP256K1Field.reduce32(Nat256.addBothTo(arrn3, arrn3, arrn3), arrn3);
        ...
        SecP256K1Field.reduce32(Nat.shiftUpBits(8, arrn2, 3, 0, arrn4), arrn4);
        SecP256K1FieldElement secP256K1FieldElement4 = new SecP256K1FieldElement(arrn2);
        SecP256K1Field.square(arrn3, secP256K1FieldElement4.x);
        SecP256K1Field.subtract(secP256K1FieldElement4.x, arrn, secP256K1FieldElement4.x);
        SecP256K1Field.subtract(secP256K1FieldElement4.x, arrn, secP256K1FieldElement4.x);
        SecP256K1FieldElement secP256K1FieldElement5 = new SecP256K1FieldElement(arrn);
        SecP256K1Field.subtract(arrn, secP256K1FieldElement4.x, secP256K1FieldElement5.x);
        SecP256K1Field.multiply(secP256K1FieldElement5.x, arrn3, secP256K1FieldElement5.x);
        SecP256K1Field.subtract(secP256K1FieldElement5.x, arrn4, secP256K1FieldElement5.x);
        SecP256K1FieldElement secP256K1FieldElement6 = new SecP256K1FieldElement(arrn3);
