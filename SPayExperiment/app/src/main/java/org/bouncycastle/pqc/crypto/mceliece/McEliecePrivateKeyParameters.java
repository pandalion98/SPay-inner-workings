...
extends McElieceKeyParameters {
    ...
    public McEliecePrivateKeyParameters(String string, int n, int n2, GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM, GF2Matrix gF2Matrix, Permutation permutation, Permutation permutation2, GF2Matrix gF2Matrix2, PolynomialGF2mSmallM[] arrpolynomialGF2mSmallM, McElieceParameters mcElieceParameters) {
    ...
    public McEliecePrivateKeyParameters(String string, int n, int n2, byte[] arrby, byte[] arrby2, byte[] arrby3, byte[] arrby4, byte[] arrby5, byte[] arrby6, byte[][] arrby7, McElieceParameters mcElieceParameters) {
        super(true, mcElieceParameters);
        this.oid = string;
        this.n = n;
        this.k = n2;
